...
class InlineResponse20014 implements ModelInterface, ArrayAccess
{
    ...
    public function setSummary($summary)
    {
        ...
        if ((mb_strlen($summary) < 1)) {
            throw new \InvalidArgumentException('invalid length for $summary when calling InlineResponse20014., must be bigger than or equal to 1.');
        }
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling InlineResponse20014., must be bigger than or equal to 1.');
        }
