...
// checks if the AddMealPlanTemplate200ResponseItemsInnerValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddMealPlanTemplate200ResponseItemsInnerValue{}
