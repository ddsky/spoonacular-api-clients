...
autocompleteMenuItemSearch 
  ...
  -> SpoonacularRequest AutocompleteMenuItemSearch MimeNoContent InlineResponse20032 MimeJSON
...
getMenuItemInformation 
  :: Id -- ^ "id" -  The item's id.
  -> SpoonacularRequest GetMenuItemInformation MimeNoContent InlineResponse20036 MimeJSON
...
-- 
searchMenuItems 
  :: SpoonacularRequest SearchMenuItems MimeNoContent InlineResponse20035 MimeJSON
searchMenuItems =
