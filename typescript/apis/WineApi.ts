...
export class WineApiResponseProcessor {
     ...
     */
     public async getDishPairingForWineWithHttpInfo(response: ResponseContext): Promise<HttpInfo<GetDishPairingForWine200Response >> {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getWineDescriptionWithHttpInfo(response: ResponseContext): Promise<HttpInfo<GetWineDescription200Response >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getWinePairingWithHttpInfo(response: ResponseContext): Promise<HttpInfo<GetWinePairing200Response >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getWineRecommendationWithHttpInfo(response: ResponseContext): Promise<HttpInfo<GetWineRecommendation200Response >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
