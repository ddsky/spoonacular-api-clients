...
/*
 * OAIGetRandomRecipes_200_response_recipes_inner.h
 *
 * 
 */

#ifndef OAIGetRandomRecipes_200_response_recipes_inner_H
#define OAIGetRandomRecipes_200_response_recipes_inner_H
...
class OAIGetRandomRecipes_200_response_recipes_inner : public OAIObject {
public:
    OAIGetRandomRecipes_200_response_recipes_inner();
    OAIGetRandomRecipes_200_response_recipes_inner(QString json);
    ~OAIGetRandomRecipes_200_response_recipes_inner() override;
    ...
    double getAggregateLikes() const;
    void setAggregateLikes(const double &aggregate_likes);
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetRandomRecipes_200_response_recipes_inner)

#endif // OAIGetRandomRecipes_200_response_recipes_inner_H
