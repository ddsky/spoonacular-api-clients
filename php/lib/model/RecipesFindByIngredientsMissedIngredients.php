...
/**
 * RecipesFindByIngredientsMissedIngredients Class Doc Comment
 *
 * @category Class
 * @package  com.spoonacular.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class RecipesFindByIngredientsMissedIngredients implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_recipes_findByIngredients_missedIngredients';
    ...
    public function setAisle($aisle)
    {
        ...
        if ((mb_strlen($aisle) < 1)) {
            throw new \InvalidArgumentException('invalid length for $aisle when calling RecipesFindByIngredientsMissedIngredients., must be bigger than or equal to 1.');
        }
    ...
    public function setImage($image)
    {
        ...
        if ((mb_strlen($image) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image when calling RecipesFindByIngredientsMissedIngredients., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RecipesFindByIngredientsMissedIngredients., must be bigger than or equal to 1.');
        }
    ...
    public function setOriginal($original)
    {
        ...
        if ((mb_strlen($original) < 1)) {
            throw new \InvalidArgumentException('invalid length for $original when calling RecipesFindByIngredientsMissedIngredients., must be bigger than or equal to 1.');
        }
    ...
    public function setOriginalName($original_name)
    {
        ...
        if ((mb_strlen($original_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $original_name when calling RecipesFindByIngredientsMissedIngredients., must be bigger than or equal to 1.');
        }
    ...
    public function setUnit($unit)
    {
        ...
        if ((mb_strlen($unit) < 0)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling RecipesFindByIngredientsMissedIngredients., must be bigger than or equal to 0.');
        }
    ...
    public function setUnitLong($unit_long)
    {
        ...
        if ((mb_strlen($unit_long) < 0)) {
            throw new \InvalidArgumentException('invalid length for $unit_long when calling RecipesFindByIngredientsMissedIngredients., must be bigger than or equal to 0.');
        }
    ...
    public function setUnitShort($unit_short)
    {
        ...
        if ((mb_strlen($unit_short) < 0)) {
            throw new \InvalidArgumentException('invalid length for $unit_short when calling RecipesFindByIngredientsMissedIngredients., must be bigger than or equal to 0.');
        }
