...
#import "OAISet.h"
@protocol OAISearchGroceryProductsByUPC200ResponseIngredientsInner;
@class OAISearchGroceryProductsByUPC200ResponseIngredientsInner;
...
@protocol OAISearchGroceryProductsByUPC200Response
@end

@interface OAISearchGroceryProductsByUPC200Response : OAIObject
...
@property(nonatomic) OAISet<OAISearchGroceryProductsByUPC200ResponseIngredientsInner>* ingredients;
