...
/**
 * InlineResponse2003ExtendedIngredients Class Doc Comment
 *
 * @category Class
 * @package  com.spoonacular.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class InlineResponse2003ExtendedIngredients implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_3_extendedIngredients';
    ...
    protected static $openAPITypes = [
        ...
        'id' => 'int',
        'image' => 'string',
        'measures' => '\com.spoonacular.client\com.spoonacular.client.model\InlineResponse2003Measures',
        'meta' => 'string[]',
        'name' => 'string',
        'original' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['consitency'] = isset($data['consitency']) ? $data['consitency'] : null;
    ...
    public function setAisle($aisle)
    {
        ...
        if ((mb_strlen($aisle) < 1)) {
            throw new \InvalidArgumentException('invalid length for $aisle when calling InlineResponse2003ExtendedIngredients., must be bigger than or equal to 1.');
        }
    ...
    public function setConsitency($consitency)
    {
        ...
        if ((mb_strlen($consitency) < 1)) {
            throw new \InvalidArgumentException('invalid length for $consitency when calling InlineResponse2003ExtendedIngredients., must be bigger than or equal to 1.');
        }
    ...
    public function setImage($image)
    {
        ...
        if ((mb_strlen($image) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image when calling InlineResponse2003ExtendedIngredients., must be bigger than or equal to 1.');
        }
     ...
     * Gets measures
     *
     * @return \com.spoonacular.client\com.spoonacular.client.model\InlineResponse2003Measures|null
     */
     ...
     * Sets measures
     *
     * @param \com.spoonacular.client\com.spoonacular.client.model\InlineResponse2003Measures|null $measures measures
     *
     * @return $this
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineResponse2003ExtendedIngredients., must be bigger than or equal to 1.');
        }
    ...
    public function setOriginal($original)
    {
        ...
        if ((mb_strlen($original) < 1)) {
            throw new \InvalidArgumentException('invalid length for $original when calling InlineResponse2003ExtendedIngredients., must be bigger than or equal to 1.');
        }
    ...
    public function setOriginalName($original_name)
    {
        ...
        if ((mb_strlen($original_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $original_name when calling InlineResponse2003ExtendedIngredients., must be bigger than or equal to 1.');
        }
    ...
    public function setUnit($unit)
    {
        ...
        if ((mb_strlen($unit) < 0)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling InlineResponse2003ExtendedIngredients., must be bigger than or equal to 0.');
        }
