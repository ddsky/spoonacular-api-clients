...
class InlineResponse2003 implements ModelInterface, ArrayAccess
{
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling InlineResponse2003., must be bigger than or equal to 1.');
        }
    ...
    public function setImage($image)
    {
        ...
        if ((mb_strlen($image) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image when calling InlineResponse2003., must be bigger than or equal to 1.');
        }
    ...
    public function setImageType($image_type)
    {
        ...
        if ((mb_strlen($image_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image_type when calling InlineResponse2003., must be bigger than or equal to 1.');
        }
    ...
    public function setLicense($license)
    {
        ...
        if ((mb_strlen($license) < 1)) {
            throw new \InvalidArgumentException('invalid length for $license when calling InlineResponse2003., must be bigger than or equal to 1.');
        }
    ...
    public function setSourceName($source_name)
    {
        ...
        if ((mb_strlen($source_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $source_name when calling InlineResponse2003., must be bigger than or equal to 1.');
        }
    ...
    public function setSourceUrl($source_url)
    {
        ...
        if ((mb_strlen($source_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $source_url when calling InlineResponse2003., must be bigger than or equal to 1.');
        }
    ...
    public function setSpoonacularSourceUrl($spoonacular_source_url)
    {
        ...
        if ((mb_strlen($spoonacular_source_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $spoonacular_source_url when calling InlineResponse2003., must be bigger than or equal to 1.');
        }
    ...
    public function setCreditsText($credits_text)
    {
        ...
        if ((mb_strlen($credits_text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $credits_text when calling InlineResponse2003., must be bigger than or equal to 1.');
        }
    ...
    public function setGaps($gaps)
    {
        ...
        if ((mb_strlen($gaps) < 1)) {
            throw new \InvalidArgumentException('invalid length for $gaps when calling InlineResponse2003., must be bigger than or equal to 1.');
        }
    ...
    public function setSummary($summary)
    {
        ...
        if ((mb_strlen($summary) < 1)) {
            throw new \InvalidArgumentException('invalid length for $summary when calling InlineResponse2003., must be bigger than or equal to 1.');
        }
