...
class InlineResponse20036 implements ModelInterface, ArrayAccess
{
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling InlineResponse20036., must be bigger than or equal to 1.');
        }
    ...
    public function setRestaurantChain($restaurant_chain)
    {
        ...
        if ((mb_strlen($restaurant_chain) < 1)) {
            throw new \InvalidArgumentException('invalid length for $restaurant_chain when calling InlineResponse20036., must be bigger than or equal to 1.');
        }
    ...
    public function setImageType($image_type)
    {
        ...
        if ((mb_strlen($image_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image_type when calling InlineResponse20036., must be bigger than or equal to 1.');
        }
