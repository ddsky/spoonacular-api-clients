...
{
    my $id = undef; # replace NULL with a proper value
    my $result = $api->menu_item_nutrition_by_id_image(id => $id);
}
...
#
{
    ...
    my $result = $api->menu_item_nutrition_label_image(id => $id, show_optional_nutrients => $show_optional_nutrients, show_zero_values => $show_zero_values, show_ingredients => $show_ingredients);
}
...
#
{
    ...
    my $show_zero_values = undef; # replace NULL with a proper value
    my $show_ingredients = undef; # replace NULL with a proper value
    my $result = $api->menu_item_nutrition_label_widget(id => $id, default_css => $default_css, show_optional_nutrients => $show_optional_nutrients, show_zero_values => $show_zero_values, show_ingredients => $show_ingredients);
}
...
#
{
    ...
    my $add_menu_item_information = undef; # replace NULL with a proper value
    my $offset = undef; # replace NULL with a proper value
    my $number = undef; # replace NULL with a proper value
    my $result = $api->search_menu_items(query => $query, min_calories => $min_calories, max_calories => $max_calories, min_carbs => $min_carbs, max_carbs => $max_carbs, min_protein => $min_protein, max_protein => $max_protein, min_fat => $min_fat, max_fat => $max_fat, add_menu_item_information => $add_menu_item_information, offset => $offset, number => $number);
}
...
#
{
    ...
    my $result = $api->visualize_menu_item_nutrition_by_id(id => $id, default_css => $default_css, accept => $accept);
}
