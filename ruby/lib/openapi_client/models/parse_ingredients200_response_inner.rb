  ...
  class ParseIngredients200ResponseInner
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ParseIngredients200ResponseInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ParseIngredients200ResponseInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'possible_units')
        if (value = attributes[:'possible_units']).is_a?(Array)
          self.possible_units = value
        end
      else
        self.possible_units = nil
      end
    ...
    def list_invalid_properties
      ...
      if @name_clean.nil?
        invalid_properties.push('invalid value for "name_clean", name_clean cannot be nil.')
      end

      if @name_clean.to_s.length < 1
        invalid_properties.push('invalid value for "name_clean", the character length must be great than or equal to 1.')
      end
      ...
      if @unit.to_s.length < 1
        invalid_properties.push('invalid value for "unit", the character length must be great than or equal to 1.')
      end

      if @unit_short.nil?
        invalid_properties.push('invalid value for "unit_short", unit_short cannot be nil.')
      end

      if @unit_short.to_s.length < 1
        invalid_properties.push('invalid value for "unit_short", the character length must be great than or equal to 1.')
      end

      if @unit_long.nil?
        invalid_properties.push('invalid value for "unit_long", unit_long cannot be nil.')
      end

      if @unit_long.to_s.length < 1
        invalid_properties.push('invalid value for "unit_long", the character length must be great than or equal to 1.')
      end

      if @possible_units.nil?
        invalid_properties.push('invalid value for "possible_units", possible_units cannot be nil.')
      end
      ...
      if @consistency.to_s.length < 1
        invalid_properties.push('invalid value for "consistency", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @name_clean.nil?
      return false if @name_clean.to_s.length < 1
      return false if @amount.nil?
      return false if @unit.nil?
      return false if @unit.to_s.length < 1
      return false if @unit_short.nil?
      return false if @unit_short.to_s.length < 1
      return false if @unit_long.nil?
      return false if @unit_long.to_s.length < 1
      return false if @possible_units.nil?
      return false if @estimated_cost.nil?
      return false if @consistency.nil?
      return false if @consistency.to_s.length < 1
    ...
    # Custom attribute writer method with validation
    # @param [Object] name_clean Value to be assigned
    def name_clean=(name_clean)
      if name_clean.nil?
        fail ArgumentError, 'name_clean cannot be nil'
      end

      if name_clean.to_s.length < 1
        fail ArgumentError, 'invalid value for "name_clean", the character length must be great than or equal to 1.'
      end
    ...
    def unit=(unit)
      ...
      if unit.to_s.length < 1
        fail ArgumentError, 'invalid value for "unit", the character length must be great than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] unit_short Value to be assigned
    def unit_short=(unit_short)
      if unit_short.nil?
        fail ArgumentError, 'unit_short cannot be nil'
      end

      if unit_short.to_s.length < 1
        fail ArgumentError, 'invalid value for "unit_short", the character length must be great than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] unit_long Value to be assigned
    def unit_long=(unit_long)
      if unit_long.nil?
        fail ArgumentError, 'unit_long cannot be nil'
      end

      if unit_long.to_s.length < 1
        fail ArgumentError, 'invalid value for "unit_long", the character length must be great than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] consistency Value to be assigned
    def consistency=(consistency)
      if consistency.nil?
        fail ArgumentError, 'consistency cannot be nil'
      end

      if consistency.to_s.length < 1
        fail ArgumentError, 'invalid value for "consistency", the character length must be great than or equal to 1.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          possible_units == o.possible_units &&
    ...
    def hash
      [id, original, original_name, name, name_clean, amount, unit, unit_short, unit_long, possible_units, estimated_cost, consistency, aisle, image, meta, nutrition].hash
    end
