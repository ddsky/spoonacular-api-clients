...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpoonacularApi.GetRandomRecipes200ResponseRecipesInner();
  });
  ...
  describe('GetRandomRecipes200ResponseRecipesInner', function() {
    it('should create an instance of GetRandomRecipes200ResponseRecipesInner', function() {
      // uncomment below and update the code to test GetRandomRecipes200ResponseRecipesInner
      //var instance = new SpoonacularApi.GetRandomRecipes200ResponseRecipesInner();
      //expect(instance).to.be.a(SpoonacularApi.GetRandomRecipes200ResponseRecipesInner);
    });
