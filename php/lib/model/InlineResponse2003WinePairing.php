...
/**
 * InlineResponse2003WinePairing Class Doc Comment
 *
 * @category Class
 * @package  com.spoonacular.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class InlineResponse2003WinePairing implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_3_winePairing';
    ...
    protected static $openAPITypes = [
        'paired_wines' => 'string[]',
        'pairing_text' => 'string',
        'product_matches' => '\com.spoonacular.client\com.spoonacular.client.model\InlineResponse2003WinePairingProductMatches[]'
    ];
    ...
    public function setPairingText($pairing_text)
    {
        ...
        if ((mb_strlen($pairing_text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $pairing_text when calling InlineResponse2003WinePairing., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \com.spoonacular.client\com.spoonacular.client.model\InlineResponse2003WinePairingProductMatches[]
     */
     ...
     *
     * @param \com.spoonacular.client\com.spoonacular.client.model\InlineResponse2003WinePairingProductMatches[] $product_matches product_matches
     *
     * @return $this
     */
