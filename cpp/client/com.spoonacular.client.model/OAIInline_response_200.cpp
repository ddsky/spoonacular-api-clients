...
qint32
OAIInline_response_200::getOffset() const {
    return offset;
}
void
OAIInline_response_200::setOffset(const qint32 &offset) {
    this->offset = offset;
...
qint32
OAIInline_response_200::getNumber() const {
    return number;
}
void
OAIInline_response_200::setNumber(const qint32 &number) {
    this->number = number;
    this->m_number_isSet = true;
}


QList<OAIInline_response_200_results>
OAIInline_response_200::getResults() const {
    return results;
}
void
OAIInline_response_200::setResults(const QList<OAIInline_response_200_results> &results) {
...
qint32
OAIInline_response_200::getTotalResults() const {
    return total_results;
}
void
OAIInline_response_200::setTotalResults(const qint32 &total_results) {
