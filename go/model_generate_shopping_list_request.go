...
// checks if the GenerateShoppingListRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenerateShoppingListRequest{}
...
type _GenerateShoppingListRequest GenerateShoppingListRequest
...
func (o GenerateShoppingListRequest) ToMap() (map[string]interface{}, error) {
...
func (o *GenerateShoppingListRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varGenerateShoppingListRequest := _GenerateShoppingListRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGenerateShoppingListRequest)

	if err != nil {
		return err
	}

	*o = GenerateShoppingListRequest(varGenerateShoppingListRequest)
