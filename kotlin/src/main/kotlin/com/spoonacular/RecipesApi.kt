...
class RecipesApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getRandomRecipes(limitLicense: kotlin.Boolean? = true, tags: kotlin.String? = null, number: kotlin.Int? = 10) : GetRandomRecipes200Response {
        val localVarResponse = getRandomRecipesWithHttpInfo(limitLicense = limitLicense, tags = tags, number = number)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getRandomRecipesWithHttpInfo(limitLicense: kotlin.Boolean?, tags: kotlin.String?, number: kotlin.Int?) : ApiResponse<GetRandomRecipes200Response?> {
        val localVariableConfig = getRandomRecipesRequestConfig(limitLicense = limitLicense, tags = tags, number = number)
     ...
     * @return RequestConfig
     */
    fun getRandomRecipesRequestConfig(limitLicense: kotlin.Boolean?, tags: kotlin.String?, number: kotlin.Int?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
