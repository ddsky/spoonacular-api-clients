        ...
        if include_optional:
            return SearchRestaurants200ResponseRestaurantsInnerLocalHours(
                ...
                delivery = spoonacular.models.search_restaurants_200_response_restaurants_inner_local_hours_operational.searchRestaurants_200_response_restaurants_inner_local_hours_operational(
                    ...
                    saturday = '', 
                    sunday = '', ),
                pickup = spoonacular.models.search_restaurants_200_response_restaurants_inner_local_hours_operational.searchRestaurants_200_response_restaurants_inner_local_hours_operational(
                    monday = '', 
                    tuesday = '', 
                    wednesday = '', 
                    thursday = '', 
                    ...
                    saturday = '', 
                    sunday = '', ),
                dine_in = spoonacular.models.search_restaurants_200_response_restaurants_inner_local_hours_operational.searchRestaurants_200_response_restaurants_inner_local_hours_operational(
                    monday = '', 
                    tuesday = '', 
                    wednesday = '', 
                    thursday = '', 
