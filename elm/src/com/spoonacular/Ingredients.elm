...
-}
autocompleteIngredientSearch : Maybe String -> Maybe Int -> Maybe Bool -> Maybe String -> Api.Request (List Api.Data.AutocompleteIngredientSearch200ResponseInner)
autocompleteIngredientSearch query_query number_query metaInformation_query intolerances_query =
    Api.request
        "GET"
        "/food/ingredients/autocomplete"
        []
        [ ( "query", Maybe.map identity query_query ), ( "number", Maybe.map String.fromInt number_query ), ( "metaInformation", Maybe.map (\val -> if val then "true" else "false") metaInformation_query ), ( "intolerances", Maybe.map identity intolerances_query ) ]
        []
        Nothing
...
-}
ingredientSearch : Maybe String -> Maybe Bool -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Bool -> Maybe String -> Maybe String -> Maybe String -> Maybe Int -> Maybe Int -> Api.Request Api.Data.IngredientSearch200Response
ingredientSearch query_query addChildren_query minProteinPercent_query maxProteinPercent_query minFatPercent_query maxFatPercent_query minCarbsPercent_query maxCarbsPercent_query metaInformation_query intolerances_query sort_query sortDirection_query offset_query number_query =
    Api.request
        "GET"
