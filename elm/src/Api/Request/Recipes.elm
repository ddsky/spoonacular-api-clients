...
-}
getRandomRecipes : Maybe Bool -> Maybe Bool -> Maybe String -> Maybe String -> Maybe Int -> Api.Request Api.Data.GetRandomRecipes200Response
getRandomRecipes limitLicense_query includeNutrition_query includeTags_query excludeTags_query number_query =
    Api.request
        "GET"
        "/recipes/random"
        []
        [ ( "limitLicense", Maybe.map (\val -> if val then "true" else "false") limitLicense_query ), ( "includeNutrition", Maybe.map (\val -> if val then "true" else "false") includeNutrition_query ), ( "include-tags", Maybe.map identity includeTags_query ), ( "exclude-tags", Maybe.map identity excludeTags_query ), ( "number", Maybe.map String.fromInt number_query ) ]
        []
        Nothing
...
-}
searchRecipes : Maybe String -> Maybe String -> Maybe String -> Maybe String -> Maybe String -> Maybe String -> Maybe String -> Maybe String -> Maybe String -> Maybe Bool -> Maybe Bool -> Maybe Bool -> Maybe Bool -> Maybe String -> Maybe String -> Maybe Float -> Maybe String -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Bool -> Maybe String -> Maybe String -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Float -> Maybe Int -> Maybe Int -> Maybe Bool -> Api.Request Api.Data.SearchRecipes200Response
