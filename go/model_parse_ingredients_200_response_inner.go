...
// checks if the ParseIngredients200ResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ParseIngredients200ResponseInner{}
...
type _ParseIngredients200ResponseInner ParseIngredients200ResponseInner
...
func (o *ParseIngredients200ResponseInner) UnmarshalJSON(data []byte) (err error) {
	...
	varParseIngredients200ResponseInner := _ParseIngredients200ResponseInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varParseIngredients200ResponseInner)

	if err != nil {
		return err
	}

	*o = ParseIngredients200ResponseInner(varParseIngredients200ResponseInner)
