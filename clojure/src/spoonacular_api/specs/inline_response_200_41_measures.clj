(ns spoonacular-api.specs.inline-response-200-41-measures
...
(def inline-response-200-41-measures-data
  {
...
(def inline-response-200-41-measures-spec
  (ds/spec
    {:name ::inline-response-200-41-measures
     :spec inline-response-200-41-measures-data}))
