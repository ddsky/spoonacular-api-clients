...
pub trait DefaultApi {
    ...
    fn get_food_information(&self, id: f32, amount: f32, unit: &str) -> Box<Future<Item = Value, Error = Error<serde_json::Value>>>;
    ...
    fn get_recipe_nutrition_by_id(&self, id: f32) -> Box<Future<Item = Value, Error = Error<serde_json::Value>>>;
...
impl<C: hyper::client::Connect>DefaultApi for DefaultApiClient<C> {
    ...
    fn generate_meal_plan(&self, time_frame: &str, target_calories: f32, diet: &str, exclude: &str) -> Box<Future<Item = Value, Error = Error<serde_json::Value>>> {
        __internal_request::Request::new(hyper::Method::Get, "/recipes/mealplans/generate".to_string())
