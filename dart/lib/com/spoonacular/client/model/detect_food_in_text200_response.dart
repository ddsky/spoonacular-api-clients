...
class DetectFoodInText200Response {
  ...
  static DetectFoodInText200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return DetectFoodInText200Response(
        annotations: DetectFoodInText200ResponseAnnotationsInner.listFromJson(json[r'annotations'])!,
      );
    }
    return null;
  }
  ...
  static Map<String, List<DetectFoodInText200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DetectFoodInText200Response.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
