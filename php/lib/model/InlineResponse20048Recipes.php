...
/**
 * InlineResponse20048Recipes Class Doc Comment
 *
 * @category Class
 * @package  com.spoonacular.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class InlineResponse20048Recipes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_48_recipes';
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling InlineResponse20048Recipes., must be bigger than or equal to 1.');
        }
    ...
    public function setImageType($image_type)
    {
        ...
        if ((mb_strlen($image_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image_type when calling InlineResponse20048Recipes., must be bigger than or equal to 1.');
        }
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling InlineResponse20048Recipes., must be bigger than or equal to 1.');
        }
