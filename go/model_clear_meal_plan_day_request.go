...
// checks if the ClearMealPlanDayRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClearMealPlanDayRequest{}
...
type _ClearMealPlanDayRequest ClearMealPlanDayRequest
...
func (o ClearMealPlanDayRequest) ToMap() (map[string]interface{}, error) {
...
func (o *ClearMealPlanDayRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varClearMealPlanDayRequest := _ClearMealPlanDayRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varClearMealPlanDayRequest)

	if err != nil {
		return err
	}

	*o = ClearMealPlanDayRequest(varClearMealPlanDayRequest)
