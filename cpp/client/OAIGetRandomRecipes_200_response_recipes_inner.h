...
private:
    ...
    QSet<OAIGetRecipeInformation_200_response_extendedIngredients_inner> m_extended_ingredients;
    ...
    OAIGetRecipeInformation_200_response_winePairing m_wine_pairing;
