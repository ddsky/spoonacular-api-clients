...
func (a *IngredientsAPIService) AutocompleteIngredientSearchExecute(r ApiAutocompleteIngredientSearchRequest) ([]AutocompleteIngredientSearch200ResponseInner, *http.Response, error) {
	...
	if r.metaInformation != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "metaInformation", r.metaInformation, "")
	}
...
func (a *IngredientsAPIService) ComputeIngredientAmountExecute(r ApiComputeIngredientAmountRequest) (*ComputeIngredientAmount200Response, *http.Response, error) {
	...
	parameterAddToHeaderOrQuery(localVarQueryParams, "nutrient", r.nutrient, "")
...
func (a *IngredientsAPIService) IngredientSearchExecute(r ApiIngredientSearchRequest) (*IngredientSearch200Response, *http.Response, error) {
	...
	if r.minProteinPercent != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "minProteinPercent", r.minProteinPercent, "")
	}
	if r.maxProteinPercent != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "maxProteinPercent", r.maxProteinPercent, "")
	}
	if r.minFatPercent != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "minFatPercent", r.minFatPercent, "")
	}
	if r.maxFatPercent != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "maxFatPercent", r.maxFatPercent, "")
	}
	if r.minCarbsPercent != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "minCarbsPercent", r.minCarbsPercent, "")
	}
	if r.maxCarbsPercent != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "maxCarbsPercent", r.maxCarbsPercent, "")
	}
	if r.metaInformation != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "metaInformation", r.metaInformation, "")
	}
...
func (r ApiIngredientsByIDImageRequest) Execute() (*os.File, *http.Response, error) {
...
func (a *IngredientsAPIService) VisualizeIngredientsExecute(r ApiVisualizeIngredientsRequest) (string, *http.Response, error) {
	...
	if r.measure != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "measure", r.measure, "")
	}
	if r.view != nil {
