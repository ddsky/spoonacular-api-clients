...
class GetMealPlanWeek200ResponseDaysInnerNutritionSummary {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetMealPlanWeek200ResponseDaysInnerNutritionSummary.RequiredProperties) {
        ...
        if (data['nutrients']) { // data not null
            ...
            for (const item of data['nutrients']) {
                GetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner.validateJSON(item);
            };
        }
