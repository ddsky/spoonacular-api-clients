...
QString
OAIInline_object_4::getUsername() const {
    return username;
}
void
OAIInline_object_4::setUsername(const QString &username) {
...
QString
OAIInline_object_4::getHash() const {
    return hash;
}
void
OAIInline_object_4::setHash(const QString &hash) {
    this->hash = hash;
