...
/**
 * IngredientInformationNutrition Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IngredientInformationNutrition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IngredientInformation_nutrition';
    ...
    protected static $openAPITypes = [
        ...
        'properties' => '\OpenAPI\Client\Model\IngredientInformationNutritionPropertiesInner[]',
        'caloric_breakdown' => '\OpenAPI\Client\Model\SearchGroceryProductsByUPC200ResponseNutritionCaloricBreakdown',
        'weight_per_serving' => '\OpenAPI\Client\Model\GetShoppingList200ResponseAislesInnerItemsInnerMeasuresOriginal'
    ];
    ...
    */
    ...
    public function setNutrients($nutrients)
    {
        ...
        if ((count($nutrients) < 0)) {
            throw new \InvalidArgumentException('invalid length for $nutrients when calling IngredientInformationNutrition., number of items must be greater than or equal to 0.');
        }
     ...
     * Gets properties
     *
     * @return \OpenAPI\Client\Model\IngredientInformationNutritionPropertiesInner[]
     */
     ...
     * Sets properties
     *
     * @param \OpenAPI\Client\Model\IngredientInformationNutritionPropertiesInner[] $properties properties
     *
     * @return self
     */
    public function setProperties($properties)
    {
        ...
        if ((count($properties) < 0)) {
            throw new \InvalidArgumentException('invalid length for $properties when calling IngredientInformationNutrition., number of items must be greater than or equal to 0.');
        }
     ...
     *
     * @param \OpenAPI\Client\Model\GetShoppingList200ResponseAislesInnerItemsInnerMeasuresOriginal $weight_per_serving weight_per_serving
     *
     * @return self
     */
