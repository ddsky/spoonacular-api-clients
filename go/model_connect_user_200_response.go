...
// checks if the ConnectUser200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectUser200Response{}
...
type _ConnectUser200Response ConnectUser200Response
...
func (o *ConnectUser200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varConnectUser200Response := _ConnectUser200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConnectUser200Response)

	if err != nil {
		return err
	}

	*o = ConnectUser200Response(varConnectUser200Response)
