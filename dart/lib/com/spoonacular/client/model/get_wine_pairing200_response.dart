...
class GetWinePairing200Response {
  ...
  static GetWinePairing200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GetWinePairing200Response(
        ...
        productMatches: GetWinePairing200ResponseProductMatchesInner.listFromJson(json[r'productMatches'])!,
      );
    }
    return null;
  }
  ...
  static Map<String, List<GetWinePairing200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetWinePairing200Response.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
