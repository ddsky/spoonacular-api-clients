...
class AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInner {
  ...
  static AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInner(
        ...
        ingredients: AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerIngredientsInner.listFromJson(json[r'ingredients']) ?? const {},
        equipment: AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerIngredientsInner.listFromJson(json[r'equipment']) ?? const {},
      );
    }
    return null;
  }
  ...
  static Map<String, List<AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AnalyzeRecipeInstructions200ResponseParsedInstructionsInnerStepsInner.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
