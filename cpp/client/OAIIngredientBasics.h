...
#ifndef OAIIngredientBasics_H
#define OAIIngredientBasics_H
...
class OAIIngredientBasics : public OAIObject {
public:
    OAIIngredientBasics();
    OAIIngredientBasics(QString json);
    ~OAIIngredientBasics() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIngredientBasics)

#endif // OAIIngredientBasics_H
