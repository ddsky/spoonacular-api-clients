...
// checks if the GetShoppingList200ResponseAislesInnerItemsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetShoppingList200ResponseAislesInnerItemsInner{}
...
type _GetShoppingList200ResponseAislesInnerItemsInner GetShoppingList200ResponseAislesInnerItemsInner
...
func (o *GetShoppingList200ResponseAislesInnerItemsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGetShoppingList200ResponseAislesInnerItemsInner := _GetShoppingList200ResponseAislesInnerItemsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetShoppingList200ResponseAislesInnerItemsInner)

	if err != nil {
		return err
	}

	*o = GetShoppingList200ResponseAislesInnerItemsInner(varGetShoppingList200ResponseAislesInnerItemsInner)
