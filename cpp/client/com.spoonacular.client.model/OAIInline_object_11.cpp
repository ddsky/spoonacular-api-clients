...
QString
OAIInline_object_11::getUsername() const {
    return username;
}
void
OAIInline_object_11::setUsername(const QString &username) {
...
QString
OAIInline_object_11::getStartDate() const {
    return start_date;
}
void
OAIInline_object_11::setStartDate(const QString &start_date) {
...
QString
OAIInline_object_11::getEndDate() const {
    return end_date;
}
void
OAIInline_object_11::setEndDate(const QString &end_date) {
...
QString
OAIInline_object_11::getHash() const {
    return hash;
}
void
OAIInline_object_11::setHash(const QString &hash) {
    this->hash = hash;
