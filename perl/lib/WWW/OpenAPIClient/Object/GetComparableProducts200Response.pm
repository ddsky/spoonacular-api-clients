...
#
package WWW::OpenAPIClient::Object::GetComparableProducts200Response;
...
__PACKAGE__->method_documentation({
    'comparable_products' => {
        datatype => 'GetComparableProducts200ResponseComparableProducts',
        base_name => 'comparableProducts',
        description => '',
        format => '',
        read_only => '',
            },
