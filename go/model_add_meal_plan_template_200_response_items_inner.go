...
// checks if the AddMealPlanTemplate200ResponseItemsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddMealPlanTemplate200ResponseItemsInner{}
...
type _AddMealPlanTemplate200ResponseItemsInner AddMealPlanTemplate200ResponseItemsInner
...
func (o *AddMealPlanTemplate200ResponseItemsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varAddMealPlanTemplate200ResponseItemsInner := _AddMealPlanTemplate200ResponseItemsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAddMealPlanTemplate200ResponseItemsInner)

	if err != nil {
		return err
	}

	*o = AddMealPlanTemplate200ResponseItemsInner(varAddMealPlanTemplate200ResponseItemsInner)
