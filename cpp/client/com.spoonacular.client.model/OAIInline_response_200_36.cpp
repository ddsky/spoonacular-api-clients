...
#include "OAIInline_response_200_36.h"
...
OAIInline_response_200_36::OAIInline_response_200_36(QString json) {
    this->init();
    this->fromJson(json);
}

OAIInline_response_200_36::OAIInline_response_200_36() {
    this->init();
}
...
void
OAIInline_response_200_36::init() {
...
void
OAIInline_response_200_36::fromJson(QString jsonString) {
...
void
OAIInline_response_200_36::fromJsonObject(QJsonObject json) {
...
QString
OAIInline_response_200_36::asJson () const {
...
QJsonObject
OAIInline_response_200_36::asJsonObject() const {
    QJsonObject obj;
	if(m_id_isSet){
...
qint32
OAIInline_response_200_36::getId() const {
    return id;
}
void
OAIInline_response_200_36::setId(const qint32 &id) {
    this->id = id;
...
QString
OAIInline_response_200_36::getTitle() const {
    return title;
}
void
OAIInline_response_200_36::setTitle(const QString &title) {
    this->title = title;
...
QString
OAIInline_response_200_36::getRestaurantChain() const {
    return restaurant_chain;
}
void
OAIInline_response_200_36::setRestaurantChain(const QString &restaurant_chain) {
...
OAIInline_response_200_36::getNutrition() const {
    return nutrition;
}
void
OAIInline_response_200_36::setNutrition(const OAIInline_response_200_28_nutrition &nutrition) {
...
QList<QString>
OAIInline_response_200_36::getBadges() const {
    return badges;
}
void
OAIInline_response_200_36::setBadges(const QList<QString> &badges) {
    this->badges = badges;
...
QList<QString>
OAIInline_response_200_36::getBreadcrumbs() const {
    return breadcrumbs;
}
void
OAIInline_response_200_36::setBreadcrumbs(const QList<QString> &breadcrumbs) {
...
QString
OAIInline_response_200_36::getGeneratedText() const {
    return generated_text;
}
void
OAIInline_response_200_36::setGeneratedText(const QString &generated_text) {
...
QString
OAIInline_response_200_36::getImageType() const {
    return image_type;
}
void
OAIInline_response_200_36::setImageType(const QString &image_type) {
...
OAINumber
OAIInline_response_200_36::getLikes() const {
    return likes;
}
void
OAIInline_response_200_36::setLikes(const OAINumber &likes) {
    this->likes = likes;
...
OAIInline_response_200_36::getServings() const {
    return servings;
}
void
OAIInline_response_200_36::setServings(const OAIInline_response_200_28_servings &servings) {
...
OAINumber
OAIInline_response_200_36::getPrice() const {
    return price;
}
void
OAIInline_response_200_36::setPrice(const OAINumber &price) {
    this->price = price;
...
OAINumber
OAIInline_response_200_36::getSpoonacularScore() const {
    return spoonacular_score;
}
void
OAIInline_response_200_36::setSpoonacularScore(const OAINumber &spoonacular_score) {
    this->spoonacular_score = spoonacular_score;
    this->m_spoonacular_score_isSet = true;
}

bool
OAIInline_response_200_36::isSet() const {
...
bool
OAIInline_response_200_36::isValid() const {
