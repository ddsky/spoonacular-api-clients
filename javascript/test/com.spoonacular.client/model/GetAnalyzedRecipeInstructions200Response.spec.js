...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpoonacularApi.GetAnalyzedRecipeInstructions200Response();
  });
  ...
  describe('GetAnalyzedRecipeInstructions200Response', function() {
    it('should create an instance of GetAnalyzedRecipeInstructions200Response', function() {
      // uncomment below and update the code to test GetAnalyzedRecipeInstructions200Response
      //var instance = new SpoonacularApi.GetAnalyzedRecipeInstructions200Response();
      //expect(instance).to.be.a(SpoonacularApi.GetAnalyzedRecipeInstructions200Response);
    });
