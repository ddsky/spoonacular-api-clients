...
class AnalyzeRecipeRequest {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (includeNutrition != null) {
      _json[r'includeNutrition'] = includeNutrition;
    } else {
      _json[r'includeNutrition'] = null;
    }
    if (includeTaste != null) {
      _json[r'includeTaste'] = includeTaste;
    } else {
      _json[r'includeTaste'] = null;
    }
    return _json;
  }
  ...
  static Map<String, List<AnalyzeRecipeRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AnalyzeRecipeRequest.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
