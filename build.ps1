...
java -jar .\openapi-generator-cli-7.3.0.jar generate -i .\spoonacular-openapi-3.json -g typescript-angular --artifact-version $VERSION --additional-properties packageVersion=$VERSION,project-name=spoonacular,packageName=spoonacular  --git-repo-id=spoonacular-api-clients/tree/master/angular/ --git-user-id=ddsky --artifact-id angular-client -o angular --additional-properties "npmName=spoonacular-angular"
...
java -jar .\openapi-generator-cli-7.3.0.jar generate -i .\spoonacular-openapi-3.json -g go --artifact-version $VERSION --additional-properties packageVersion=$VERSION,project-name=spoonacular,packageName=spoonacular  --git-repo-id=spoonacular-api-clients/go --git-user-id=ddsky --artifact-id go-client -o go --name-mappings _=Underscore
...
java -jar .\openapi-generator-cli-7.3.0.jar generate -i .\spoonacular-openapi-3.json -g python --artifact-version $VERSION --additional-properties packageVersion=$VERSION,project-name=spoonacular,packageName=spoonacular  --git-repo-id=spoonacular-api-clients/tree/master/python/ --git-user-id=ddsky --artifact-id python-client -o python --name-mappings _=underscore
java -jar .\openapi-generator-cli-7.3.0.jar generate -i .\spoonacular-openapi-3.json -g rust --artifact-version $VERSION --additional-properties packageVersion=$VERSION,project-name=spoonacular,packageName=spoonacular  --git-repo-id=spoonacular-api-clients/tree/master/rust/ --git-user-id=ddsky --artifact-id rust-client -o rust --name-mappings _=underscore
...
java -jar .\openapi-generator-cli-7.3.0.jar generate -i .\spoonacular-openapi-3.json -g groovy --artifact-version $VERSION --additional-properties packageVersion=$VERSION,project-name=spoonacular,packageName=spoonacular  --git-repo-id=spoonacular-api-clients/tree/master/groovy/ --git-user-id=ddsky --artifact-id groovy-client -o groovy --additional-properties hideGenerationTimestamp=true
