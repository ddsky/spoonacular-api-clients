...
namespace spoonacular.Model {
  ...
  public class InlineResponse20048Nutrition {
    ...
    public InlineResponse20048NutritionCalories Calories { get; set; }
    ...
    public InlineResponse20048NutritionCalories Fat { get; set; }
    ...
    public InlineResponse20048NutritionCalories Protein { get; set; }
    ...
    public InlineResponse20048NutritionCalories Carbs { get; set; }
