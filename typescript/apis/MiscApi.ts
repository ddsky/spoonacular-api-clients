...
export class MiscApiResponseProcessor {
     ...
     */
     public async detectFoodInTextWithHttpInfo(response: ResponseContext): Promise<HttpInfo<DetectFoodInText200Response >> {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getARandomFoodJokeWithHttpInfo(response: ResponseContext): Promise<HttpInfo<GetARandomFoodJoke200Response >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getConversationSuggestsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<GetConversationSuggests200Response >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async imageAnalysisByURLWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ImageAnalysisByURL200Response >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async imageClassificationByURLWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ImageClassificationByURL200Response >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async searchAllFoodWithHttpInfo(response: ResponseContext): Promise<HttpInfo<SearchAllFood200Response >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async searchCustomFoodsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<SearchCustomFoods200Response >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async searchFoodVideosWithHttpInfo(response: ResponseContext): Promise<HttpInfo<SearchFoodVideos200Response >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async searchSiteContentWithHttpInfo(response: ResponseContext): Promise<HttpInfo<SearchSiteContent200Response >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async talkToChatbotWithHttpInfo(response: ResponseContext): Promise<HttpInfo<TalkToChatbot200Response >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
