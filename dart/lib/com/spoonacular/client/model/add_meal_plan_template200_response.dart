...
class AddMealPlanTemplate200Response {
  ...
  Map<String, dynamic> toJson() {
    final _json = <String, dynamic>{};
      _json[r'name'] = name;
      _json[r'items'] = items;
      _json[r'publishAsPublic'] = publishAsPublic;
    return _json;
  }
  ...
  static AddMealPlanTemplate200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return AddMealPlanTemplate200Response(
        ...
        items: AddMealPlanTemplate200ResponseItemsInner.listFromJson(json[r'items'])!,
  ...
  static Map<String, List<AddMealPlanTemplate200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AddMealPlanTemplate200Response.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
