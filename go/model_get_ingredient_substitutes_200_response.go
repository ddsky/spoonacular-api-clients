...
// checks if the GetIngredientSubstitutes200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetIngredientSubstitutes200Response{}
...
type _GetIngredientSubstitutes200Response GetIngredientSubstitutes200Response
...
func (o *GetIngredientSubstitutes200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetIngredientSubstitutes200Response := _GetIngredientSubstitutes200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetIngredientSubstitutes200Response)

	if err != nil {
		return err
	}

	*o = GetIngredientSubstitutes200Response(varGetIngredientSubstitutes200Response)
