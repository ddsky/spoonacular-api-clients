...
/**
 * InlineResponse2003WinePairingProductMatches Class Doc Comment
 *
 * @category Class
 * @package  com.spoonacular.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class InlineResponse2003WinePairingProductMatches implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_3_winePairing_productMatches';
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling InlineResponse2003WinePairingProductMatches., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InlineResponse2003WinePairingProductMatches., must be bigger than or equal to 1.');
        }
    ...
    public function setPrice($price)
    {
        ...
        if ((mb_strlen($price) < 1)) {
            throw new \InvalidArgumentException('invalid length for $price when calling InlineResponse2003WinePairingProductMatches., must be bigger than or equal to 1.');
        }
    ...
    public function setImageUrl($image_url)
    {
        ...
        if ((mb_strlen($image_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling InlineResponse2003WinePairingProductMatches., must be bigger than or equal to 1.');
        }
    ...
    public function setLink($link)
    {
        ...
        if ((mb_strlen($link) < 1)) {
            throw new \InvalidArgumentException('invalid length for $link when calling InlineResponse2003WinePairingProductMatches., must be bigger than or equal to 1.');
        }
