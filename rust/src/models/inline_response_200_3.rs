...
pub struct InlineResponse2003 {
    ...
    pub analyzed_instructions: Vec<Value>,
    #[serde(rename = "cheap")]
    pub cheap: bool,
    ...
    pub extended_ingredients: Vec<::models::InlineResponse2003ExtendedIngredients>,
    #[serde(rename = "summary")]
    pub summary: String,
    #[serde(rename = "winePairing")]
    pub wine_pairing: ::models::InlineResponse2003WinePairing,
}

impl InlineResponse2003 {
    pub fn new(id: i32, title: String, image: String, image_type: String, servings: f32, ready_in_minutes: i32, license: String, source_name: String, source_url: String, spoonacular_source_url: String, aggregate_likes: i32, health_score: f32, spoonacular_score: f32, price_per_serving: f32, analyzed_instructions: Vec<Value>, cheap: bool, credits_text: String, cuisines: Vec<String>, dairy_free: bool, diets: Vec<String>, gaps: String, gluten_free: bool, instructions: String, ketogenic: bool, low_fodmap: bool, occasions: Vec<String>, sustainable: bool, vegan: bool, vegetarian: bool, very_healthy: bool, very_popular: bool, whole30: bool, weight_watcher_smart_points: f32, dish_types: Vec<String>, extended_ingredients: Vec<::models::InlineResponse2003ExtendedIngredients>, summary: String, wine_pairing: ::models::InlineResponse2003WinePairing) -> InlineResponse2003 {
        InlineResponse2003 {
            id: id,
            title: title,
            image: image,
