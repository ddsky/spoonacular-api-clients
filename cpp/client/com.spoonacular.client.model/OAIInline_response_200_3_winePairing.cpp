...
#include "OAIInline_response_200_3_winePairing.h"
...
OAIInline_response_200_3_winePairing::OAIInline_response_200_3_winePairing(QString json) {
    this->init();
    this->fromJson(json);
}

OAIInline_response_200_3_winePairing::OAIInline_response_200_3_winePairing() {
    this->init();
}
...
void
OAIInline_response_200_3_winePairing::init() {
...
void
OAIInline_response_200_3_winePairing::fromJson(QString jsonString) {
...
void
OAIInline_response_200_3_winePairing::fromJsonObject(QJsonObject json) {
...
QString
OAIInline_response_200_3_winePairing::asJson () const {
...
QJsonObject
OAIInline_response_200_3_winePairing::asJsonObject() const {
    QJsonObject obj;
...
QList<QString>
OAIInline_response_200_3_winePairing::getPairedWines() const {
    return paired_wines;
}
void
OAIInline_response_200_3_winePairing::setPairedWines(const QList<QString> &paired_wines) {
...
QString
OAIInline_response_200_3_winePairing::getPairingText() const {
    return pairing_text;
}
void
OAIInline_response_200_3_winePairing::setPairingText(const QString &pairing_text) {
    this->pairing_text = pairing_text;
    this->m_pairing_text_isSet = true;
}


QList<OAIInline_response_200_3_winePairing_productMatches>
OAIInline_response_200_3_winePairing::getProductMatches() const {
    return product_matches;
}
void
OAIInline_response_200_3_winePairing::setProductMatches(const QList<OAIInline_response_200_3_winePairing_productMatches> &product_matches) {
    this->product_matches = product_matches;
    this->m_product_matches_isSet = true;
}

bool
OAIInline_response_200_3_winePairing::isSet() const {
...
bool
OAIInline_response_200_3_winePairing::isValid() const {
