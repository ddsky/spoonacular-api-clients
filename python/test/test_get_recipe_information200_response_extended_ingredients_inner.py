...
class TestGetRecipeInformation200ResponseExtendedIngredientsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetRecipeInformation200ResponseExtendedIngredientsInner:
        ...
        """
        model = GetRecipeInformation200ResponseExtendedIngredientsInner()
        if include_optional:
