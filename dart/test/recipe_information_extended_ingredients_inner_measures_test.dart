...
// tests for RecipeInformationExtendedIngredientsInnerMeasures
void main() {
  // final instance = RecipeInformationExtendedIngredientsInnerMeasures();

  group('test RecipeInformationExtendedIngredientsInnerMeasures', () {
