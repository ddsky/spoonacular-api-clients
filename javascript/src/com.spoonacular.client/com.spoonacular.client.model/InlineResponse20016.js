    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('parsedInstructions')) {
                obj['parsedInstructions'] = ApiClient.convertToType(data['parsedInstructions'], [Object]);
            }
            if (data.hasOwnProperty('ingredients')) {
                obj['ingredients'] = ApiClient.convertToType(data['ingredients'], [Object]);
            }
            if (data.hasOwnProperty('equipment')) {
                obj['equipment'] = ApiClient.convertToType(data['equipment'], [Object]);
            }
        }
        return obj;
    }
