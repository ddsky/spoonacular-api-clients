...
class ImageAnalysisByURL200ResponseNutritionCalories {
  ...
  Map<String, dynamic> toJson() {
    final _json = <String, dynamic>{};
      _json[r'value'] = value;
      _json[r'unit'] = unit;
      _json[r'confidenceRange95Percent'] = confidenceRange95Percent;
      _json[r'standardDeviation'] = standardDeviation;
    return _json;
  }
  ...
  static ImageAnalysisByURL200ResponseNutritionCalories? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ImageAnalysisByURL200ResponseNutritionCalories(
        ...
        standardDeviation: json[r'standardDeviation'] == null
            ? null
            : num.parse(json[r'standardDeviation'].toString()),
      );
    }
    return null;
  }
  ...
  static Map<String, List<ImageAnalysisByURL200ResponseNutritionCalories>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ImageAnalysisByURL200ResponseNutritionCalories.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
