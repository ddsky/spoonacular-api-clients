## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `spoonacular API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the spoonacular API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | Spoonacular                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | spoonacular                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | SpoonacularConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | SpoonacularRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| Spoonacular.Client    | use the "dispatch" functions to send requests       |
| Spoonacular.Core      | core functions, config and request types            |
| Spoonacular.API       | construct api requests                              |
| Spoonacular.Model     | describes api models                                |
| Spoonacular.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| Spoonacular.ModelLens | lenses for model fields                             |
| Spoonacular.Logging   | logging functions and utils                         |
