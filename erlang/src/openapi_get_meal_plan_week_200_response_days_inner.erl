-module(openapi_get_meal_plan_week_200_response_days_inner).

-export([encode/1]).

-export_type([openapi_get_meal_plan_week_200_response_days_inner/0]).

-type openapi_get_meal_plan_week_200_response_days_inner() ::
