...
/**
 * InlineResponse20048NutritionCalories Class Doc Comment
 *
 * @category Class
 * @package  com.spoonacular.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class InlineResponse20048NutritionCalories implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_48_nutrition_calories';
    ...
    protected static $openAPITypes = [
        'value' => 'float',
        'unit' => 'string',
        'confidence_range95_percent' => '\com.spoonacular.client\com.spoonacular.client.model\InlineResponse20048NutritionCaloriesConfidenceRange95Percent',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['confidence_range95_percent'] = isset($data['confidence_range95_percent']) ? $data['confidence_range95_percent'] : null;
    ...
    public function setUnit($unit)
    {
        ...
        if ((mb_strlen($unit) < 1)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling InlineResponse20048NutritionCalories., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \com.spoonacular.client\com.spoonacular.client.model\InlineResponse20048NutritionCaloriesConfidenceRange95Percent
     */
     ...
     *
     * @param \com.spoonacular.client\com.spoonacular.client.model\InlineResponse20048NutritionCaloriesConfidenceRange95Percent $confidence_range95_percent confidence_range95_percent
     *
     * @return $this
     */
