...
export class ObservableIngredientsApi {
     ...
     */
    public autocompleteIngredientSearch(query?: string, number?: number, metaInformation?: boolean, intolerances?: string, _options?: Configuration): Observable<Set<AutocompleteIngredientSearch200ResponseInner>> {
        const requestContextPromise = this.requestFactory.autocompleteIngredientSearch(query, number, metaInformation, intolerances, _options);
    ...
    public ingredientSearch(query?: string, addChildren?: boolean, minProteinPercent?: number, maxProteinPercent?: number, minFatPercent?: number, maxFatPercent?: number, minCarbsPercent?: number, maxCarbsPercent?: number, metaInformation?: boolean, intolerances?: string, sort?: string, sortDirection?: string, offset?: number, number?: number, _options?: Configuration): Observable<IngredientSearch200Response> {
        const requestContextPromise = this.requestFactory.ingredientSearch(query, addChildren, minProteinPercent, maxProteinPercent, minFatPercent, maxFatPercent, minCarbsPercent, maxCarbsPercent, metaInformation, intolerances, sort, sortDirection, offset, number, _options);
