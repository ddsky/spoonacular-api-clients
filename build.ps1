...
java -jar .\openapi-generator-cli-7.3.0.jar generate -i .\spoonacular-openapi-3.json -g go --artifact-version $VERSION --additional-properties packageVersion=$VERSION,project-name=spoonacular,packageName=spoonacular  --git-repo-id=spoonacular-api-clients/tree/master/go/ --git-user-id=ddsky --artifact-id go-client -o go --name-mappings _=Underscore
