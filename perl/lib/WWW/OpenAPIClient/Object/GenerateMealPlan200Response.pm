...
#
package WWW::OpenAPIClient::Object::GenerateMealPlan200Response;
...
__PACKAGE__->method_documentation({
    'meals' => {
        datatype => 'ARRAY[GetSimilarRecipes200ResponseInner]',
        base_name => 'meals',
        description => '',
        format => '',
        read_only => '',
    ...
    'nutrients' => {
        datatype => 'GenerateMealPlan200ResponseNutrients',
        base_name => 'nutrients',
        description => '',
        format => '',
        read_only => '',
