...
class AnalyzeRecipeRequest1 {
     ...
     * @param {module:model/AnalyzeRecipeRequest1} obj Optional instance to populate.
     * @return {module:model/AnalyzeRecipeRequest1} The populated <code>AnalyzeRecipeRequest1</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>AnalyzeRecipeRequest1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AnalyzeRecipeRequest1</code>.
     */
