...
impl SearchRecipesByIngredients200ResponseInnerMissedIngredientsInner {
    pub fn new(aisle: String, amount: f64, id: i32, image: String, name: String, original: String, original_name: String, unit: String, unit_long: String, unit_short: String) -> SearchRecipesByIngredients200ResponseInnerMissedIngredientsInner {
