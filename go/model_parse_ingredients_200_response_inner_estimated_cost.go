...
// checks if the ParseIngredients200ResponseInnerEstimatedCost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ParseIngredients200ResponseInnerEstimatedCost{}
...
type _ParseIngredients200ResponseInnerEstimatedCost ParseIngredients200ResponseInnerEstimatedCost
...
func (o *ParseIngredients200ResponseInnerEstimatedCost) UnmarshalJSON(data []byte) (err error) {
	...
	varParseIngredients200ResponseInnerEstimatedCost := _ParseIngredients200ResponseInnerEstimatedCost{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varParseIngredients200ResponseInnerEstimatedCost)

	if err != nil {
		return err
	}

	*o = ParseIngredients200ResponseInnerEstimatedCost(varParseIngredients200ResponseInnerEstimatedCost)
