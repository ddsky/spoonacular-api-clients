...
public class SearchAllFood200ResponseSearchResultsInner {
  ...
  private Set<SearchAllFood200ResponseSearchResultsInnerResultsInner> results;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchAllFood200ResponseSearchResultsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchAllFood200ResponseSearchResultsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
