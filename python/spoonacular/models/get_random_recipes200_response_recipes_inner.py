...
class GetRandomRecipes200ResponseRecipesInner(BaseModel):
    ...
    extended_ingredients: Optional[Annotated[List[GetRecipeInformation200ResponseExtendedIngredientsInner], Field(min_length=0)]] = Field(default=None, alias="extendedIngredients")
    summary: Annotated[str, Field(min_length=1, strict=True)]
    wine_pairing: Optional[GetRecipeInformation200ResponseWinePairing] = Field(default=None, alias="winePairing")
