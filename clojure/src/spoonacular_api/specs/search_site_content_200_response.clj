...
(def search-site-content-200-response-data
  {
   ...
   (ds/req :GroceryProducts) (s/coll-of search-site-content-200-response-grocery-products-inner-spec)
   (ds/req :MenuItems) (s/coll-of search-site-content-200-response-grocery-products-inner-spec)
   (ds/req :Recipes) (s/coll-of search-site-content-200-response-grocery-products-inner-spec)
   })
