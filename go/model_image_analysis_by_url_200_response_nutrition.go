...
// checks if the ImageAnalysisByURL200ResponseNutrition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageAnalysisByURL200ResponseNutrition{}
...
type _ImageAnalysisByURL200ResponseNutrition ImageAnalysisByURL200ResponseNutrition
...
func (o *ImageAnalysisByURL200ResponseNutrition) UnmarshalJSON(data []byte) (err error) {
	...
	varImageAnalysisByURL200ResponseNutrition := _ImageAnalysisByURL200ResponseNutrition{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varImageAnalysisByURL200ResponseNutrition)

	if err != nil {
		return err
	}

	*o = ImageAnalysisByURL200ResponseNutrition(varImageAnalysisByURL200ResponseNutrition)
