-module(spoonacular_get_meal_plan_template_200_response_days_inner).

-export([encode/1]).

-export_type([spoonacular_get_meal_plan_template_200_response_days_inner/0]).

-type spoonacular_get_meal_plan_template_200_response_days_inner() ::
