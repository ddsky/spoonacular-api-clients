...
class SearchCustomFoods200Response {
  ...
  Map<String, dynamic> toJson() {
    final _json = <String, dynamic>{};
      _json[r'customFoods'] = customFoods;
      _json[r'type'] = type;
  ...
  static SearchCustomFoods200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SearchCustomFoods200Response(
        customFoods: SearchCustomFoods200ResponseCustomFoodsInner.listFromJson(json[r'customFoods'])!,
  ...
  static Map<String, List<SearchCustomFoods200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SearchCustomFoods200Response.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
