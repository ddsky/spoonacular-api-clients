...
// checks if the AddToMealPlanRequest1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddToMealPlanRequest1{}
...
type _AddToMealPlanRequest1 AddToMealPlanRequest1
...
func (o AddToMealPlanRequest1) ToMap() (map[string]interface{}, error) {
...
func (o *AddToMealPlanRequest1) UnmarshalJSON(data []byte) (err error) {
	...
	varAddToMealPlanRequest1 := _AddToMealPlanRequest1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAddToMealPlanRequest1)

	if err != nil {
		return err
	}

	*o = AddToMealPlanRequest1(varAddToMealPlanRequest1)
