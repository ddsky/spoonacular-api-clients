...
#include "com.spoonacular.client.model\OAIGenerateMealPlan_200_response_nutrients.h"
#include "com.spoonacular.client.model\OAIGetSimilarRecipes_200_response_inner.h"
#include <QList>
#include <QSet>
...
private:
    ...
    QSet<OAIGetSimilarRecipes_200_response_inner> meals;
    bool m_meals_isSet;
    bool m_meals_isValid;

    OAIGenerateMealPlan_200_response_nutrients nutrients;
