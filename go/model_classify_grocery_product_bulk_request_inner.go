...
// checks if the ClassifyGroceryProductBulkRequestInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClassifyGroceryProductBulkRequestInner{}
...
type _ClassifyGroceryProductBulkRequestInner ClassifyGroceryProductBulkRequestInner
...
func (o *ClassifyGroceryProductBulkRequestInner) UnmarshalJSON(data []byte) (err error) {
	...
	varClassifyGroceryProductBulkRequestInner := _ClassifyGroceryProductBulkRequestInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varClassifyGroceryProductBulkRequestInner)

	if err != nil {
		return err
	}

	*o = ClassifyGroceryProductBulkRequestInner(varClassifyGroceryProductBulkRequestInner)
