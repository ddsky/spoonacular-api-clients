...
#
package WWW::OpenAPIClient::Object::GetRecipeInformation200ResponseExtendedIngredientsInnerMeasures;
...
__PACKAGE__->method_documentation({
    'metric' => {
        datatype => 'GetRecipeInformation200ResponseExtendedIngredientsInnerMeasuresMetric',
        base_name => 'metric',
        description => '',
        format => '',
        read_only => '',
