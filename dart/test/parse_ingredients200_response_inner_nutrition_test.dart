...
// tests for ParseIngredients200ResponseInnerNutrition
void main() {
  // final instance = ParseIngredients200ResponseInnerNutrition();

  group('test ParseIngredients200ResponseInnerNutrition', () {
    ...
    // Set<ParseIngredients200ResponseInnerNutritionPropertiesInner> flavonoids (default value: const {})
