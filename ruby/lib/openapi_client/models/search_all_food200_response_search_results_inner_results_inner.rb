  ...
  class SearchAllFood200ResponseSearchResultsInnerResultsInner
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::SearchAllFood200ResponseSearchResultsInnerResultsInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::SearchAllFood200ResponseSearchResultsInnerResultsInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @relevance.nil?
        invalid_properties.push('invalid value for "relevance", relevance cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @relevance.nil?
      return false if @content.to_s.length < 0
      true
    end
    ...
    def image=(image)
      if !image.nil? && image.to_s.length < 1
    ...
    def hash
      [id, name, image, link, type, relevance, content].hash
    end
