...
module OpenapiClient
  ...
  class GetIngredientInformation200Response
    ...
    attr_accessor :shopping_list_units
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::GetIngredientInformation200Response` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::GetIngredientInformation200Response`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'shopping_list_units')
        if (value = attributes[:'shopping_list_units']).is_a?(Array)
          self.shopping_list_units = value
        end
      else
        self.shopping_list_units = nil
      end
      ...
      if attributes.key?(:'category_path')
        if (value = attributes[:'category_path']).is_a?(Array)
          self.category_path = value
        end
      else
        self.category_path = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @shopping_list_units.nil?
        invalid_properties.push('invalid value for "shopping_list_units", shopping_list_units cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @shopping_list_units.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          shopping_list_units == o.shopping_list_units &&
          aisle == o.aisle &&
          image == o.image &&
          meta == o.meta &&
    ...
    def hash
      [id, original, original_name, name, name_clean, amount, unit, unit_short, unit_long, possible_units, estimated_cost, consistency, shopping_list_units, aisle, image, meta, nutrition, category_path].hash
    end
