...
class InlineResponse20022 {
  ...
  InlineResponse20022.fromJson(Map<String, dynamic> json) {
    ...
    if (json['shoppingListUnits'] == null) {
      shoppingListUnits = null;
    } else {
      shoppingListUnits = (json['shoppingListUnits'] as List).cast<String>();
    }
    if (json['aisle'] == null) {
      aisle = null;
    } else {
    ...
    if (json['meta'] == null) {
      ...
      meta = Object.listFromJson(json['meta']);
    }
    if (json['nutrition'] == null) {
      nutrition = null;
    } else {
      nutrition = new InlineResponse20022Nutrition.fromJson(json['nutrition']);
    }
    if (json['categoryPath'] == null) {
      categoryPath = null;
    } else {
      categoryPath = (json['categoryPath'] as List).cast<String>();
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (shoppingListUnits != null)
      json['shoppingListUnits'] = shoppingListUnits;
    if (aisle != null)
      json['aisle'] = aisle;
    if (image != null)
      json['image'] = image;
  ...
  static Map<String, InlineResponse20022> mapFromJson(Map<String, dynamic> json) {
    var map = new Map<String, InlineResponse20022>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = new InlineResponse20022.fromJson(value));
    }
    return map;
  }
}
