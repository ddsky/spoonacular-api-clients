...
// checks if the SearchGroceryProductsByUPC200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchGroceryProductsByUPC200Response{}
...
type _SearchGroceryProductsByUPC200Response SearchGroceryProductsByUPC200Response
...
func (o *SearchGroceryProductsByUPC200Response) GetIngredientCount() int32 {
	if o == nil || IsNil(o.IngredientCount) {
		var ret int32
		return ret
	}
...
func (o *SearchGroceryProductsByUPC200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varSearchGroceryProductsByUPC200Response := _SearchGroceryProductsByUPC200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSearchGroceryProductsByUPC200Response)

	if err != nil {
		return err
	}

	*o = SearchGroceryProductsByUPC200Response(varSearchGroceryProductsByUPC200Response)
