...
#
package WWW::OpenAPIClient::Object::GetRecipePriceBreakdownByID200ResponseIngredientsInner;
...
__PACKAGE__->method_documentation({
    'amount' => {
        datatype => 'GetRecipePriceBreakdownByID200ResponseIngredientsInnerAmount',
        base_name => 'amount',
        description => '',
        format => '',
        read_only => '',
