...
class ParseIngredients200ResponseInnerNutrition(BaseModel):
    ...
    properties: Annotated[List[ParseIngredients200ResponseInnerNutritionPropertiesInner], Field(min_length=0)]
    flavonoids: Annotated[List[ParseIngredients200ResponseInnerNutritionPropertiesInner], Field(min_length=0)]
    ...
    __properties: ClassVar[List[str]] = ["nutrients", "properties", "flavonoids", "caloricBreakdown", "weightPerServing"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": [ParseIngredients200ResponseInnerNutritionPropertiesInner.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None,
            "flavonoids": [ParseIngredients200ResponseInnerNutritionPropertiesInner.from_dict(_item) for _item in obj["flavonoids"]] if obj.get("flavonoids") is not None else None,
            ...
            "weightPerServing": ParseIngredients200ResponseInnerNutritionWeightPerServing.from_dict(obj["weightPerServing"]) if obj.get("weightPerServing") is not None else None
        })
        return _obj
