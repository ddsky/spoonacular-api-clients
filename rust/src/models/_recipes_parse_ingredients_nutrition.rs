...
pub struct RecipesParseIngredientsNutrition {
    ...
    pub flavonoids: Vec<::models::RecipesParseIngredientsNutritionProperties>,
...
impl RecipesParseIngredientsNutrition {
    pub fn new(nutrients: Vec<::models::RecipesParseIngredientsNutritionNutrients>, properties: Vec<::models::RecipesParseIngredientsNutritionProperties>, flavonoids: Vec<::models::RecipesParseIngredientsNutritionProperties>, caloric_breakdown: ::models::RecipesParseIngredientsNutritionCaloricBreakdown, weight_per_serving: ::models::RecipesParseIngredientsNutritionWeightPerServing) -> RecipesParseIngredientsNutrition {
