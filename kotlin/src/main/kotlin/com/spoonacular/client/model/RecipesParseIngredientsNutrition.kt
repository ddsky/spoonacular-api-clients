 ...
 */
data class RecipesParseIngredientsNutrition (
    @Json(name = "nutrients")
    val nutrients: kotlin.Array<RecipesParseIngredientsNutritionNutrients>,
    @Json(name = "properties")
    val properties: kotlin.Array<RecipesParseIngredientsNutritionProperties>,
    @Json(name = "flavonoids")
    val flavonoids: kotlin.Array<RecipesParseIngredientsNutritionProperties>,
    @Json(name = "caloricBreakdown")
    val caloricBreakdown: RecipesParseIngredientsNutritionCaloricBreakdown,
    @Json(name = "weightPerServing")
    val weightPerServing: RecipesParseIngredientsNutritionWeightPerServing
) {
