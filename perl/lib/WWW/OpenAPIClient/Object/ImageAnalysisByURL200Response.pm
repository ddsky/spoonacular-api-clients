...
#
package WWW::OpenAPIClient::Object::ImageAnalysisByURL200Response;
...
__PACKAGE__->method_documentation({
    'nutrition' => {
        datatype => 'ImageAnalysisByURL200ResponseNutrition',
        base_name => 'nutrition',
        description => '',
        format => '',
        read_only => '',
    ...
    'category' => {
        datatype => 'ImageAnalysisByURL200ResponseCategory',
        base_name => 'category',
        description => '',
        format => '',
        read_only => '',
    ...
    'recipes' => {
        datatype => 'ARRAY[ImageAnalysisByURL200ResponseRecipesInner]',
        base_name => 'recipes',
        description => '',
        format => '',
        read_only => '',
