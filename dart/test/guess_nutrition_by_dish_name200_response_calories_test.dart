...
// tests for GuessNutritionByDishName200ResponseCalories
void main() {
  // final instance = GuessNutritionByDishName200ResponseCalories();

  group('test GuessNutritionByDishName200ResponseCalories', () {
