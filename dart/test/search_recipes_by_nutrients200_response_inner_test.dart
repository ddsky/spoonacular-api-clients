...
// tests for SearchRecipesByNutrients200ResponseInner
void main() {
  // final instance = SearchRecipesByNutrients200ResponseInner();

  group('test SearchRecipesByNutrients200ResponseInner', () {
    // num calories
