...
class SearchRestaurants200Response {
  ...
  Map<String, dynamic> toJson() {
    final _json = <String, dynamic>{};
      _json[r'restaurants'] = restaurants;
    return _json;
  }
  ...
  static SearchRestaurants200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SearchRestaurants200Response(
        restaurants: SearchRestaurants200ResponseRestaurantsInner.listFromJson(json[r'restaurants']) ?? const [],
      );
    }
    return null;
  }
  ...
  static Map<String, List<SearchRestaurants200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SearchRestaurants200Response.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
