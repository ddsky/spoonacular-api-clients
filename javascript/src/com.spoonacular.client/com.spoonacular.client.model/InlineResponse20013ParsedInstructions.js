...
import InlineResponse20013Steps from './InlineResponse20013Steps';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('steps')) {
                obj['steps'] = ApiClient.convertToType(data['steps'], [InlineResponse20013Steps]);
            }
        }
        return obj;
    }
...
export default InlineResponse20013ParsedInstructions;
