...
// checks if the GetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner{}
...
type _GetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner GetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner
...
func NewGetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner(name string, amount float32, unit string, percentDailyNeeds float32) *GetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner {
	this := GetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner{}
	this.Name = name
	this.Amount = amount
	this.Unit = unit
...
func (o *GetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner) GetPercentDailyNeeds() float32 {
	...
	return o.PercentDailyNeeds
}

// GetPercentDailyNeedsOk returns a tuple with the PercentDailyNeeds field value
// and a boolean to check if the value has been set.
func (o *GetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner) GetPercentDailyNeedsOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.PercentDailyNeeds, true
}
...
func (o GetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["percentDailyNeeds"] = o.PercentDailyNeeds
...
func (o *GetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner := _GetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner)

	if err != nil {
		return err
	}

	*o = GetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner(varGetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner)

	return err
}

type NullableGetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner struct {
	value *GetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner
	isSet bool
}
...
func NewNullableGetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner(val *GetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner) *NullableGetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner {
	return &NullableGetMealPlanWeek200ResponseDaysInnerNutritionSummaryNutrientsInner{value: val, isSet: true}
}
