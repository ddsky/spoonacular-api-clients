...
local openapiclient_add_meal_plan_template_200_response = require "openapiclient.model.add_meal_plan_template_200_response"
local openapiclient_add_to_meal_plan_request_1 = require "openapiclient.model.add_to_meal_plan_request_1"
local openapiclient_add_to_shopping_list_request = require "openapiclient.model.add_to_shopping_list_request"
local openapiclient_add_to_meal_plan_request = require "openapiclient.model.add_to_meal_plan_request"
local openapiclient_clear_meal_plan_day_request = require "openapiclient.model.clear_meal_plan_day_request"
local openapiclient_connect_user_200_response = require "openapiclient.model.connect_user_200_response"
local openapiclient_connect_user_request = require "openapiclient.model.connect_user_request"
local openapiclient_delete_from_meal_plan_request = require "openapiclient.model.delete_from_meal_plan_request"
local openapiclient_generate_meal_plan_200_response = require "openapiclient.model.generate_meal_plan_200_response"
local openapiclient_generate_shopping_list_200_response = require "openapiclient.model.generate_shopping_list_200_response"
local openapiclient_generate_shopping_list_request = require "openapiclient.model.generate_shopping_list_request"
local openapiclient_get_meal_plan_template_200_response = require "openapiclient.model.get_meal_plan_template_200_response"
local openapiclient_get_meal_plan_templates_200_response = require "openapiclient.model.get_meal_plan_templates_200_response"
local openapiclient_get_meal_plan_week_200_response = require "openapiclient.model.get_meal_plan_week_200_response"
local openapiclient_get_shopping_list_200_response = require "openapiclient.model.get_shopping_list_200_response"
...
function meal_planning_api:add_meal_plan_template(username, hash, add_to_meal_plan_request)
	...
	if http_status:sub(1,1) == "2" then
		...
		return openapiclient_add_meal_plan_template_200_response.cast(result), headers
	else
		local body, err, errno2 = stream:get_body_as_string()
		if not body then
			return nil, err, errno2
...
function meal_planning_api:add_to_shopping_list(username, hash, add_to_meal_plan_request)
	...
	if http_status:sub(1,1) == "2" then
		...
		return openapiclient_generate_shopping_list_200_response.cast(result), headers
	else
		local body, err, errno2 = stream:get_body_as_string()
		if not body then
			return nil, err, errno2
...
function meal_planning_api:connect_user(body)
	...
	if http_status:sub(1,1) == "2" then
		...
		return openapiclient_connect_user_200_response.cast(result), headers
	else
		local body, err, errno2 = stream:get_body_as_string()
		if not body then
			return nil, err, errno2
...
function meal_planning_api:generate_meal_plan(time_frame, target_calories, diet, exclude)
	...
	if http_status:sub(1,1) == "2" then
		...
		return openapiclient_generate_meal_plan_200_response.cast(result), headers
	else
		local body, err, errno2 = stream:get_body_as_string()
		if not body then
			return nil, err, errno2
...
function meal_planning_api:get_meal_plan_template(username, id, hash)
	...
	if http_status:sub(1,1) == "2" then
		...
		return openapiclient_get_meal_plan_template_200_response.cast(result), headers
	else
		local body, err, errno2 = stream:get_body_as_string()
		if not body then
			return nil, err, errno2
...
function meal_planning_api:get_meal_plan_templates(username, hash)
	...
	if http_status:sub(1,1) == "2" then
		...
		return openapiclient_get_meal_plan_templates_200_response.cast(result), headers
	else
		local body, err, errno2 = stream:get_body_as_string()
		if not body then
			return nil, err, errno2
...
function meal_planning_api:get_meal_plan_week(username, start_date, hash)
	...
	if http_status:sub(1,1) == "2" then
		...
		return openapiclient_get_meal_plan_week_200_response.cast(result), headers
	else
		local body, err, errno2 = stream:get_body_as_string()
		if not body then
			return nil, err, errno2
...
function meal_planning_api:get_shopping_list(username, hash)
	...
	if http_status:sub(1,1) == "2" then
		...
		return openapiclient_get_shopping_list_200_response.cast(result), headers
	else
		local body, err, errno2 = stream:get_body_as_string()
		if not body then
			return nil, err, errno2
