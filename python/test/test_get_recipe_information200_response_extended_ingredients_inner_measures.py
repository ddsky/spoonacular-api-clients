...
class TestGetRecipeInformation200ResponseExtendedIngredientsInnerMeasures(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetRecipeInformation200ResponseExtendedIngredientsInnerMeasures:
        ...
        """
        model = GetRecipeInformation200ResponseExtendedIngredientsInnerMeasures()
        if include_optional:
