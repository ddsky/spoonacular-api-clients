...
class ProductInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductInformation';
    ...
    protected static $openAPITypes = [
        ...
        'likes' => 'float',
        'aisle' => 'string',
        'credits' => '\OpenAPI\Client\Model\ProductInformationCredits',
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ProductInformation., must be bigger than or equal to 1.');
        }
     ...
     * Sets usda_code
     *
     * @param string|null $usda_code usda_code
     *
     * @return self
     */
    public function setUsdaCode($usda_code)
    {
        if (is_null($usda_code)) {
            array_push($this->openAPINullablesSetToNull, 'usda_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('usda_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setImageType($image_type)
    {
        ...
        if ((mb_strlen($image_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image_type when calling ProductInformation., must be bigger than or equal to 1.');
        }
    ...
    public function setIngredientList($ingredient_list)
    {
        ...
        if ((mb_strlen($ingredient_list) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ingredient_list when calling ProductInformation., must be bigger than or equal to 1.');
        }
    ...
    public function setIngredients($ingredients)
    {
        ...
        if ((count($ingredients) < 0)) {
            throw new \InvalidArgumentException('invalid length for $ingredients when calling ProductInformation., number of items must be greater than or equal to 0.');
        }
     ...
     * Gets credits
     *
     * @return \OpenAPI\Client\Model\ProductInformationCredits|null
     */
     ...
     * Sets credits
     *
     * @param \OpenAPI\Client\Model\ProductInformationCredits|null $credits credits
     *
     * @return self
     */
