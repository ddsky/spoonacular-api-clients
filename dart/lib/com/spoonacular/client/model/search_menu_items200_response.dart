...
class SearchMenuItems200Response {
  ...
  Map<String, dynamic> toJson() {
    final _json = <String, dynamic>{};
      _json[r'menuItems'] = menuItems;
      _json[r'totalMenuItems'] = totalMenuItems;
      _json[r'type'] = type;
  ...
  static SearchMenuItems200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SearchMenuItems200Response(
        menuItems: SearchMenuItems200ResponseMenuItemsInner.listFromJson(json[r'menuItems'])!,
  ...
  static Map<String, List<SearchMenuItems200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SearchMenuItems200Response.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
