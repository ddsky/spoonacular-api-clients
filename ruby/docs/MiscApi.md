...
begin
  ...
  puts "Exception when calling MiscApi->detect_food_in_text: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling MiscApi->get_a_random_food_joke: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling MiscApi->get_conversation_suggests: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling MiscApi->get_random_food_trivia: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling MiscApi->image_analysis_by_url: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling MiscApi->image_classification_by_url: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling MiscApi->search_all_food: #{e}"
end
```
...
> InlineResponse20029 search_custom_foods(username, hash, opts)
...
begin
  ...
  puts "Exception when calling MiscApi->search_custom_foods: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling MiscApi->search_food_videos: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling MiscApi->search_site_content: #{e}"
end
```
...
begin
  ...
  puts "Exception when calling MiscApi->talk_to_chatbot: #{e}"
end
```
