...
#ifndef OAISearchRecipesByNutrients_200_response_inner_H
#define OAISearchRecipesByNutrients_200_response_inner_H
...
class OAISearchRecipesByNutrients_200_response_inner : public OAIObject {
public:
    OAISearchRecipesByNutrients_200_response_inner();
    OAISearchRecipesByNutrients_200_response_inner(QString json);
    ~OAISearchRecipesByNutrients_200_response_inner() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISearchRecipesByNutrients_200_response_inner)

#endif // OAISearchRecipesByNutrients_200_response_inner_H
