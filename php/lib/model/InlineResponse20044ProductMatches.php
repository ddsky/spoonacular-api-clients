...
/**
 * InlineResponse20044ProductMatches Class Doc Comment
 *
 * @category Class
 * @package  com.spoonacular.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class InlineResponse20044ProductMatches implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_44_productMatches';
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling InlineResponse20044ProductMatches., must be bigger than or equal to 1.');
        }
    ...
    public function setImageUrl($image_url)
    {
        ...
        if ((mb_strlen($image_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling InlineResponse20044ProductMatches., must be bigger than or equal to 1.');
        }
    ...
    public function setLink($link)
    {
        ...
        if ((mb_strlen($link) < 1)) {
            throw new \InvalidArgumentException('invalid length for $link when calling InlineResponse20044ProductMatches., must be bigger than or equal to 1.');
        }
    ...
    public function setPrice($price)
    {
        ...
        if ((mb_strlen($price) < 1)) {
            throw new \InvalidArgumentException('invalid length for $price when calling InlineResponse20044ProductMatches., must be bigger than or equal to 1.');
        }
