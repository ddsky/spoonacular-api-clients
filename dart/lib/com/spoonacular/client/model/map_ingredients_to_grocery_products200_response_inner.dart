...
class MapIngredientsToGroceryProducts200ResponseInner {
  ...
  Map<String, dynamic> toJson() {
    final _json = <String, dynamic>{};
      ...
      _json[r'ingredientImage'] = ingredientImage;
      _json[r'meta'] = meta;
    ...
    if (value is Map) {
      ...
      return MapIngredientsToGroceryProducts200ResponseInner(
        ...
        meta: json[r'meta'] is List
            ...
            : const [],
        products: MapIngredientsToGroceryProducts200ResponseInnerProductsInner.listFromJson(json[r'products'])!,
      );
    }
    return null;
  }
  ...
  static Map<String, List<MapIngredientsToGroceryProducts200ResponseInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MapIngredientsToGroceryProducts200ResponseInner.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
