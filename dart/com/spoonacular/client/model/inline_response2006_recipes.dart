...
class InlineResponse2006Recipes {
  ...
  static List<InlineResponse2006Recipes> listFromJson(List<dynamic> json) {
    return json == null ? new List<InlineResponse2006Recipes>() : json.map((value) => new InlineResponse2006Recipes.fromJson(value)).toList();
  }

  static Map<String, InlineResponse2006Recipes> mapFromJson(Map<String, dynamic> json) {
    var map = new Map<String, InlineResponse2006Recipes>();
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic value) => map[key] = new InlineResponse2006Recipes.fromJson(value));
    }
    return map;
  }
}
