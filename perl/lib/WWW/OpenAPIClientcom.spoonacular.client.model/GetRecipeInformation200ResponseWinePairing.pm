...
#
package WWW::OpenAPIClient::Object::GetRecipeInformation200ResponseWinePairing;
...
__PACKAGE__->method_documentation({
    ...
    'product_matches' => {
        datatype => 'ARRAY[GetRecipeInformation200ResponseWinePairingProductMatchesInner]',
