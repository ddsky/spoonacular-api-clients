...
// tests for GetRecipeInformation200ResponseExtendedIngredientsInner
void main() {
  // final instance = GetRecipeInformation200ResponseExtendedIngredientsInner();

  group('test GetRecipeInformation200ResponseExtendedIngredientsInner', () {
    // String aisle
