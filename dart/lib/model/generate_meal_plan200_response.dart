...
class GenerateMealPlan200Response {
  ...
  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'meals'] = this.meals.toList(growable: false);
  ...
  static GenerateMealPlan200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GenerateMealPlan200Response(
        meals: GetSimilarRecipes200ResponseInner.listFromJson(json[r'meals']).toSet(),
  ...
  static Map<String, List<GenerateMealPlan200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = GenerateMealPlan200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
