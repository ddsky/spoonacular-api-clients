...
class GetRecipePriceBreakdownByID200Response {
  ...
  Map<String, dynamic> toJson() {
    final _json = <String, dynamic>{};
      ...
      _json[r'totalCost'] = totalCost;
      _json[r'totalCostPerServing'] = totalCostPerServing;
    return _json;
  }
  ...
  static GetRecipePriceBreakdownByID200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GetRecipePriceBreakdownByID200Response(
        ingredients: GetRecipePriceBreakdownByID200ResponseIngredientsInner.listFromJson(json[r'ingredients'])!,
        totalCost: json[r'totalCost'] == null
            ? null
            : num.parse(json[r'totalCost'].toString()),
        totalCostPerServing: json[r'totalCostPerServing'] == null
            ? null
            : num.parse(json[r'totalCostPerServing'].toString()),
      );
    }
    return null;
  }
  ...
  static Map<String, List<GetRecipePriceBreakdownByID200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetRecipePriceBreakdownByID200Response.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
