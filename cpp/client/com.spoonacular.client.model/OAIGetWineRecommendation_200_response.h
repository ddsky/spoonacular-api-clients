...
#include "com.spoonacular.client.model\OAIGetWineRecommendation_200_response_recommendedWines_inner.h"
#include <QList>
#include <QSet>
...
private:
    ...
    QSet<OAIGetWineRecommendation_200_response_recommendedWines_inner> recommended_wines;
