...
qint32
OAIInline_response_200_7::getId() const {
    return id;
}
void
OAIInline_response_200_7::setId(const qint32 &id) {
    this->id = id;
...
QString
OAIInline_response_200_7::getTitle() const {
    return title;
}
void
OAIInline_response_200_7::setTitle(const QString &title) {
    this->title = title;
...
QString
OAIInline_response_200_7::getImageType() const {
    return image_type;
}
void
OAIInline_response_200_7::setImageType(const QString &image_type) {
