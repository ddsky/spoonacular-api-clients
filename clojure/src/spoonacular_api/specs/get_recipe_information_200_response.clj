(ns spoonacular-api.specs.get-recipe-information-200-response
...
(def get-recipe-information-200-response-data
  {
   (ds/req :id) int?
   (ds/req :title) string?
   (ds/req :image) string?
...
(def get-recipe-information-200-response-spec
  (ds/spec
    {:name ::get-recipe-information-200-response
     :spec get-recipe-information-200-response-data}))
