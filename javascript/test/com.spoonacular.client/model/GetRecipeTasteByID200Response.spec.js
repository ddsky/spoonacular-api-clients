...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpoonacularApi.GetRecipeTasteByID200Response();
  });
  ...
  describe('GetRecipeTasteByID200Response', function() {
    it('should create an instance of GetRecipeTasteByID200Response', function() {
      // uncomment below and update the code to test GetRecipeTasteByID200Response
      //var instance = new SpoonacularApi.GetRecipeTasteByID200Response();
      //expect(instance).to.be.a(SpoonacularApi.GetRecipeTasteByID200Response);
    });
