...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpoonacularApi.InlineResponse2003MeasuresMetric();
  });
  ...
  describe('InlineResponse2003MeasuresMetric', function() {
    it('should create an instance of InlineResponse2003MeasuresMetric', function() {
      // uncomment below and update the code to test InlineResponse2003MeasuresMetric
      //var instane = new SpoonacularApi.InlineResponse2003MeasuresMetric();
      //expect(instance).to.be.a(SpoonacularApi.InlineResponse2003MeasuresMetric);
    });
