...
QString
OAIInline_object_5::getUsername() const {
    return username;
}
void
OAIInline_object_5::setUsername(const QString &username) {
...
OAINumber
OAIInline_object_5::getId() const {
    return id;
}
void
OAIInline_object_5::setId(const OAINumber &id) {
    this->id = id;
...
QString
OAIInline_object_5::getHash() const {
    return hash;
}
void
OAIInline_object_5::setHash(const QString &hash) {
    this->hash = hash;
