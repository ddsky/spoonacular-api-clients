...
class SearchAllFood200Response {
  ...
  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      ...
      json[r'searchResults'] = this.searchResults.toList(growable: false);
    return json;
  }
  ...
  static SearchAllFood200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SearchAllFood200Response(
        ...
        searchResults: SearchAllFood200ResponseSearchResultsInner.listFromJson(json[r'searchResults']).toSet(),
      );
    }
    return null;
  }
  ...
  static Map<String, List<SearchAllFood200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = SearchAllFood200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
