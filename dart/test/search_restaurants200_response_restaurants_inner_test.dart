...
void main() {
  ...
  group('test SearchRestaurants200ResponseRestaurantsInner', () {
    ...
    // List<String> foodPhotos (default value: const [])
    test('to test the property `foodPhotos`', () async {
      // TODO
    });

    // List<String> logoPhotos (default value: const [])
    test('to test the property `logoPhotos`', () async {
      // TODO
    });
