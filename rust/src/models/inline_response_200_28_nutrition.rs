...
pub struct InlineResponse20028Nutrition {
...
impl InlineResponse20028Nutrition {
    pub fn new(nutrients: Vec<::models::RecipesParseIngredientsNutritionNutrients>, caloric_breakdown: ::models::RecipesParseIngredientsNutritionCaloricBreakdown) -> InlineResponse20028Nutrition {
