...
# Unit tests for OpenapiClient::InlineResponse20057
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InlineResponse20057' do
  before do
    # run before each test
    @instance = OpenapiClient::InlineResponse20057.new
  end
  ...
  describe 'test an instance of InlineResponse20057' do
    it 'should create an instance of InlineResponse20057' do
      expect(@instance).to be_instance_of(OpenapiClient::InlineResponse20057)
    end
  end
