...
QString
OAIInline_object_1::getTitle() const {
    return title;
}
void
OAIInline_object_1::setTitle(const QString &title) {
    this->title = title;
...
QString
OAIInline_object_1::getUpc() const {
    return upc;
}
void
OAIInline_object_1::setUpc(const QString &upc) {
    this->upc = upc;
...
QString
OAIInline_object_1::getPluCode() const {
    return plu_code;
}
void
OAIInline_object_1::setPluCode(const QString &plu_code) {
