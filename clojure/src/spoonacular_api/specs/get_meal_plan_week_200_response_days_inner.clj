(ns spoonacular-api.specs.get-meal-plan-week-200-response-days-inner
...
(def get-meal-plan-week-200-response-days-inner-data
  {
   ...
   (ds/req :date) float?
   (ds/req :day) string?
   (ds/opt :items) (s/coll-of get-meal-plan-week-200-response-days-inner-items-inner-spec)
   })

(def get-meal-plan-week-200-response-days-inner-spec
  (ds/spec
    {:name ::get-meal-plan-week-200-response-days-inner
     :spec get-meal-plan-week-200-response-days-inner-data}))
