...
class InlineResponse20041Items(object):
    ...
    @property
    def id(self):
        """Gets the id of this InlineResponse20041Items.  # noqa: E501


        :return: The id of this InlineResponse20041Items.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this InlineResponse20041Items.


        :param id: The id of this InlineResponse20041Items.  # noqa: E501
        :type: int
        """
        if id is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineResponse20041Items):
            return False
