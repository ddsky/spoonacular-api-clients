 ...
 * @module model/GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner
 * @version 1.1
 */
class GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner {
     ...
     * @alias module:model/GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner
     * @param number {Number} 
     * @param step {String} 
     */
     ...
     * @param {module:model/GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner} obj Optional instance to populate.
     * @return {module:model/GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner} The populated <code>GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner.RequiredProperties) {
        ...
        if (data['ingredients']) { // data not null
            ...
            for (const item of data['ingredients']) {
                GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerIngredientsInner.validateJSON(item);
            };
        }
...
GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner.RequiredProperties = ["number", "step"];
...
/**
 * @member {Array.<module:model/GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerIngredientsInner>} ingredients
 */
GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner.prototype['ingredients'] = undefined;

/**
 * @member {Array.<module:model/GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerIngredientsInner>} equipment
 */
