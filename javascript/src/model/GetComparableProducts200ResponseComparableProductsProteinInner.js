 ...
 * @module model/GetComparableProducts200ResponseComparableProductsProteinInner
 * @version 1.1
 */
class GetComparableProducts200ResponseComparableProductsProteinInner {
     ...
     * @alias module:model/GetComparableProducts200ResponseComparableProductsProteinInner
     ...
     * @param {module:model/GetComparableProducts200ResponseComparableProductsProteinInner} obj Optional instance to populate.
     * @return {module:model/GetComparableProducts200ResponseComparableProductsProteinInner} The populated <code>GetComparableProducts200ResponseComparableProductsProteinInner</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>GetComparableProducts200ResponseComparableProductsProteinInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetComparableProducts200ResponseComparableProductsProteinInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetComparableProducts200ResponseComparableProductsProteinInner.RequiredProperties) {
...
GetComparableProducts200ResponseComparableProductsProteinInner.RequiredProperties = ["difference", "id", "image", "title"];
