...
module OpenapiClient
  class RecipesApi
    ...
    def compute_glycemic_load(inline_object, opts = {})
      data, _status_code, _headers = compute_glycemic_load_with_http_info(inline_object, opts)
      data
    end
    ...
    def compute_glycemic_load_with_http_info(inline_object, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && inline_object.nil?
        fail ArgumentError, "Missing the required parameter 'inline_object' when calling RecipesApi.compute_glycemic_load"
      end
    ...
    def equipment_by_id_image_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/recipes/{id}/equipmentWidget.png'.sub('{' + 'id' + '}', id.to_s)
    ...
    # @option opts [String] :content_type The content type.
    # @option opts [String] :language The language of the input. Either &#39;en&#39; or &#39;de&#39;.
    # @return [Array<(Array<InlineResponse20020>, Integer, Hash)>] Array<InlineResponse20020> data, response status code and response headers
    def parse_ingredients_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'Array<InlineResponse20020>' 
    ...
    def price_breakdown_by_id_image_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/recipes/{id}/priceBreakdownWidget.png'.sub('{' + 'id' + '}', id.to_s)
    ...
    def recipe_nutrition_by_id_image_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/recipes/{id}/nutritionWidget.png'.sub('{' + 'id' + '}', id.to_s)
    ...
    def recipe_nutrition_label_image_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/recipes/{id}/nutritionLabel.png'.sub('{' + 'id' + '}', id.to_s)
    ...
    def recipe_nutrition_label_widget_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/recipes/{id}/nutritionLabel'.sub('{' + 'id' + '}', id.to_s)
    ...
    def recipe_taste_by_id_image_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/recipes/{id}/tasteWidget.png'.sub('{' + 'id' + '}', id.to_s)
