...
# Unit tests for OpenapiClient::InlineResponse20038
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InlineResponse20038' do
  before do
    # run before each test
    @instance = OpenapiClient::InlineResponse20038.new
  end
  ...
  describe 'test an instance of InlineResponse20038' do
    it 'should create an instance of InlineResponse20038' do
      expect(@instance).to be_instance_of(OpenapiClient::InlineResponse20038)
    end
  end
