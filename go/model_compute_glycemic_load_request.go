...
// checks if the ComputeGlycemicLoadRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComputeGlycemicLoadRequest{}
...
type _ComputeGlycemicLoadRequest ComputeGlycemicLoadRequest
...
func (o *ComputeGlycemicLoadRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varComputeGlycemicLoadRequest := _ComputeGlycemicLoadRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varComputeGlycemicLoadRequest)

	if err != nil {
		return err
	}

	*o = ComputeGlycemicLoadRequest(varComputeGlycemicLoadRequest)
