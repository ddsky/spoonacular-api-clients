...
-- get_recipe_information_200_response class
local get_recipe_information_200_response = {}
local get_recipe_information_200_response_mt = {
	__name = "get_recipe_information_200_response";
	__index = get_recipe_information_200_response;
}

local function cast_get_recipe_information_200_response(t)
	return setmetatable(t, get_recipe_information_200_response_mt)
end

local function new_get_recipe_information_200_response(id, title, image, image_type, servings, ready_in_minutes, license, source_name, source_url, spoonacular_source_url, aggregate_likes, health_score, spoonacular_score, price_per_serving, analyzed_instructions, cheap, credits_text, cuisines, dairy_free, diets, gaps, gluten_free, instructions, ketogenic, low_fodmap, occasions, sustainable, vegan, vegetarian, very_healthy, very_popular, whole30, weight_watcher_smart_points, dish_types, extended_ingredients, summary, wine_pairing)
	return cast_get_recipe_information_200_response({
		["id"] = id;
		["title"] = title;
		["image"] = image;
...
return {
	cast = cast_get_recipe_information_200_response;
	new = new_get_recipe_information_200_response;
}
