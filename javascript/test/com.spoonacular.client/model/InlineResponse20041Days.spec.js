...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpoonacularApi.InlineResponse20041Days();
  });
  ...
  describe('InlineResponse20041Days', function() {
    it('should create an instance of InlineResponse20041Days', function() {
      // uncomment below and update the code to test InlineResponse20041Days
      //var instane = new SpoonacularApi.InlineResponse20041Days();
      //expect(instance).to.be.a(SpoonacularApi.InlineResponse20041Days);
    });
