...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = IngredientsApi()
        api_instance.autocomplete_ingredient_search  # this is an instance of the class Endpoint
        api_instance.autocomplete_ingredient_search()  # this invokes api_instance.autocomplete_ingredient_search.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.autocomplete_ingredient_search.callable or self.callable in this class
