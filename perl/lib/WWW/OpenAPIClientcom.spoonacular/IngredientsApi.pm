...
# @param string $intolerances A comma-separated list of intolerances. All recipes returned must not contain ingredients that are not suitable for people with the intolerances entered. See a full list of supported intolerances. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'autocomplete_ingredient_search' } = { 
        ...
        params => $params,
        returns => 'ARRAY[InlineResponse20024]',
        };
}
...
sub autocomplete_ingredient_search {
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[InlineResponse20024]', $response);
...
# @param string $unit The target unit. (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'compute_ingredient_amount' } = { 
        ...
        params => $params,
        returns => 'RecipesParseIngredientsNutritionWeightPerServing',
        };
}
...
sub compute_ingredient_amount {
    ...
    my $_response_object = $self->{api_client}->deserialize('RecipesParseIngredientsNutritionWeightPerServing', $response);
    return $_response_object;
}
...
# @param InlineObject2 $inline_object2  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'map_ingredients_to_grocery_products' } = { 
        ...
        params => $params,
        returns => 'ARRAY[InlineResponse20034]',
        };
}
...
sub map_ingredients_to_grocery_products {
    ...
    unless (exists $args{'inline_object2'}) {
      croak("Missing the required parameter 'inline_object2' when calling map_ingredients_to_grocery_products");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[InlineResponse20034]', $response);
    return $_response_object;
}
