...
Put the package under your project folder in a directory named `spoonacular` and add the following to `Cargo.toml` under `[dependencies]`:

```
spoonacular = { path = "./spoonacular" }
```
