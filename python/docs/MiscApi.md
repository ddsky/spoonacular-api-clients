...
> InlineResponse20056 get_conversation_suggests(query, number=number)
...
# **search_all_food**
> InlineResponse20052 search_all_food(query, offset=offset, number=number)
...
# **talk_to_chatbot**
> InlineResponse20055 talk_to_chatbot(text, context_id=context_id)
