...
public class TasteInformation {
  ...
  public boolean equals(Object o) {
    ...
    return (this.sweetness == null ? tasteInformation.sweetness == null : this.sweetness.equals(tasteInformation.sweetness)) &&
        (this.saltiness == null ? tasteInformation.saltiness == null : this.saltiness.equals(tasteInformation.saltiness)) &&
        (this.sourness == null ? tasteInformation.sourness == null : this.sourness.equals(tasteInformation.sourness)) &&
        (this.bitterness == null ? tasteInformation.bitterness == null : this.bitterness.equals(tasteInformation.bitterness)) &&
        (this.savoriness == null ? tasteInformation.savoriness == null : this.savoriness.equals(tasteInformation.savoriness)) &&
        (this.fattiness == null ? tasteInformation.fattiness == null : this.fattiness.equals(tasteInformation.fattiness)) &&
        (this.spiciness == null ? tasteInformation.spiciness == null : this.spiciness.equals(tasteInformation.spiciness));
  }
