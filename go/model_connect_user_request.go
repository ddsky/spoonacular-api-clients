...
// checks if the ConnectUserRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectUserRequest{}
...
type _ConnectUserRequest ConnectUserRequest
...
func (o *ConnectUserRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varConnectUserRequest := _ConnectUserRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConnectUserRequest)

	if err != nil {
		return err
	}

	*o = ConnectUserRequest(varConnectUserRequest)
