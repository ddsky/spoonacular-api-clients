...
public:
    ...
    QList<OAIObject> getBad() const;
    void setBad(const QList<OAIObject> &bad);

    
    QList<OAIObject> getGood() const;
    void setGood(const QList<OAIObject> &good);
