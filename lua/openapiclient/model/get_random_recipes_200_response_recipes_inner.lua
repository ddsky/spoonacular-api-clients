...
-- get_random_recipes_200_response_recipes_inner class
local get_random_recipes_200_response_recipes_inner = {}
local get_random_recipes_200_response_recipes_inner_mt = {
	__name = "get_random_recipes_200_response_recipes_inner";
	__index = get_random_recipes_200_response_recipes_inner;
}

local function cast_get_random_recipes_200_response_recipes_inner(t)
	return setmetatable(t, get_random_recipes_200_response_recipes_inner_mt)
end

local function new_get_random_recipes_200_response_recipes_inner(id, title, image, image_type, servings, ready_in_minutes, license, source_name, source_url, spoonacular_source_url, aggregate_likes, health_score, spoonacular_score, price_per_serving, analyzed_instructions, cheap, credits_text, cuisines, dairy_free, diets, gaps, gluten_free, instructions, ketogenic, low_fodmap, occasions, sustainable, vegan, vegetarian, very_healthy, very_popular, whole30, weight_watcher_smart_points, dish_types, extended_ingredients, summary, wine_pairing)
	return cast_get_random_recipes_200_response_recipes_inner({
		["id"] = id;
		["title"] = title;
		["image"] = image;
...
return {
	cast = cast_get_random_recipes_200_response_recipes_inner;
	new = new_get_random_recipes_200_response_recipes_inner;
}
