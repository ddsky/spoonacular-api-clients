...
/**
 * InlineResponse20046RecommendedWines Class Doc Comment
 *
 * @category Class
 * @package  com.spoonacular.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class InlineResponse20046RecommendedWines implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_46_recommendedWines';
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling InlineResponse20046RecommendedWines., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InlineResponse20046RecommendedWines., must be bigger than or equal to 1.');
        }
    ...
    public function setImageUrl($image_url)
    {
        ...
        if ((mb_strlen($image_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling InlineResponse20046RecommendedWines., must be bigger than or equal to 1.');
        }
    ...
    public function setLink($link)
    {
        ...
        if ((mb_strlen($link) < 1)) {
            throw new \InvalidArgumentException('invalid length for $link when calling InlineResponse20046RecommendedWines., must be bigger than or equal to 1.');
        }
    ...
    public function setPrice($price)
    {
        ...
        if ((mb_strlen($price) < 1)) {
            throw new \InvalidArgumentException('invalid length for $price when calling InlineResponse20046RecommendedWines., must be bigger than or equal to 1.');
        }
