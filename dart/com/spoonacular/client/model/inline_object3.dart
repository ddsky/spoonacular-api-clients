...
class InlineObject3 {
  ...
  @override
  String toString() {
    return 'InlineObject3[title=$title, image=$image, ingredients=$ingredients, instructions=$instructions, readyInMinutes=$readyInMinutes, servings=$servings, mask=$mask, backgroundImage=$backgroundImage, author=$author, backgroundColor=$backgroundColor, fontColor=$fontColor, source=$source, ]';
  }
