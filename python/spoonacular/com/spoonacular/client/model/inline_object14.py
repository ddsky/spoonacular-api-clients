...
class InlineObject14(object):
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this InlineObject14.

        The text in which food items, such as dish names and ingredients, should be detected in.  # noqa: E501

        :param text: The text of this InlineObject14.  # noqa: E501
        :type: str
        """
        if text is None:
