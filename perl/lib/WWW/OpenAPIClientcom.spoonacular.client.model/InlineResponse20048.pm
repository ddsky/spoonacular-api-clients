...
#
package WWW::OpenAPIClient::Object::InlineResponse20048;
...
__PACKAGE__->method_documentation({
    'nutrition' => {
        datatype => 'InlineResponse20048Nutrition',
        base_name => 'nutrition',
        description => '',
        format => '',
        read_only => '',
    ...
    'category' => {
        datatype => 'InlineResponse20048Category',
        base_name => 'category',
        description => '',
        format => '',
        read_only => '',
    ...
    'recipes' => {
        datatype => 'ARRAY[InlineResponse20048Recipes]',
        base_name => 'recipes',
        description => '',
        format => '',
        read_only => '',
