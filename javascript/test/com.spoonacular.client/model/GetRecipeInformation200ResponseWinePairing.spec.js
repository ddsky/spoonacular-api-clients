...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpoonacularApi.GetRecipeInformation200ResponseWinePairing();
  });
  ...
  describe('GetRecipeInformation200ResponseWinePairing', function() {
    it('should create an instance of GetRecipeInformation200ResponseWinePairing', function() {
      // uncomment below and update the code to test GetRecipeInformation200ResponseWinePairing
      //var instance = new SpoonacularApi.GetRecipeInformation200ResponseWinePairing();
      //expect(instance).to.be.a(SpoonacularApi.GetRecipeInformation200ResponseWinePairing);
    });
