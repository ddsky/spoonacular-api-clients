...
class DefaultApi {
    ...
    def getIngredientInformation ( BigDecimal id, BigDecimal amount, String unit, Closure onSuccess, Closure onFailure)  {
    ...
    def getRecipeNutritionWidgetByID ( BigDecimal id, Closure onSuccess, Closure onFailure)  {
