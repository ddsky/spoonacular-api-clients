...
// checks if the ConvertAmounts200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConvertAmounts200Response{}
...
type _ConvertAmounts200Response ConvertAmounts200Response
...
func (o *ConvertAmounts200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varConvertAmounts200Response := _ConvertAmounts200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConvertAmounts200Response)

	if err != nil {
		return err
	}

	*o = ConvertAmounts200Response(varConvertAmounts200Response)
