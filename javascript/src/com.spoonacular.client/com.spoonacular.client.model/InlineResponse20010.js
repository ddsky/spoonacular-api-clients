...
import InlineResponse20010Ingredients from './InlineResponse20010Ingredients';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ingredients')) {
                obj['ingredients'] = ApiClient.convertToType(data['ingredients'], [InlineResponse20010Ingredients]);
            }
