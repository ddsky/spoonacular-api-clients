...
import com.spoonacular.client.request.GetRequest;
import com.spoonacular.client.request.PostRequest;
import com.spoonacular.client.request.PutRequest;
import com.spoonacular.client.request.DeleteRequest;
import com.spoonacular.client.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    setUserAgent("OpenAPI-Generator/2.0.2/android");
