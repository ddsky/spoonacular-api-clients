...
/**
 * RecipesParseIngredientsNutritionCaloricBreakdown Class Doc Comment
 *
 * @category Class
 * @package  com.spoonacular.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class RecipesParseIngredientsNutritionCaloricBreakdown implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_recipes_parseIngredients_nutrition_caloricBreakdown';
    ...
    {
        $this->container['percent_protein'] = isset($data['percent_protein']) ? $data['percent_protein'] : null;
        $this->container['percent_fat'] = isset($data['percent_fat']) ? $data['percent_fat'] : null;
        $this->container['percent_carbs'] = isset($data['percent_carbs']) ? $data['percent_carbs'] : null;
    }
