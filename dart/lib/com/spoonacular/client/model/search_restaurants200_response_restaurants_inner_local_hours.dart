...
class SearchRestaurants200ResponseRestaurantsInnerLocalHours {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (operational != null) {
      _json[r'operational'] = operational;
    } else {
      _json[r'operational'] = null;
    }
    if (delivery != null) {
      _json[r'delivery'] = delivery;
    } else {
      _json[r'delivery'] = null;
    }
    if (pickup != null) {
      _json[r'pickup'] = pickup;
    } else {
      _json[r'pickup'] = null;
    }
    if (dineIn != null) {
      _json[r'dine_in'] = dineIn;
    } else {
      _json[r'dine_in'] = null;
    }
    return _json;
  }
  ...
  static Map<String, List<SearchRestaurants200ResponseRestaurantsInnerLocalHours>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SearchRestaurants200ResponseRestaurantsInnerLocalHours.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
