 ...
 * @module model/SearchGroceryProductsByUPC200ResponseIngredientsInner
 * @version 1.1
 */
class SearchGroceryProductsByUPC200ResponseIngredientsInner {
     ...
     * @alias module:model/SearchGroceryProductsByUPC200ResponseIngredientsInner
     * @param name {String} 
     */
    constructor(name) { 
     ...
     * @param {module:model/SearchGroceryProductsByUPC200ResponseIngredientsInner} obj Optional instance to populate.
     * @return {module:model/SearchGroceryProductsByUPC200ResponseIngredientsInner} The populated <code>SearchGroceryProductsByUPC200ResponseIngredientsInner</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>SearchGroceryProductsByUPC200ResponseIngredientsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SearchGroceryProductsByUPC200ResponseIngredientsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SearchGroceryProductsByUPC200ResponseIngredientsInner.RequiredProperties) {
