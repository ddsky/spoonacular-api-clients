...
-spec autocomplete_ingredient_search(ctx:ctx()) -> {ok, [spoonacular_autocomplete_ingredient_search_200_response_inner:spoonacular_autocomplete_ingredient_search_200_response_inner()], spoonacular_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), spoonacular_utils:response_info()}.
autocomplete_ingredient_search(Ctx) ->
    autocomplete_ingredient_search(Ctx, #{}).

-spec autocomplete_ingredient_search(ctx:ctx(), maps:map()) -> {ok, [spoonacular_autocomplete_ingredient_search_200_response_inner:spoonacular_autocomplete_ingredient_search_200_response_inner()], spoonacular_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), spoonacular_utils:response_info()}.
autocomplete_ingredient_search(Ctx, Optional) ->
    ...
    QS = lists:flatten([])++spoonacular_utils:optional_params(['query', 'number', 'metaInformation', 'intolerances', 'language'], _OptionalParams),
    Headers = [],
    Body1 = [],
...
-spec get_ingredient_information(ctx:ctx(), integer()) -> {ok, spoonacular_get_ingredient_information_200_response:spoonacular_get_ingredient_information_200_response(), spoonacular_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), spoonacular_utils:response_info()}.
get_ingredient_information(Ctx, Id) ->
    get_ingredient_information(Ctx, Id, #{}).

-spec get_ingredient_information(ctx:ctx(), integer(), maps:map()) -> {ok, spoonacular_get_ingredient_information_200_response:spoonacular_get_ingredient_information_200_response(), spoonacular_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), spoonacular_utils:response_info()}.
...
-spec ingredient_search(ctx:ctx()) -> {ok, spoonacular_ingredient_search_200_response:spoonacular_ingredient_search_200_response(), spoonacular_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), spoonacular_utils:response_info()}.
ingredient_search(Ctx) ->
    ingredient_search(Ctx, #{}).

-spec ingredient_search(ctx:ctx(), maps:map()) -> {ok, spoonacular_ingredient_search_200_response:spoonacular_ingredient_search_200_response(), spoonacular_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), spoonacular_utils:response_info()}.
ingredient_search(Ctx, Optional) ->
    ...
    QS = lists:flatten([])++spoonacular_utils:optional_params(['query', 'addChildren', 'minProteinPercent', 'maxProteinPercent', 'minFatPercent', 'maxFatPercent', 'minCarbsPercent', 'maxCarbsPercent', 'metaInformation', 'intolerances', 'sort', 'sortDirection', 'offset', 'number', 'language'], _OptionalParams),
    Headers = [],
    Body1 = [],
    ContentTypeHeader = spoonacular_utils:select_header_content_type([]),
    Opts = maps:get(hackney_opts, Optional, []),
