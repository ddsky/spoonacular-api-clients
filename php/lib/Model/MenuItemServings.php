...
/**
 * MenuItemServings Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MenuItemServings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MenuItem_servings';
    ...
    */
    ...
    public function setUnit($unit)
    {
        ...
        if (!is_null($unit) && (mb_strlen($unit) < 1)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling MenuItemServings., must be bigger than or equal to 1.');
        }
