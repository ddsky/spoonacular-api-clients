...
#include "com.spoonacular.client.model\OAISearchGroceryProductsByUPC_200_response_ingredients_inner.h"
...
private:
    ...
    QSet<OAISearchGroceryProductsByUPC_200_response_ingredients_inner> ingredients;
