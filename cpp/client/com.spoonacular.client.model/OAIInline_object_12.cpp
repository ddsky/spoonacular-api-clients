...
QString
OAIInline_object_12::getUsername() const {
    return username;
}
void
OAIInline_object_12::setUsername(const QString &username) {
...
OAINumber
OAIInline_object_12::getId() const {
    return id;
}
void
OAIInline_object_12::setId(const OAINumber &id) {
    this->id = id;
...
QString
OAIInline_object_12::getHash() const {
    return hash;
}
void
OAIInline_object_12::setHash(const QString &hash) {
    this->hash = hash;
