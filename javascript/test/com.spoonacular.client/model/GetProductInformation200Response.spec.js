...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpoonacularApi.GetProductInformation200Response();
  });
  ...
  describe('GetProductInformation200Response', function() {
    it('should create an instance of GetProductInformation200Response', function() {
      // uncomment below and update the code to test GetProductInformation200Response
      //var instance = new SpoonacularApi.GetProductInformation200Response();
      //expect(instance).to.be.a(SpoonacularApi.GetProductInformation200Response);
    });
