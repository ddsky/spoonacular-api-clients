...
/**
 * InlineResponse20049NutritionCalories Class Doc Comment
 *
 * @category Class
 * @package  com.spoonacular.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class InlineResponse20049NutritionCalories implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_49_nutrition_calories';
    ...
    protected static $openAPITypes = [
        'value' => 'float',
        'unit' => 'string',
        'confidence_range95_percent' => '\com.spoonacular.client\com.spoonacular.client.model\InlineResponse20049NutritionCaloriesConfidenceRange95Percent',
    ...
    public function setUnit($unit)
    {
        ...
        if ((mb_strlen($unit) < 1)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling InlineResponse20049NutritionCalories., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \com.spoonacular.client\com.spoonacular.client.model\InlineResponse20049NutritionCaloriesConfidenceRange95Percent
     */
     ...
     *
     * @param \com.spoonacular.client\com.spoonacular.client.model\InlineResponse20049NutritionCaloriesConfidenceRange95Percent $confidence_range95_percent confidence_range95_percent
     *
     * @return $this
     */
