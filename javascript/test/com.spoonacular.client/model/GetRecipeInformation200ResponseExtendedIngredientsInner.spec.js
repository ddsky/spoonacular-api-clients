...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpoonacularApi.GetRecipeInformation200ResponseExtendedIngredientsInner();
  });
  ...
  describe('GetRecipeInformation200ResponseExtendedIngredientsInner', function() {
    it('should create an instance of GetRecipeInformation200ResponseExtendedIngredientsInner', function() {
      // uncomment below and update the code to test GetRecipeInformation200ResponseExtendedIngredientsInner
      //var instance = new SpoonacularApi.GetRecipeInformation200ResponseExtendedIngredientsInner();
      //expect(instance).to.be.a(SpoonacularApi.GetRecipeInformation200ResponseExtendedIngredientsInner);
    });
