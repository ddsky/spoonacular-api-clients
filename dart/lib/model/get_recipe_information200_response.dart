...
class GetRecipeInformation200Response {
  /// Returns a new [GetRecipeInformation200Response] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetRecipeInformation200Response &&
    other.id == id &&
    other.title == title &&
    other.image == image &&
  ...
  /// Returns a new [GetRecipeInformation200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetRecipeInformation200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GetRecipeInformation200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GetRecipeInformation200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GetRecipeInformation200Response> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <GetRecipeInformation200Response>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetRecipeInformation200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GetRecipeInformation200Response> mapFromJson(dynamic json) {
    final map = <String, GetRecipeInformation200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetRecipeInformation200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of GetRecipeInformation200Response-objects as value to a dart map
  static Map<String, List<GetRecipeInformation200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GetRecipeInformation200Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GetRecipeInformation200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
