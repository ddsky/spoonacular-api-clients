...
/**
 * InlineResponse20054Videos Class Doc Comment
 *
 * @category Class
 * @package  com.spoonacular.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class InlineResponse20054Videos implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_54_videos';
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling InlineResponse20054Videos., must be bigger than or equal to 1.');
        }
    ...
    public function setShortTitle($short_title)
    {
        ...
        if ((mb_strlen($short_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $short_title when calling InlineResponse20054Videos., must be bigger than or equal to 1.');
        }
    ...
    public function setThumbnail($thumbnail)
    {
        ...
        if ((mb_strlen($thumbnail) < 1)) {
            throw new \InvalidArgumentException('invalid length for $thumbnail when calling InlineResponse20054Videos., must be bigger than or equal to 1.');
        }
    ...
    public function setYouTubeId($you_tube_id)
    {
        ...
        if ((mb_strlen($you_tube_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $you_tube_id when calling InlineResponse20054Videos., must be bigger than or equal to 1.');
        }
