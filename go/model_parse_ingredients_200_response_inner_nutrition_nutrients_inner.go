...
// checks if the ParseIngredients200ResponseInnerNutritionNutrientsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ParseIngredients200ResponseInnerNutritionNutrientsInner{}
...
type _ParseIngredients200ResponseInnerNutritionNutrientsInner ParseIngredients200ResponseInnerNutritionNutrientsInner
...
func NewParseIngredients200ResponseInnerNutritionNutrientsInner(name string, amount float32, unit string, percentOfDailyNeeds float32) *ParseIngredients200ResponseInnerNutritionNutrientsInner {
	this := ParseIngredients200ResponseInnerNutritionNutrientsInner{}
	this.Name = name
	this.Amount = amount
	this.Unit = unit
...
func (o ParseIngredients200ResponseInnerNutritionNutrientsInner) MarshalJSON() ([]byte, error) {
...
func (o ParseIngredients200ResponseInnerNutritionNutrientsInner) ToMap() (map[string]interface{}, error) {
...
func (o *ParseIngredients200ResponseInnerNutritionNutrientsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varParseIngredients200ResponseInnerNutritionNutrientsInner := _ParseIngredients200ResponseInnerNutritionNutrientsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varParseIngredients200ResponseInnerNutritionNutrientsInner)

	if err != nil {
		return err
	}

	*o = ParseIngredients200ResponseInnerNutritionNutrientsInner(varParseIngredients200ResponseInnerNutritionNutrientsInner)

	return err
}

type NullableParseIngredients200ResponseInnerNutritionNutrientsInner struct {
	value *ParseIngredients200ResponseInnerNutritionNutrientsInner
	isSet bool
}

func (v NullableParseIngredients200ResponseInnerNutritionNutrientsInner) Get() *ParseIngredients200ResponseInnerNutritionNutrientsInner {
	return v.value
}

func (v *NullableParseIngredients200ResponseInnerNutritionNutrientsInner) Set(val *ParseIngredients200ResponseInnerNutritionNutrientsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableParseIngredients200ResponseInnerNutritionNutrientsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableParseIngredients200ResponseInnerNutritionNutrientsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableParseIngredients200ResponseInnerNutritionNutrientsInner(val *ParseIngredients200ResponseInnerNutritionNutrientsInner) *NullableParseIngredients200ResponseInnerNutritionNutrientsInner {
	return &NullableParseIngredients200ResponseInnerNutritionNutrientsInner{value: val, isSet: true}
}

func (v NullableParseIngredients200ResponseInnerNutritionNutrientsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableParseIngredients200ResponseInnerNutritionNutrientsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
