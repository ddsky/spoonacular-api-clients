...
#
package WWW::OpenAPIClient::Object::GetProductInformation200Response;
...
__PACKAGE__->method_documentation({
    ...
    'ingredients' => {
        datatype => 'ARRAY[GetProductInformation200ResponseIngredientsInner]',
