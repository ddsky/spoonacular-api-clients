...
class GetShoppingList200ResponseAislesInnerItemsInner {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (measures != null) {
      ...
      _json[r'pantryItem'] = pantryItem;
      _json[r'aisle'] = aisle;
      _json[r'cost'] = cost;
      _json[r'ingredientId'] = ingredientId;
    return _json;
  }
  ...
  static Map<String, List<GetShoppingList200ResponseAislesInnerItemsInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetShoppingList200ResponseAislesInnerItemsInner.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
