...
#include "com.spoonacular.client.model\OAIInline_response_200_results.h"
#include <QList>
...
public:
    ...
    QList<OAIInline_response_200_results> getResults() const;
    void setResults(const QList<OAIInline_response_200_results> &results);
...
private:
    ...
    QList<OAIInline_response_200_results> results;
