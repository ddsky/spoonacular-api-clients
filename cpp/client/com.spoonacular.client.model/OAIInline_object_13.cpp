...
QString
OAIInline_object_13::getUsername() const {
    return username;
}
void
OAIInline_object_13::setUsername(const QString &username) {
...
QString
OAIInline_object_13::getHash() const {
    return hash;
}
void
OAIInline_object_13::setHash(const QString &hash) {
    this->hash = hash;
