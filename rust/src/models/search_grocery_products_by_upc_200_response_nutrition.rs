...
impl SearchGroceryProductsByUpc200ResponseNutrition {
    pub fn new(nutrients: Vec<crate::models::ParseIngredients200ResponseInnerNutritionNutrientsInner>, caloric_breakdown: crate::models::ParseIngredients200ResponseInnerNutritionCaloricBreakdown) -> SearchGroceryProductsByUpc200ResponseNutrition {
