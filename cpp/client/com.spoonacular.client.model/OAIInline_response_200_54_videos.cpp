...
#include "OAIInline_response_200_54_videos.h"
...
OAIInline_response_200_54_videos::OAIInline_response_200_54_videos(QString json) {
    this->init();
    this->fromJson(json);
}

OAIInline_response_200_54_videos::OAIInline_response_200_54_videos() {
    this->init();
}
...
void
OAIInline_response_200_54_videos::init() {
...
void
OAIInline_response_200_54_videos::fromJson(QString jsonString) {
...
void
OAIInline_response_200_54_videos::fromJsonObject(QJsonObject json) {
...
QString
OAIInline_response_200_54_videos::asJson () const {
...
QJsonObject
OAIInline_response_200_54_videos::asJsonObject() const {
    QJsonObject obj;
	if(m_title_isSet){
...
QString
OAIInline_response_200_54_videos::getTitle() const {
    return title;
}
void
OAIInline_response_200_54_videos::setTitle(const QString &title) {
    this->title = title;
...
qint32
OAIInline_response_200_54_videos::getLength() const {
    return length;
}
void
OAIInline_response_200_54_videos::setLength(const qint32 &length) {
    this->length = length;
...
OAINumber
OAIInline_response_200_54_videos::getRating() const {
    return rating;
}
void
OAIInline_response_200_54_videos::setRating(const OAINumber &rating) {
    this->rating = rating;
...
QString
OAIInline_response_200_54_videos::getShortTitle() const {
    return short_title;
}
void
OAIInline_response_200_54_videos::setShortTitle(const QString &short_title) {
...
QString
OAIInline_response_200_54_videos::getThumbnail() const {
    return thumbnail;
}
void
OAIInline_response_200_54_videos::setThumbnail(const QString &thumbnail) {
...
qint32
OAIInline_response_200_54_videos::getViews() const {
    return views;
}
void
OAIInline_response_200_54_videos::setViews(const qint32 &views) {
    this->views = views;
...
QString
OAIInline_response_200_54_videos::getYouTubeId() const {
    return you_tube_id;
}
void
OAIInline_response_200_54_videos::setYouTubeId(const QString &you_tube_id) {
    this->you_tube_id = you_tube_id;
    this->m_you_tube_id_isSet = true;
}

bool
OAIInline_response_200_54_videos::isSet() const {
...
bool
OAIInline_response_200_54_videos::isValid() const {
