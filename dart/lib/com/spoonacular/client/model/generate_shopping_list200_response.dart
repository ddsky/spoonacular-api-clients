...
class GenerateShoppingList200Response {
  ...
  static GenerateShoppingList200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GenerateShoppingList200Response(
        aisles: GetShoppingList200ResponseAislesInner.listFromJson(json[r'aisles'])!,
        cost: json[r'cost'] == null
            ? null
            : num.parse(json[r'cost'].toString()),
        startDate: json[r'startDate'] == null
            ? null
            : num.parse(json[r'startDate'].toString()),
        endDate: json[r'endDate'] == null
            ? null
            : num.parse(json[r'endDate'].toString()),
      );
    }
    return null;
  }
  ...
  static Map<String, List<GenerateShoppingList200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GenerateShoppingList200Response.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
