...
data class ParseIngredients200ResponseInnerNutrition (

    @Json(name = "nutrients")
    val nutrients: kotlin.collections.List<ParseIngredients200ResponseInnerNutritionNutrientsInner>,

    @Json(name = "properties")
    val properties: kotlin.collections.List<ParseIngredients200ResponseInnerNutritionPropertiesInner>,

    @Json(name = "flavonoids")
    val flavonoids: kotlin.collections.List<ParseIngredients200ResponseInnerNutritionPropertiesInner>,
