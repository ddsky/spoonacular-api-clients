...
class AddMealPlanTemplate200ResponseItemsInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of AddMealPlanTemplate200ResponseItemsInner.RequiredProperties) {
        ...
        if (data['value']) { // data not null
          AddMealPlanTemplate200ResponseItemsInnerValue.validateJSON(data['value']);
        }
