...
class ComputeGlycemicLoad200Response {
  ...
  Map<String, dynamic> toJson() {
    final _json = <String, dynamic>{};
      _json[r'totalGlycemicLoad'] = totalGlycemicLoad;
  ...
  static ComputeGlycemicLoad200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ComputeGlycemicLoad200Response(
        totalGlycemicLoad: json[r'totalGlycemicLoad'] == null
            ? null
            : num.parse(json[r'totalGlycemicLoad'].toString()),
        ingredients: ComputeGlycemicLoad200ResponseIngredientsInner.listFromJson(json[r'ingredients'])!,
      );
    }
    return null;
  }
  ...
  static Map<String, List<ComputeGlycemicLoad200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ComputeGlycemicLoad200Response.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
