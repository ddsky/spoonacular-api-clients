  ...
  class IngredientInformation
    ...
    def self.openapi_types
      {
        ...
        :'estimated_cost' => :'IngredientInformationEstimatedCost',
        :'consistency' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::IngredientInformation` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::IngredientInformation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, original, original_name, name, amount, unit, unit_short, unit_long, possible_units, estimated_cost, consistency, shopping_list_units, aisle, image, meta, nutrition, category_path].hash
    end
