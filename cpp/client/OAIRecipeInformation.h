...
#ifndef OAIRecipeInformation_H
#define OAIRecipeInformation_H
...
namespace OpenAPI {
class OAIRecipeInformation_extendedIngredients_inner;
class OAIRecipeInformation_winePairing;
class OAITasteInformation;

class OAIRecipeInformation : public OAIObject {
public:
    OAIRecipeInformation();
    OAIRecipeInformation(QString json);
    ~OAIRecipeInformation() override;
    ...
    qint32 getPreparationMinutes() const;
    void setPreparationMinutes(const qint32 &preparation_minutes);
    bool is_preparation_minutes_Set() const;
    bool is_preparation_minutes_Valid() const;

    qint32 getCookingMinutes() const;
    void setCookingMinutes(const qint32 &cooking_minutes);
    bool is_cooking_minutes_Set() const;
    bool is_cooking_minutes_Valid() const;
    ...
    QSet<OAIRecipeInformation_extendedIngredients_inner> getExtendedIngredients() const;
    void setExtendedIngredients(const QSet<OAIRecipeInformation_extendedIngredients_inner> &extended_ingredients);
    ...
    OAIRecipeInformation_winePairing getWinePairing() const;
    void setWinePairing(const OAIRecipeInformation_winePairing &wine_pairing);
    bool is_wine_pairing_Set() const;
    bool is_wine_pairing_Valid() const;

    OAITasteInformation getTaste() const;
    void setTaste(const OAITasteInformation &taste);
...
private:
    ...
    qint32 m_preparation_minutes;
    bool m_preparation_minutes_isSet;
    bool m_preparation_minutes_isValid;

    qint32 m_cooking_minutes;
    bool m_cooking_minutes_isSet;
    bool m_cooking_minutes_isValid;
    ...
    QList<OAIObject> m_analyzed_instructions;
    ...
    QSet<OAIRecipeInformation_extendedIngredients_inner> m_extended_ingredients;
    ...
    OAIRecipeInformation_winePairing m_wine_pairing;
    bool m_wine_pairing_isSet;
    bool m_wine_pairing_isValid;

    OAITasteInformation m_taste;
    bool m_taste_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRecipeInformation)

#endif // OAIRecipeInformation_H
