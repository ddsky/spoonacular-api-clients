...
min_folate = 0 # float | The minimum amount of folate in grams the recipe must have. (optional)
max_folate = 100 # float | The maximum amount of folate in grams the recipe can have. (optional)
min_folic_acid = 0 # float | The minimum amount of folic acid in grams the recipe must have. (optional)
max_folic_acid = 100 # float | The maximum amount of folic acid in grams the recipe can have. (optional)
min_iodine = 0 # float | The minimum amount of iodine in grams the recipe must have. (optional)
max_iodine = 100 # float | The maximum amount of iodine in grams the recipe can have. (optional)
...
min_selenium = 0 # float | The minimum amount of selenium in grams the recipe must have. (optional)
max_selenium = 100 # float | The maximum amount of selenium in grams the recipe can have. (optional)
