...
// checks if the ImageAnalysisByURL200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageAnalysisByURL200Response{}
...
type _ImageAnalysisByURL200Response ImageAnalysisByURL200Response
...
func (o *ImageAnalysisByURL200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varImageAnalysisByURL200Response := _ImageAnalysisByURL200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varImageAnalysisByURL200Response)

	if err != nil {
		return err
	}

	*o = ImageAnalysisByURL200Response(varImageAnalysisByURL200Response)
