...
public:
    ...
    OAINumber getSourceAmount() const;
    void setSourceAmount(const OAINumber &source_amount);
    ...
    OAINumber getTargetAmount() const;
    void setTargetAmount(const OAINumber &target_amount);
