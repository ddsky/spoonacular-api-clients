...
// checks if the SearchFoodVideos200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchFoodVideos200Response{}
...
type _SearchFoodVideos200Response SearchFoodVideos200Response
...
func (o *SearchFoodVideos200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varSearchFoodVideos200Response := _SearchFoodVideos200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSearchFoodVideos200Response)

	if err != nil {
		return err
	}

	*o = SearchFoodVideos200Response(varSearchFoodVideos200Response)
