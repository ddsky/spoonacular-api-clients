...
module OpenapiClient
  class MenuItemsApi
    ...
    def menu_item_nutrition_by_id_image_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/food/menuItems/{id}/nutritionWidget.png'.sub('{' + 'id' + '}', id.to_s)
    ...
    def menu_item_nutrition_label_image_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/food/menuItems/{id}/nutritionLabel.png'.sub('{' + 'id' + '}', id.to_s)
    ...
    def menu_item_nutrition_label_widget_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = '/food/menuItems/{id}/nutritionLabel'.sub('{' + 'id' + '}', id.to_s)
