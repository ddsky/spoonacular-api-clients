...
// tests for GetRandomRecipes200ResponseRecipesInner
void main() {
  // final instance = GetRandomRecipes200ResponseRecipesInner();

  group('test GetRandomRecipes200ResponseRecipesInner', () {
    // int id
    ...
    // List<Object> analyzedInstructions (default value: const [])
