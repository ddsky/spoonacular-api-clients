...
class RecipesApi
{
     ...
     */
    public function getRandomRecipes($include_nutrition = false, $include_tags = null, $exclude_tags = null, $number = 10, string $contentType = self::contentTypes['getRandomRecipes'][0])
    {
        list($response) = $this->getRandomRecipesWithHttpInfo($include_nutrition, $include_tags, $exclude_tags, $number, $contentType);
        return $response;
    }
     ...
     */
    public function getRandomRecipesWithHttpInfo($include_nutrition = false, $include_tags = null, $exclude_tags = null, $number = 10, string $contentType = self::contentTypes['getRandomRecipes'][0])
    {
        $request = $this->getRandomRecipesRequest($include_nutrition, $include_tags, $exclude_tags, $number, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRandomRecipesAsync($include_nutrition = false, $include_tags = null, $exclude_tags = null, $number = 10, string $contentType = self::contentTypes['getRandomRecipes'][0])
    {
        return $this->getRandomRecipesAsyncWithHttpInfo($include_nutrition, $include_tags, $exclude_tags, $number, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRandomRecipesAsyncWithHttpInfo($include_nutrition = false, $include_tags = null, $exclude_tags = null, $number = 10, string $contentType = self::contentTypes['getRandomRecipes'][0])
    {
        $returnType = '\OpenAPI\Client\Model\GetRandomRecipes200Response';
        $request = $this->getRandomRecipesRequest($include_nutrition, $include_tags, $exclude_tags, $number, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRandomRecipesRequest($include_nutrition = false, $include_tags = null, $exclude_tags = null, $number = 10, string $contentType = self::contentTypes['getRandomRecipes'][0])
    {
     ...
     */
    public function getSimilarRecipes($id, $number = 10, string $contentType = self::contentTypes['getSimilarRecipes'][0])
    {
        list($response) = $this->getSimilarRecipesWithHttpInfo($id, $number, $contentType);
        return $response;
    }
     ...
     */
    public function getSimilarRecipesWithHttpInfo($id, $number = 10, string $contentType = self::contentTypes['getSimilarRecipes'][0])
    {
        $request = $this->getSimilarRecipesRequest($id, $number, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSimilarRecipesAsync($id, $number = 10, string $contentType = self::contentTypes['getSimilarRecipes'][0])
    {
        return $this->getSimilarRecipesAsyncWithHttpInfo($id, $number, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSimilarRecipesAsyncWithHttpInfo($id, $number = 10, string $contentType = self::contentTypes['getSimilarRecipes'][0])
    {
        $returnType = '\OpenAPI\Client\Model\GetSimilarRecipes200ResponseInner[]';
        $request = $this->getSimilarRecipesRequest($id, $number, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSimilarRecipesRequest($id, $number = 10, string $contentType = self::contentTypes['getSimilarRecipes'][0])
    {
