  ...
  class InlineResponse20031ComparableProducts
    ...
    def self.openapi_types
      {
        ...
        :'likes' => :'Array<Object>',
        :'price' => :'Array<Object>',
        :'protein' => :'Array<InlineResponse20031ComparableProductsProtein>',
        :'spoonacular_score' => :'Array<InlineResponse20031ComparableProductsProtein>',
        :'sugar' => :'Array<Object>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::InlineResponse20031ComparableProducts` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::InlineResponse20031ComparableProducts`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'calories')
        if (value = attributes[:'calories']).is_a?(Array)
          self.calories = value
        end
      end
      ...
      if attributes.key?(:'protein')
        if (value = attributes[:'protein']).is_a?(Array)
          self.protein = value
        end
      end

      if attributes.key?(:'spoonacular_score')
        if (value = attributes[:'spoonacular_score']).is_a?(Array)
          self.spoonacular_score = value
        end
      end

      if attributes.key?(:'sugar')
        if (value = attributes[:'sugar']).is_a?(Array)
          self.sugar = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @sugar.nil?
        invalid_properties.push('invalid value for "sugar", sugar cannot be nil.')
      end
    ...
    def hash
      [calories, likes, price, protein, spoonacular_score, sugar].hash
    end
