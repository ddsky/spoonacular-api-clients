...
class InlineResponse20033 implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['usda_code'] = isset($data['usda_code']) ? $data['usda_code'] : null;
    }
    ...
    public function setCleanTitle($clean_title)
    {
        ...
        if ((mb_strlen($clean_title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $clean_title when calling InlineResponse20033., must be bigger than or equal to 1.');
        }
    ...
    public function setImage($image)
    {
        ...
        if ((mb_strlen($image) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image when calling InlineResponse20033., must be bigger than or equal to 1.');
        }
    ...
    public function setCategory($category)
    {
        ...
        if ((mb_strlen($category) < 1)) {
            throw new \InvalidArgumentException('invalid length for $category when calling InlineResponse20033., must be bigger than or equal to 1.');
        }
