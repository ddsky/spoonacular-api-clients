...
// tests for GetWineRecommendation200ResponseRecommendedWinesInner
void main() {
  // final instance = GetWineRecommendation200ResponseRecommendedWinesInner();

  group('test GetWineRecommendation200ResponseRecommendedWinesInner', () {
    // int id
