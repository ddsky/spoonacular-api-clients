...
class RecipeInformationTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of RecipeInformation
        //val modelInstance = RecipeInformation()
        ...
        // to test the property `preparationMinutes`
        should("test preparationMinutes") {
            // uncomment below to test the property
            //modelInstance.preparationMinutes shouldBe ("TODO")
        }

        // to test the property `cookingMinutes`
        should("test cookingMinutes") {
            // uncomment below to test the property
            //modelInstance.cookingMinutes shouldBe ("TODO")
        }
