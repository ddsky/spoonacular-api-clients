...
module OpenapiClient
  class MealPlanningApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [Object]
    def add_to_meal_plan(username, hash, inline_object4, opts = {})
      data, _status_code, _headers = add_to_meal_plan_with_http_info(username, hash, inline_object4, opts)
      data
    end
    ...
    def add_to_meal_plan_with_http_info(username, hash, inline_object4, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && inline_object4.nil?
        fail ArgumentError, "Missing the required parameter 'inline_object4' when calling MealPlanningApi.add_to_meal_plan"
      end
      # resource path
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Object, Integer, Hash)>] Object data, response status code and response headers
    def clear_meal_plan_day_with_http_info(username, date, hash, inline_object3, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && inline_object3.nil?
        fail ArgumentError, "Missing the required parameter 'inline_object3' when calling MealPlanningApi.clear_meal_plan_day"
      end
      # resource path
    ...
    # @param [Hash] opts the optional parameters
    # @return [Object]
    def delete_from_meal_plan(username, id, hash, inline_object5, opts = {})
      data, _status_code, _headers = delete_from_meal_plan_with_http_info(username, id, hash, inline_object5, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Object, Integer, Hash)>] Object data, response status code and response headers
    def delete_from_meal_plan_with_http_info(username, id, hash, inline_object5, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && inline_object5.nil?
        fail ArgumentError, "Missing the required parameter 'inline_object5' when calling MealPlanningApi.delete_from_meal_plan"
      end
      # resource path
