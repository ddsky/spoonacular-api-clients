...
QString
OAIInline_object_8::getStartDate() const {
    return start_date;
}
void
OAIInline_object_8::setStartDate(const QString &start_date) {
...
QString
OAIInline_object_8::getEndDate() const {
    return end_date;
}
void
OAIInline_object_8::setEndDate(const QString &end_date) {
