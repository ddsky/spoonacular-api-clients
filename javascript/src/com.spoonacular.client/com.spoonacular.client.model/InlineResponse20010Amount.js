...
import InlineResponse20010AmountMetric from './InlineResponse20010AmountMetric';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('metric')) {
                obj['metric'] = InlineResponse20010AmountMetric.constructFromObject(data['metric']);
            }
            if (data.hasOwnProperty('us')) {
                obj['us'] = InlineResponse20010AmountMetric.constructFromObject(data['us']);
            }
        }
        return obj;
    }
...
export default InlineResponse20010Amount;
