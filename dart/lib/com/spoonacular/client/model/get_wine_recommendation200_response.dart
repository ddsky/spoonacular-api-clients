...
class GetWineRecommendation200Response {
  ...
  bool operator ==(Object other) => identical(this, other) || other is GetWineRecommendation200Response &&
     other.recommendedWines == recommendedWines &&
  ...
  Map<String, dynamic> toJson() {
    final _json = <String, dynamic>{};
      _json[r'recommendedWines'] = recommendedWines;
      _json[r'totalFound'] = totalFound;
    return _json;
  }
  ...
  static GetWineRecommendation200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GetWineRecommendation200Response(
        recommendedWines: GetWineRecommendation200ResponseRecommendedWinesInner.listFromJson(json[r'recommendedWines'])!,
  ...
  static Map<String, List<GetWineRecommendation200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetWineRecommendation200Response.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
