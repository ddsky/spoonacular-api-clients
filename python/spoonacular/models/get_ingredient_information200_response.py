...
class GetIngredientInformation200Response(BaseModel):
    ...
    estimated_cost: ParseIngredients200ResponseInnerEstimatedCost = Field(alias="estimatedCost")
    ...
    __properties: ClassVar[List[str]] = ["id", "original", "originalName", "name", "nameClean", "amount", "unit", "unitShort", "unitLong", "possibleUnits", "estimatedCost", "consistency", "shoppingListUnits", "aisle", "image", "meta", "nutrition", "categoryPath"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "estimatedCost": ParseIngredients200ResponseInnerEstimatedCost.from_dict(obj["estimatedCost"]) if obj.get("estimatedCost") is not None else None,
