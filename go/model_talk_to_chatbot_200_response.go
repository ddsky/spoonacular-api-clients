...
// checks if the TalkToChatbot200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TalkToChatbot200Response{}
...
func (o *TalkToChatbot200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varTalkToChatbot200Response := _TalkToChatbot200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTalkToChatbot200Response)

	if err != nil {
		return err
	}

	*o = TalkToChatbot200Response(varTalkToChatbot200Response)
