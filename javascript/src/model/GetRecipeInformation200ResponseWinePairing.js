 ...
 * @module model/GetRecipeInformation200ResponseWinePairing
 * @version 1.1
 */
class GetRecipeInformation200ResponseWinePairing {
    /**
     * Constructs a new <code>GetRecipeInformation200ResponseWinePairing</code>.
     * @alias module:model/GetRecipeInformation200ResponseWinePairing
     * @param pairedWines {Array.<String>} 
     * @param pairingText {String} 
     * @param productMatches {Array.<module:model/GetRecipeInformation200ResponseWinePairingProductMatchesInner>} 
     */
     ...
     * @param {module:model/GetRecipeInformation200ResponseWinePairing} obj Optional instance to populate.
     * @return {module:model/GetRecipeInformation200ResponseWinePairing} The populated <code>GetRecipeInformation200ResponseWinePairing</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>GetRecipeInformation200ResponseWinePairing</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRecipeInformation200ResponseWinePairing</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetRecipeInformation200ResponseWinePairing.RequiredProperties) {
        ...
        if (data['productMatches']) { // data not null
            ...
            for (const item of data['productMatches']) {
                GetRecipeInformation200ResponseWinePairingProductMatchesInner.validateJSON(item);
            };
        }
...
GetRecipeInformation200ResponseWinePairing.RequiredProperties = ["pairedWines", "pairingText", "productMatches"];
...
/**
 * @member {Array.<module:model/GetRecipeInformation200ResponseWinePairingProductMatchesInner>} productMatches
 */
