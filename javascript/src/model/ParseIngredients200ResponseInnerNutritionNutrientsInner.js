 ...
 * @module model/ParseIngredients200ResponseInnerNutritionNutrientsInner
 * @version 1.1
 */
class ParseIngredients200ResponseInnerNutritionNutrientsInner {
     ...
     * @alias module:model/ParseIngredients200ResponseInnerNutritionNutrientsInner
     * @param name {String} 
     * @param amount {Number} 
     * @param unit {String} 
     ...
     * @param {module:model/ParseIngredients200ResponseInnerNutritionNutrientsInner} obj Optional instance to populate.
     * @return {module:model/ParseIngredients200ResponseInnerNutritionNutrientsInner} The populated <code>ParseIngredients200ResponseInnerNutritionNutrientsInner</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>ParseIngredients200ResponseInnerNutritionNutrientsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ParseIngredients200ResponseInnerNutritionNutrientsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ParseIngredients200ResponseInnerNutritionNutrientsInner.RequiredProperties) {
...
ParseIngredients200ResponseInnerNutritionNutrientsInner.RequiredProperties = ["name", "amount", "unit", "percentOfDailyNeeds"];
...
export default ParseIngredients200ResponseInnerNutritionNutrientsInner;
