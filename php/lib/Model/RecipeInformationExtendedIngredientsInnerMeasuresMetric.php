...
/**
 * RecipeInformationExtendedIngredientsInnerMeasuresMetric Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RecipeInformationExtendedIngredientsInnerMeasuresMetric implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecipeInformation_extendedIngredients_inner_measures_metric';
    ...
    */
    ...
    public function setUnitLong($unit_long)
    {
        ...
        if ((mb_strlen($unit_long) < 0)) {
            throw new \InvalidArgumentException('invalid length for $unit_long when calling RecipeInformationExtendedIngredientsInnerMeasuresMetric., must be bigger than or equal to 0.');
        }
    ...
    public function setUnitShort($unit_short)
    {
        ...
        if ((mb_strlen($unit_short) < 0)) {
            throw new \InvalidArgumentException('invalid length for $unit_short when calling RecipeInformationExtendedIngredientsInnerMeasuresMetric., must be bigger than or equal to 0.');
        }
