...
(function(root, factory) {
  ...
  describe('DefaultApi', function() {
    describe('analyzeRecipe', function() {
      it('should call analyzeRecipe successfully', function(done) {
        //uncomment below and update the code to test analyzeRecipe
        //instance.analyzeRecipe(function(error) {
