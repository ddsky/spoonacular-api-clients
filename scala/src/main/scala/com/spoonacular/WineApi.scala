    ...
    */
    ...
    implicit class StringOps(s: String) {
      ...
      def toZonedDateTime: ZonedDateTime = ZonedDateTime.parse(s, datetimeformatter)
        ...
        */
        private def getDishPairingForWine(da: DataAccessor): Endpoint[InlineResponse20043] =
        ...
        */
        private def getWineDescription(da: DataAccessor): Endpoint[InlineResponse20045] =
        ...
        */
        private def getWinePairing(da: DataAccessor): Endpoint[InlineResponse20044] =
        ...
        */
        private def getWineRecommendation(da: DataAccessor): Endpoint[InlineResponse20046] =
