...
class GetIngredientSubstitutes200Response {
  ...
  Map<String, dynamic> toJson() {
    final _json = <String, dynamic>{};
      _json[r'ingredient'] = ingredient;
      _json[r'substitutes'] = substitutes;
  ...
  static GetIngredientSubstitutes200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GetIngredientSubstitutes200Response(
        ...
        substitutes: json[r'substitutes'] is List
            ? (json[r'substitutes'] as List).cast<String>()
            : const [],
  ...
  static Map<String, List<GetIngredientSubstitutes200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetIngredientSubstitutes200Response.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
