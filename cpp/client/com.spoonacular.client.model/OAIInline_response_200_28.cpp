...
void
OAIInline_response_200_28::init() {
...
void
OAIInline_response_200_28::fromJson(QString jsonString) {
...
void
OAIInline_response_200_28::fromJsonObject(QJsonObject json) {
...
QString
OAIInline_response_200_28::asJson () const {
...
QJsonObject
OAIInline_response_200_28::asJsonObject() const {
    QJsonObject obj;
	if(m_id_isSet){
...
qint32
OAIInline_response_200_28::getId() const {
    return id;
}
void
OAIInline_response_200_28::setId(const qint32 &id) {
    this->id = id;
...
QString
OAIInline_response_200_28::getTitle() const {
    return title;
}
void
OAIInline_response_200_28::setTitle(const QString &title) {
    this->title = title;
...
QList<QString>
OAIInline_response_200_28::getBadges() const {
    return badges;
}
void
OAIInline_response_200_28::setBadges(const QList<QString> &badges) {
    this->badges = badges;
...
QList<QString>
OAIInline_response_200_28::getImportantBadges() const {
    return important_badges;
}
void
OAIInline_response_200_28::setImportantBadges(const QList<QString> &important_badges) {
...
QList<QString>
OAIInline_response_200_28::getBreadcrumbs() const {
    return breadcrumbs;
}
void
OAIInline_response_200_28::setBreadcrumbs(const QList<QString> &breadcrumbs) {
...
QString
OAIInline_response_200_28::getGeneratedText() const {
    return generated_text;
}
void
OAIInline_response_200_28::setGeneratedText(const QString &generated_text) {
...
QString
OAIInline_response_200_28::getImageType() const {
    return image_type;
}
void
OAIInline_response_200_28::setImageType(const QString &image_type) {
...
qint32
OAIInline_response_200_28::getIngredientCount() const {
    return ingredient_count;
}
void
OAIInline_response_200_28::setIngredientCount(const qint32 &ingredient_count) {
...
QString
OAIInline_response_200_28::getIngredientList() const {
    return ingredient_list;
}
void
OAIInline_response_200_28::setIngredientList(const QString &ingredient_list) {
    this->ingredient_list = ingredient_list;
    this->m_ingredient_list_isSet = true;
}


QList<OAIInline_response_200_28_ingredients>
OAIInline_response_200_28::getIngredients() const {
    return ingredients;
}
void
OAIInline_response_200_28::setIngredients(const QList<OAIInline_response_200_28_ingredients> &ingredients) {
...
OAINumber
OAIInline_response_200_28::getLikes() const {
    return likes;
}
void
OAIInline_response_200_28::setLikes(const OAINumber &likes) {
    this->likes = likes;
...
OAIInline_response_200_28::getNutrition() const {
    return nutrition;
}
void
OAIInline_response_200_28::setNutrition(const OAIInline_response_200_28_nutrition &nutrition) {
...
OAINumber
OAIInline_response_200_28::getPrice() const {
    return price;
}
void
OAIInline_response_200_28::setPrice(const OAINumber &price) {
    this->price = price;
...
OAIInline_response_200_28::getServings() const {
    return servings;
}
void
OAIInline_response_200_28::setServings(const OAIInline_response_200_28_servings &servings) {
...
OAINumber
OAIInline_response_200_28::getSpoonacularScore() const {
    return spoonacular_score;
}
void
OAIInline_response_200_28::setSpoonacularScore(const OAINumber &spoonacular_score) {
    this->spoonacular_score = spoonacular_score;
    this->m_spoonacular_score_isSet = true;
}

bool
OAIInline_response_200_28::isSet() const {
    ...
    do{ 
        ...
        if(m_generated_text_isSet){ isObjectUpdated = true; break;}
...
bool
OAIInline_response_200_28::isValid() const {
