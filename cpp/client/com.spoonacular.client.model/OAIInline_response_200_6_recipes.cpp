...
#include "OAIInline_response_200_6_recipes.h"
...
OAIInline_response_200_6_recipes::OAIInline_response_200_6_recipes(QString json) {
    this->init();
    this->fromJson(json);
}

OAIInline_response_200_6_recipes::OAIInline_response_200_6_recipes() {
    this->init();
}
...
void
OAIInline_response_200_6_recipes::init() {
...
void
OAIInline_response_200_6_recipes::fromJson(QString jsonString) {
...
void
OAIInline_response_200_6_recipes::fromJsonObject(QJsonObject json) {
...
QString
OAIInline_response_200_6_recipes::asJson () const {
...
QJsonObject
OAIInline_response_200_6_recipes::asJsonObject() const {
    QJsonObject obj;
	if(m_id_isSet){
...
qint32
OAIInline_response_200_6_recipes::getId() const {
    return id;
}
void
OAIInline_response_200_6_recipes::setId(const qint32 &id) {
    this->id = id;
...
QString
OAIInline_response_200_6_recipes::getTitle() const {
    return title;
}
void
OAIInline_response_200_6_recipes::setTitle(const QString &title) {
    this->title = title;
...
QString
OAIInline_response_200_6_recipes::getImage() const {
    return image;
}
void
OAIInline_response_200_6_recipes::setImage(const QString &image) {
    this->image = image;
...
QString
OAIInline_response_200_6_recipes::getImageType() const {
    return image_type;
}
void
OAIInline_response_200_6_recipes::setImageType(const QString &image_type) {
...
OAINumber
OAIInline_response_200_6_recipes::getServings() const {
    return servings;
}
void
OAIInline_response_200_6_recipes::setServings(const OAINumber &servings) {
...
qint32
OAIInline_response_200_6_recipes::getReadyInMinutes() const {
    return ready_in_minutes;
}
void
OAIInline_response_200_6_recipes::setReadyInMinutes(const qint32 &ready_in_minutes) {
...
QString
OAIInline_response_200_6_recipes::getLicense() const {
    return license;
}
void
OAIInline_response_200_6_recipes::setLicense(const QString &license) {
...
QString
OAIInline_response_200_6_recipes::getSourceName() const {
    return source_name;
}
void
OAIInline_response_200_6_recipes::setSourceName(const QString &source_name) {
...
QString
OAIInline_response_200_6_recipes::getSourceUrl() const {
    return source_url;
}
void
OAIInline_response_200_6_recipes::setSourceUrl(const QString &source_url) {
...
QString
OAIInline_response_200_6_recipes::getSpoonacularSourceUrl() const {
    return spoonacular_source_url;
}
void
OAIInline_response_200_6_recipes::setSpoonacularSourceUrl(const QString &spoonacular_source_url) {
...
OAINumber
OAIInline_response_200_6_recipes::getAggregateLikes() const {
    return aggregate_likes;
}
void
OAIInline_response_200_6_recipes::setAggregateLikes(const OAINumber &aggregate_likes) {
...
OAINumber
OAIInline_response_200_6_recipes::getHealthScore() const {
    return health_score;
}
void
OAIInline_response_200_6_recipes::setHealthScore(const OAINumber &health_score) {
...
OAINumber
OAIInline_response_200_6_recipes::getSpoonacularScore() const {
    return spoonacular_score;
}
void
OAIInline_response_200_6_recipes::setSpoonacularScore(const OAINumber &spoonacular_score) {
...
OAINumber
OAIInline_response_200_6_recipes::getPricePerServing() const {
    return price_per_serving;
}
void
OAIInline_response_200_6_recipes::setPricePerServing(const OAINumber &price_per_serving) {
...
QList<OAIObject>
OAIInline_response_200_6_recipes::getAnalyzedInstructions() const {
    return analyzed_instructions;
}
void
OAIInline_response_200_6_recipes::setAnalyzedInstructions(const QList<OAIObject> &analyzed_instructions) {
...
bool
OAIInline_response_200_6_recipes::isCheap() const {
    return cheap;
}
void
OAIInline_response_200_6_recipes::setCheap(const bool &cheap) {
    this->cheap = cheap;
...
QString
OAIInline_response_200_6_recipes::getCreditsText() const {
    return credits_text;
}
void
OAIInline_response_200_6_recipes::setCreditsText(const QString &credits_text) {
...
QList<QString>
OAIInline_response_200_6_recipes::getCuisines() const {
    return cuisines;
}
void
OAIInline_response_200_6_recipes::setCuisines(const QList<QString> &cuisines) {
...
bool
OAIInline_response_200_6_recipes::isDairyFree() const {
    return dairy_free;
}
void
OAIInline_response_200_6_recipes::setDairyFree(const bool &dairy_free) {
...
QList<QString>
OAIInline_response_200_6_recipes::getDiets() const {
    return diets;
}
void
OAIInline_response_200_6_recipes::setDiets(const QList<QString> &diets) {
    this->diets = diets;
...
QString
OAIInline_response_200_6_recipes::getGaps() const {
    return gaps;
}
void
OAIInline_response_200_6_recipes::setGaps(const QString &gaps) {
    this->gaps = gaps;
...
bool
OAIInline_response_200_6_recipes::isGlutenFree() const {
    return gluten_free;
}
void
OAIInline_response_200_6_recipes::setGlutenFree(const bool &gluten_free) {
...
QString
OAIInline_response_200_6_recipes::getInstructions() const {
    return instructions;
}
void
OAIInline_response_200_6_recipes::setInstructions(const QString &instructions) {
...
bool
OAIInline_response_200_6_recipes::isKetogenic() const {
    return ketogenic;
}
void
OAIInline_response_200_6_recipes::setKetogenic(const bool &ketogenic) {
...
bool
OAIInline_response_200_6_recipes::isLowFodmap() const {
    return low_fodmap;
}
void
OAIInline_response_200_6_recipes::setLowFodmap(const bool &low_fodmap) {
...
QList<QString>
OAIInline_response_200_6_recipes::getOccasions() const {
    return occasions;
}
void
OAIInline_response_200_6_recipes::setOccasions(const QList<QString> &occasions) {
...
bool
OAIInline_response_200_6_recipes::isSustainable() const {
    return sustainable;
}
void
OAIInline_response_200_6_recipes::setSustainable(const bool &sustainable) {
...
bool
OAIInline_response_200_6_recipes::isVegan() const {
    return vegan;
}
void
OAIInline_response_200_6_recipes::setVegan(const bool &vegan) {
    this->vegan = vegan;
...
bool
OAIInline_response_200_6_recipes::isVegetarian() const {
    return vegetarian;
}
void
OAIInline_response_200_6_recipes::setVegetarian(const bool &vegetarian) {
...
bool
OAIInline_response_200_6_recipes::isVeryHealthy() const {
    return very_healthy;
}
void
OAIInline_response_200_6_recipes::setVeryHealthy(const bool &very_healthy) {
...
bool
OAIInline_response_200_6_recipes::isVeryPopular() const {
    return very_popular;
}
void
OAIInline_response_200_6_recipes::setVeryPopular(const bool &very_popular) {
...
bool
OAIInline_response_200_6_recipes::isWhole30() const {
    return whole30;
}
void
OAIInline_response_200_6_recipes::setWhole30(const bool &whole30) {
...
OAINumber
OAIInline_response_200_6_recipes::getWeightWatcherSmartPoints() const {
    return weight_watcher_smart_points;
}
void
OAIInline_response_200_6_recipes::setWeightWatcherSmartPoints(const OAINumber &weight_watcher_smart_points) {
...
QList<QString>
OAIInline_response_200_6_recipes::getDishTypes() const {
    return dish_types;
}
void
OAIInline_response_200_6_recipes::setDishTypes(const QList<QString> &dish_types) {
...
OAIInline_response_200_6_recipes::getExtendedIngredients() const {
    return extended_ingredients;
}
void
OAIInline_response_200_6_recipes::setExtendedIngredients(const QList<OAIInline_response_200_3_extendedIngredients> &extended_ingredients) {
...
QString
OAIInline_response_200_6_recipes::getSummary() const {
    return summary;
}
void
OAIInline_response_200_6_recipes::setSummary(const QString &summary) {
...
OAIInline_response_200_6_recipes::getWinePairing() const {
    return wine_pairing;
}
void
OAIInline_response_200_6_recipes::setWinePairing(const OAIInline_response_200_3_winePairing &wine_pairing) {
    this->wine_pairing = wine_pairing;
    this->m_wine_pairing_isSet = true;
}

bool
OAIInline_response_200_6_recipes::isSet() const {
    ...
    do{ 
        ...
        if(aggregate_likes.isSet()){ isObjectUpdated = true; break;}
...
bool
OAIInline_response_200_6_recipes::isValid() const {
