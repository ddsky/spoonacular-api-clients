...
/**
 * InlineResponse20041Days Class Doc Comment
 *
 * @category Class
 * @package  com.spoonacular.client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class InlineResponse20041Days implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_41_days';
    ...
    public function setDay($day)
    {
        ...
        if ((mb_strlen($day) < 1)) {
            throw new \InvalidArgumentException('invalid length for $day when calling InlineResponse20041Days., must be bigger than or equal to 1.');
        }
