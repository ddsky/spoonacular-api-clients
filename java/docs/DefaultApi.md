...
try {
    ...
    System.err.println("Exception when calling DefaultApi#visualizeRecipeTaste");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling DefaultApi#visualizeRecipeTasteByID");
    e.printStackTrace();
}
```
