...
#include "OAIInline_response_200_40_days.h"
...
OAIInline_response_200_40_days::OAIInline_response_200_40_days(QString json) {
    this->init();
    this->fromJson(json);
}

OAIInline_response_200_40_days::OAIInline_response_200_40_days() {
    this->init();
}
...
void
OAIInline_response_200_40_days::init() {
...
void
OAIInline_response_200_40_days::fromJson(QString jsonString) {
...
void
OAIInline_response_200_40_days::fromJsonObject(QJsonObject json) {
...
QString
OAIInline_response_200_40_days::asJson () const {
...
QJsonObject
OAIInline_response_200_40_days::asJsonObject() const {
    QJsonObject obj;
...
OAIInline_response_200_40_days::getNutritionSummary() const {
    return nutrition_summary;
}
void
OAIInline_response_200_40_days::setNutritionSummary(const OAIInline_response_200_38_nutritionSummary &nutrition_summary) {
...
OAIInline_response_200_38_nutritionSummary
OAIInline_response_200_40_days::getNutritionSummaryBreakfast() const {
    return nutrition_summary_breakfast;
}
void
OAIInline_response_200_40_days::setNutritionSummaryBreakfast(const OAIInline_response_200_38_nutritionSummary &nutrition_summary_breakfast) {
...
OAIInline_response_200_38_nutritionSummary
OAIInline_response_200_40_days::getNutritionSummaryLunch() const {
    return nutrition_summary_lunch;
}
void
OAIInline_response_200_40_days::setNutritionSummaryLunch(const OAIInline_response_200_38_nutritionSummary &nutrition_summary_lunch) {
...
OAIInline_response_200_38_nutritionSummary
OAIInline_response_200_40_days::getNutritionSummaryDinner() const {
    return nutrition_summary_dinner;
}
void
OAIInline_response_200_40_days::setNutritionSummaryDinner(const OAIInline_response_200_38_nutritionSummary &nutrition_summary_dinner) {
...
QString
OAIInline_response_200_40_days::getDay() const {
    return day;
}
void
OAIInline_response_200_40_days::setDay(const QString &day) {
    this->day = day;
...
OAIInline_response_200_40_days::getItems() const {
    return items;
}
void
OAIInline_response_200_40_days::setItems(const QList<OAIInline_response_200_40_items> &items) {
    this->items = items;
    this->m_items_isSet = true;
}

bool
OAIInline_response_200_40_days::isSet() const {
...
bool
OAIInline_response_200_40_days::isValid() const {
