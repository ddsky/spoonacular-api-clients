...
pub struct GetRecipeNutritionWidgetById200ResponseGoodInner {
    #[serde(rename = "amount")]
    pub amount: String,
...
impl GetRecipeNutritionWidgetById200ResponseGoodInner {
    pub fn new(amount: String, indented: bool, percent_of_daily_needs: f32, name: String) -> GetRecipeNutritionWidgetById200ResponseGoodInner {
