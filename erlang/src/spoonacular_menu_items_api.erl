...
-spec autocomplete_menu_item_search(ctx:ctx(), binary()) -> {ok, spoonacular_inline_response_200_32:spoonacular_inline_response_200_32(), spoonacular_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), spoonacular_utils:response_info()}.
autocomplete_menu_item_search(Ctx, Query) ->
    autocomplete_menu_item_search(Ctx, Query, #{}).

-spec autocomplete_menu_item_search(ctx:ctx(), binary(), maps:map()) -> {ok, spoonacular_inline_response_200_32:spoonacular_inline_response_200_32(), spoonacular_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), spoonacular_utils:response_info()}.
...
-spec get_menu_item_information(ctx:ctx(), integer()) -> {ok, spoonacular_inline_response_200_36:spoonacular_inline_response_200_36(), spoonacular_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), spoonacular_utils:response_info()}.
get_menu_item_information(Ctx, Id) ->
    get_menu_item_information(Ctx, Id, #{}).

-spec get_menu_item_information(ctx:ctx(), integer(), maps:map()) -> {ok, spoonacular_inline_response_200_36:spoonacular_inline_response_200_36(), spoonacular_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), spoonacular_utils:response_info()}.
...
-spec search_menu_items(ctx:ctx()) -> {ok, spoonacular_inline_response_200_35:spoonacular_inline_response_200_35(), spoonacular_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), spoonacular_utils:response_info()}.
search_menu_items(Ctx) ->
    search_menu_items(Ctx, #{}).

-spec search_menu_items(ctx:ctx(), maps:map()) -> {ok, spoonacular_inline_response_200_35:spoonacular_inline_response_200_35(), spoonacular_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), spoonacular_utils:response_info()}.
