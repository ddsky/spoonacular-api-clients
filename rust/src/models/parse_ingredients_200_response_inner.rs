...
pub struct ParseIngredients200ResponseInner {
    ...
    pub nutrition: Box<crate::models::ParseIngredients200ResponseInnerNutrition>,
}

impl ParseIngredients200ResponseInner {
    pub fn new(id: i32, original: String, original_name: String, name: String, name_clean: String, amount: f32, unit: String, unit_short: String, unit_long: String, possible_units: Vec<String>, estimated_cost: crate::models::ParseIngredients200ResponseInnerEstimatedCost, consistency: String, aisle: String, image: String, meta: Vec<String>, nutrition: crate::models::ParseIngredients200ResponseInnerNutrition) -> ParseIngredients200ResponseInner {
