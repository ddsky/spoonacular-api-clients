...
defmodule com.spoonacular.client.Model.InlineResponse2006Recipes do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :"extendedIngredients" => [InlineResponse2003ExtendedIngredients] | nil,
    :"summary" => String.t,
    :"winePairing" => InlineResponse2003WinePairing | nil
  }
end

defimpl Poison.Decoder, for: com.spoonacular.client.Model.InlineResponse2006Recipes do
