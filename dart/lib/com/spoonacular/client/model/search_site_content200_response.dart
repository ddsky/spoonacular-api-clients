...
class SearchSiteContent200Response {
  ...
  bool operator ==(Object other) => identical(this, other) || other is SearchSiteContent200Response &&
     ...
     other.groceryProducts == groceryProducts &&
  ...
  Map<String, dynamic> toJson() {
    final _json = <String, dynamic>{};
      _json[r'Articles'] = articles;
      _json[r'Grocery Products'] = groceryProducts;
      _json[r'Menu Items'] = menuItems;
      _json[r'Recipes'] = recipes;
    return _json;
  }
  ...
  static SearchSiteContent200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SearchSiteContent200Response(
        articles: SearchSiteContent200ResponseArticlesInner.listFromJson(json[r'Articles'])!,
        groceryProducts: SearchSiteContent200ResponseGroceryProductsInner.listFromJson(json[r'Grocery Products'])!,
        menuItems: SearchSiteContent200ResponseGroceryProductsInner.listFromJson(json[r'Menu Items'])!,
        recipes: SearchSiteContent200ResponseGroceryProductsInner.listFromJson(json[r'Recipes'])!,
      );
    }
    return null;
  }
  ...
  static Map<String, List<SearchSiteContent200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SearchSiteContent200Response.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
