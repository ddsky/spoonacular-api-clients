(ns spoonacular-api.specs.inline-response-200-41-days
...
(def inline-response-200-41-days-data
  {
...
(def inline-response-200-41-days-spec
  (ds/spec
    {:name ::inline-response-200-41-days
     :spec inline-response-200-41-days-data}))
