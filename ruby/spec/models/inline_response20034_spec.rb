...
# Unit tests for OpenapiClient::InlineResponse20034
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'InlineResponse20034' do
  before do
    # run before each test
    @instance = OpenapiClient::InlineResponse20034.new
  end
  ...
  describe 'test an instance of InlineResponse20034' do
    it 'should create an instance of InlineResponse20034' do
      expect(@instance).to be_instance_of(OpenapiClient::InlineResponse20034)
    end
  end
