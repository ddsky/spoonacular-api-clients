...
// tests for ClassifyGroceryProductBulk200ResponseInner
void main() {
  // final instance = ClassifyGroceryProductBulk200ResponseInner();

  group('test ClassifyGroceryProductBulk200ResponseInner', () {
    // String cleanTitle
