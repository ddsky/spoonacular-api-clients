...
// checks if the GetWineDescription200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetWineDescription200Response{}
...
type _GetWineDescription200Response GetWineDescription200Response
...
func (o *GetWineDescription200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetWineDescription200Response := _GetWineDescription200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetWineDescription200Response)

	if err != nil {
		return err
	}

	*o = GetWineDescription200Response(varGetWineDescription200Response)
