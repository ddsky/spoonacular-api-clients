...
pub struct InlineResponse20040Days {
    ...
    pub day: String,
    #[serde(rename = "items")]
    pub items: Option<Vec<::models::InlineResponse20040Items>>,
}

impl InlineResponse20040Days {
    pub fn new(day: String) -> InlineResponse20040Days {
