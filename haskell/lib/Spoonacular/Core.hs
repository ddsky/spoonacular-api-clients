...
module Spoonacular.Core where

import Spoonacular.MimeTypes
import Spoonacular.Logging
...
-- | 
data SpoonacularConfig = SpoonacularConfig
...
-- | display the config
instance P.Show SpoonacularConfig where
  show c =
    T.printf
...
-- | constructs a default SpoonacularConfig
--
-- configHost:
--
...
-- @"spoonacular/0.1.0.0"@
--
newConfig :: IO SpoonacularConfig
newConfig = do
    logCxt <- initLogContext
    return $ SpoonacularConfig
        { configHost = "https://api.spoonacular.com"
        , configUserAgent = "spoonacular/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => SpoonacularConfig -> auth -> SpoonacularConfig
addAuthMethod config@SpoonacularConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: SpoonacularConfig -> IO SpoonacularConfig
...
withStderrLogging :: SpoonacularConfig -> IO SpoonacularConfig
...
withNoLogging :: SpoonacularConfig -> SpoonacularConfig
...
data SpoonacularRequest req contentType res accept = SpoonacularRequest
  { rMethod  :: NH.Method   -- ^ Method of SpoonacularRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of SpoonacularRequest
  , rParams   :: Params -- ^ params of SpoonacularRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (SpoonacularRequest req contentType res accept) NH.Method
rMethodL f SpoonacularRequest{..} = (\rMethod -> SpoonacularRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (SpoonacularRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f SpoonacularRequest{..} = (\rUrlPath -> SpoonacularRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (SpoonacularRequest req contentType res accept) Params
rParamsL f SpoonacularRequest{..} = (\rParams -> SpoonacularRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (SpoonacularRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f SpoonacularRequest{..} = (\rAuthTypes -> SpoonacularRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => SpoonacularRequest req contentType res accept -> param -> SpoonacularRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: SpoonacularRequest req contentType res accept -> param -> SpoonacularRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: SpoonacularRequest req contentType res accept -> param -> SpoonacularRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** SpoonacularRequest Utils

_mkRequest :: NH.Method -- ^ Method 
          -> [BCL.ByteString] -- ^ Endpoint
          -> SpoonacularRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = SpoonacularRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader :: SpoonacularRequest req contentType res accept -> [NH.Header] -> SpoonacularRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: SpoonacularRequest req contentType res accept -> [NH.HeaderName] -> SpoonacularRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => SpoonacularRequest req contentType res accept -> SpoonacularRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of 
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => SpoonacularRequest req contentType res accept -> SpoonacularRequest req contentType res accept
_setAcceptHeader req =
    case mimeType (P.Proxy :: P.Proxy accept) of 
        Just m -> req `setHeader` [("accept", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["accept"]

setQuery :: SpoonacularRequest req contentType res accept -> [NH.QueryItem] -> SpoonacularRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
addForm :: SpoonacularRequest req contentType res accept -> WH.Form -> SpoonacularRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: SpoonacularRequest req contentType res accept -> NH.Part -> SpoonacularRequest req contentType res accept
...
_setBodyBS :: SpoonacularRequest req contentType res accept -> B.ByteString -> SpoonacularRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: SpoonacularRequest req contentType res accept -> BL.ByteString -> SpoonacularRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => SpoonacularRequest req contentType res accept -> P.Proxy authMethod -> SpoonacularRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: SpoonacularConfig
    -> a
    -> SpoonacularRequest req contentType res accept
    -> IO (SpoonacularRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> SpoonacularConfig
  -> IO (SpoonacularRequest req contentType res accept)
_applyAuthMethods req config@(SpoonacularConfig {configAuthMethods = as}) =
  foldlM go req as
  where
