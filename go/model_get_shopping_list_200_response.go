...
// checks if the GetShoppingList200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetShoppingList200Response{}
...
type _GetShoppingList200Response GetShoppingList200Response
...
func (o *GetShoppingList200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetShoppingList200Response := _GetShoppingList200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetShoppingList200Response)

	if err != nil {
		return err
	}

	*o = GetShoppingList200Response(varGetShoppingList200Response)
