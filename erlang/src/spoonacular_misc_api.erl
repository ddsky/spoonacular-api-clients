...
-spec search_custom_foods(ctx:ctx(), binary(), binary()) -> {ok, spoonacular_inline_response_200_29:spoonacular_inline_response_200_29(), spoonacular_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), spoonacular_utils:response_info()}.
search_custom_foods(Ctx, Username, Hash) ->
    search_custom_foods(Ctx, Username, Hash, #{}).

-spec search_custom_foods(ctx:ctx(), binary(), binary(), maps:map()) -> {ok, spoonacular_inline_response_200_29:spoonacular_inline_response_200_29(), spoonacular_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), spoonacular_utils:response_info()}.
