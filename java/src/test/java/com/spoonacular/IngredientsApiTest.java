...
public class IngredientsApiTest {
    ...
    public void autocompleteIngredientSearchTest() throws ApiException {
        ...
        List<InlineResponse20024> response = api.autocompleteIngredientSearch(query, number, metaInformation, intolerances);
    ...
    public void computeIngredientAmountTest() throws ApiException {
        ...
        String unit = null;
        RecipesParseIngredientsNutritionWeightPerServing response = api.computeIngredientAmount(id, nutrient, target, unit);
    ...
    public void getIngredientInformationTest() throws ApiException {
        ...
        String unit = null;
        InlineResponse20022 response = api.getIngredientInformation(id, amount, unit);
    ...
    public void getIngredientSubstitutesTest() throws ApiException {
        ...
        InlineResponse20026 response = api.getIngredientSubstitutes(ingredientName);
    ...
    public void getIngredientSubstitutesByIDTest() throws ApiException {
        Integer id = null;
        InlineResponse20026 response = api.getIngredientSubstitutesByID(id);
    ...
    public void ingredientSearchTest() throws ApiException {
        ...
        Integer offset = null;
        Integer number = null;
        InlineResponse20025 response = api.ingredientSearch(query, addChildren, minProteinPercent, maxProteinPercent, minFatPercent, maxFatPercent, minCarbsPercent, maxCarbsPercent, metaInformation, intolerances, sort, sortDirection, offset, number);
    ...
    public void mapIngredientsToGroceryProductsTest() throws ApiException {
        ...
        List<InlineResponse20034> response = api.mapIngredientsToGroceryProducts(inlineObject2);
