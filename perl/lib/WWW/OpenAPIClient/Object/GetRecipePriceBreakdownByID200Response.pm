...
#
package WWW::OpenAPIClient::Object::GetRecipePriceBreakdownByID200Response;
...
__PACKAGE__->method_documentation({
    'ingredients' => {
        datatype => 'ARRAY[GetRecipePriceBreakdownByID200ResponseIngredientsInner]',
