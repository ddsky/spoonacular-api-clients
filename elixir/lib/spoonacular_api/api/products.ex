...
defmodule SpoonacularAPI.Api.Products do
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec classify_grocery_product_bulk(Tesla.Env.client, list(SpoonacularAPI.Model.ClassifyGroceryProductBulkRequestInner.t), keyword()) :: {:ok, nil} | {:ok, list(SpoonacularAPI.Model.ClassifyGroceryProductBulk200ResponseInner.t)} | {:error, Tesla.Env.t}
