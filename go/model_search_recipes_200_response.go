...
type _SearchRecipes200Response SearchRecipes200Response
...
func (o *SearchRecipes200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varSearchRecipes200Response := _SearchRecipes200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSearchRecipes200Response)

	if err != nil {
		return err
	}

	*o = SearchRecipes200Response(varSearchRecipes200Response)
