    ...
    */
    ...
    public function setConsistency($consistency)
    {
        ...
        if ((mb_strlen($consistency) < 1)) {
            throw new \InvalidArgumentException('invalid length for $consistency when calling GetRecipeInformation200ResponseExtendedIngredientsInner., must be bigger than or equal to 1.');
        }
