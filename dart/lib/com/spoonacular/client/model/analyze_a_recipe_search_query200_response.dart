...
class AnalyzeARecipeSearchQuery200Response {
  ...
  static AnalyzeARecipeSearchQuery200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return AnalyzeARecipeSearchQuery200Response(
        dishes: AnalyzeARecipeSearchQuery200ResponseDishesInner.listFromJson(json[r'dishes'])!,
        ingredients: AnalyzeARecipeSearchQuery200ResponseIngredientsInner.listFromJson(json[r'ingredients'])!,
        cuisines: json[r'cuisines'] is List
            ? (json[r'cuisines'] as List).cast<String>()
            : const [],
        modifiers: json[r'modifiers'] is List
            ? (json[r'modifiers'] as List).cast<String>()
            : const [],
      );
    }
    return null;
  ...
  static Map<String, List<AnalyzeARecipeSearchQuery200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AnalyzeARecipeSearchQuery200Response.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
