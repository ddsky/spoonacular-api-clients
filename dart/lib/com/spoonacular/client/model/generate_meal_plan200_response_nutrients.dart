...
class GenerateMealPlan200ResponseNutrients {
  ...
  Map<String, dynamic> toJson() {
    final _json = <String, dynamic>{};
      ...
      _json[r'carbohydrates'] = carbohydrates;
      _json[r'fat'] = fat;
  ...
  static GenerateMealPlan200ResponseNutrients? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GenerateMealPlan200ResponseNutrients(
        ...
        carbohydrates: json[r'carbohydrates'] == null
            ? null
            : num.parse(json[r'carbohydrates'].toString()),
        fat: json[r'fat'] == null
            ? null
            : num.parse(json[r'fat'].toString()),
        protein: json[r'protein'] == null
            ? null
            : num.parse(json[r'protein'].toString()),
      );
    }
    return null;
  }
  ...
  static Map<String, List<GenerateMealPlan200ResponseNutrients>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GenerateMealPlan200ResponseNutrients.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
