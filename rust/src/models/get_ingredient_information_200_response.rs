...
pub struct GetIngredientInformation200Response {
    ...
    pub nutrition: Box<models::GetIngredientInformation200ResponseNutrition>,
...
impl GetIngredientInformation200Response {
    /// 
    pub fn new(id: i32, original: String, original_name: String, name: String, name_clean: String, amount: f64, unit: String, unit_short: String, unit_long: String, possible_units: Vec<String>, estimated_cost: models::ParseIngredients200ResponseInnerEstimatedCost, consistency: String, shopping_list_units: Vec<String>, aisle: String, image: String, meta: Vec<serde_json::Value>, nutrition: models::GetIngredientInformation200ResponseNutrition, category_path: Vec<String>) -> GetIngredientInformation200Response {
        GetIngredientInformation200Response {
            id,
            original,
            original_name,
