...
class ConvertAmounts200Response {
  ...
  Map<String, dynamic> toJson() {
    final _json = <String, dynamic>{};
      _json[r'sourceAmount'] = sourceAmount;
      _json[r'sourceUnit'] = sourceUnit;
      _json[r'targetAmount'] = targetAmount;
      _json[r'targetUnit'] = targetUnit;
  ...
  static ConvertAmounts200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ConvertAmounts200Response(
        sourceAmount: json[r'sourceAmount'] == null
            ? null
            : num.parse(json[r'sourceAmount'].toString()),
        sourceUnit: mapValueOfType<String>(json, r'sourceUnit')!,
        targetAmount: json[r'targetAmount'] == null
            ? null
            : num.parse(json[r'targetAmount'].toString()),
  ...
  static Map<String, List<ConvertAmounts200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ConvertAmounts200Response.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
