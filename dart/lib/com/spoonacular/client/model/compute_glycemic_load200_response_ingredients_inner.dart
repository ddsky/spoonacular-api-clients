...
class ComputeGlycemicLoad200ResponseIngredientsInner {
  ...
  Map<String, dynamic> toJson() {
    final _json = <String, dynamic>{};
      ...
      _json[r'glycemicIndex'] = glycemicIndex;
      _json[r'glycemicLoad'] = glycemicLoad;
    return _json;
  }
  ...
  static ComputeGlycemicLoad200ResponseIngredientsInner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ComputeGlycemicLoad200ResponseIngredientsInner(
        ...
        glycemicIndex: json[r'glycemicIndex'] == null
            ? null
            : num.parse(json[r'glycemicIndex'].toString()),
        glycemicLoad: json[r'glycemicLoad'] == null
            ? null
            : num.parse(json[r'glycemicLoad'].toString()),
      );
    }
    return null;
  }
  ...
  static Map<String, List<ComputeGlycemicLoad200ResponseIngredientsInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ComputeGlycemicLoad200ResponseIngredientsInner.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
