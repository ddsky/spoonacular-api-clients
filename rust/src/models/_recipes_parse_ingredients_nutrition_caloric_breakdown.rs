...
pub struct RecipesParseIngredientsNutritionCaloricBreakdown {
...
impl RecipesParseIngredientsNutritionCaloricBreakdown {
    pub fn new(percent_protein: f32, percent_fat: f32, percent_carbs: f32) -> RecipesParseIngredientsNutritionCaloricBreakdown {
