...
#include "OAIInline_response_200_40_items.h"
...
OAIInline_response_200_40_items::OAIInline_response_200_40_items(QString json) {
    this->init();
    this->fromJson(json);
}

OAIInline_response_200_40_items::OAIInline_response_200_40_items() {
    this->init();
}
...
void
OAIInline_response_200_40_items::fromJson(QString jsonString) {
...
QString
OAIInline_response_200_40_items::asJson () const {
...
qint32
OAIInline_response_200_40_items::getSlot() const {
    return slot;
}
void
OAIInline_response_200_40_items::setSlot(const qint32 &slot) {
    this->slot = slot;
...
qint32
OAIInline_response_200_40_items::getPosition() const {
    return position;
}
void
OAIInline_response_200_40_items::setPosition(const qint32 &position) {
...
QString
OAIInline_response_200_40_items::getType() const {
    return type;
}
void
OAIInline_response_200_40_items::setType(const QString &type) {
    this->type = type;
    this->m_type_isSet = true;
}


OAIInline_response_200_40_value
OAIInline_response_200_40_items::getValue() const {
    return value;
}
void
OAIInline_response_200_40_items::setValue(const OAIInline_response_200_40_value &value) {
    this->value = value;
