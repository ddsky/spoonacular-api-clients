...
// checks if the GetRecipeInformation200ResponseWinePairing type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRecipeInformation200ResponseWinePairing{}
...
type _GetRecipeInformation200ResponseWinePairing GetRecipeInformation200ResponseWinePairing
...
func (o *GetRecipeInformation200ResponseWinePairing) UnmarshalJSON(data []byte) (err error) {
	...
	varGetRecipeInformation200ResponseWinePairing := _GetRecipeInformation200ResponseWinePairing{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetRecipeInformation200ResponseWinePairing)

	if err != nil {
		return err
	}

	*o = GetRecipeInformation200ResponseWinePairing(varGetRecipeInformation200ResponseWinePairing)
