...
class ParseIngredients200ResponseInnerNutritionCaloricBreakdown {
  ...
  Map<String, dynamic> toJson() {
    final _json = <String, dynamic>{};
      _json[r'percentProtein'] = percentProtein;
      _json[r'percentFat'] = percentFat;
      _json[r'percentCarbs'] = percentCarbs;
    return _json;
  }
  ...
  static ParseIngredients200ResponseInnerNutritionCaloricBreakdown? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ParseIngredients200ResponseInnerNutritionCaloricBreakdown(
        percentProtein: json[r'percentProtein'] == null
            ? null
            : num.parse(json[r'percentProtein'].toString()),
        percentFat: json[r'percentFat'] == null
            ? null
            : num.parse(json[r'percentFat'].toString()),
        percentCarbs: json[r'percentCarbs'] == null
            ? null
            : num.parse(json[r'percentCarbs'].toString()),
      );
    }
    return null;
  }
  ...
  static Map<String, List<ParseIngredients200ResponseInnerNutritionCaloricBreakdown>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ParseIngredients200ResponseInnerNutritionCaloricBreakdown.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
