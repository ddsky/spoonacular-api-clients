...
class GetRandomRecipes200ResponseRecipesInner {
     ...
     * @param {module:model/GetRandomRecipes200ResponseRecipesInner} obj Optional instance to populate.
     * @return {module:model/GetRandomRecipes200ResponseRecipesInner} The populated <code>GetRandomRecipes200ResponseRecipesInner</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>GetRandomRecipes200ResponseRecipesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetRandomRecipes200ResponseRecipesInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetRandomRecipes200ResponseRecipesInner.RequiredProperties) {
...
GetRandomRecipes200ResponseRecipesInner.RequiredProperties = ["id", "title", "image", "imageType", "servings", "readyInMinutes", "license", "sourceName", "sourceUrl", "spoonacularSourceUrl", "aggregateLikes", "healthScore", "spoonacularScore", "pricePerServing", "cheap", "creditsText", "dairyFree", "gaps", "glutenFree", "instructions", "ketogenic", "lowFodmap", "sustainable", "vegan", "vegetarian", "veryHealthy", "veryPopular", "whole30", "weightWatcherSmartPoints", "summary"];
