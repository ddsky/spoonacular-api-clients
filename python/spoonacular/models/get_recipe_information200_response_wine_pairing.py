...
class GetRecipeInformation200ResponseWinePairing(BaseModel):
    """
    ...
    product_matches: Annotated[List[GetRecipeInformation200ResponseWinePairingProductMatchesInner], Field(min_length=0)] = Field(alias="productMatches")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "productMatches": [GetRecipeInformation200ResponseWinePairingProductMatchesInner.from_dict(_item) for _item in obj["productMatches"]] if obj.get("productMatches") is not None else None
        })
        return _obj
