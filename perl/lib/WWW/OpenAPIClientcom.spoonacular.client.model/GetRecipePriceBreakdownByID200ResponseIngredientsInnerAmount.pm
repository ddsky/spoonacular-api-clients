...
#
package WWW::OpenAPIClient::Object::GetRecipePriceBreakdownByID200ResponseIngredientsInnerAmount;
...
__PACKAGE__->method_documentation({
    'metric' => {
        datatype => 'GetRecipePriceBreakdownByID200ResponseIngredientsInnerAmountMetric',
        base_name => 'metric',
        description => '',
        format => '',
        read_only => '',
