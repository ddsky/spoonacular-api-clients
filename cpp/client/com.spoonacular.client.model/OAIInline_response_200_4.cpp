...
QString
OAIInline_response_200_4::getTitle() const {
    return title;
}
void
OAIInline_response_200_4::setTitle(const QString &title) {
    this->title = title;
...
QString
OAIInline_response_200_4::getImage() const {
    return image;
}
void
OAIInline_response_200_4::setImage(const QString &image) {
    this->image = image;
...
QString
OAIInline_response_200_4::getImageType() const {
    return image_type;
}
void
OAIInline_response_200_4::setImageType(const QString &image_type) {
...
OAINumber
OAIInline_response_200_4::getServings() const {
    return servings;
}
void
OAIInline_response_200_4::setServings(const OAINumber &servings) {
...
qint32
OAIInline_response_200_4::getReadyInMinutes() const {
    return ready_in_minutes;
}
void
OAIInline_response_200_4::setReadyInMinutes(const qint32 &ready_in_minutes) {
...
QString
OAIInline_response_200_4::getLicense() const {
    return license;
}
void
OAIInline_response_200_4::setLicense(const QString &license) {
...
QString
OAIInline_response_200_4::getSourceName() const {
    return source_name;
}
void
OAIInline_response_200_4::setSourceName(const QString &source_name) {
...
QString
OAIInline_response_200_4::getSourceUrl() const {
    return source_url;
}
void
OAIInline_response_200_4::setSourceUrl(const QString &source_url) {
...
QString
OAIInline_response_200_4::getSpoonacularSourceUrl() const {
    return spoonacular_source_url;
}
void
OAIInline_response_200_4::setSpoonacularSourceUrl(const QString &spoonacular_source_url) {
...
qint32
OAIInline_response_200_4::getAggregateLikes() const {
    return aggregate_likes;
}
void
OAIInline_response_200_4::setAggregateLikes(const qint32 &aggregate_likes) {
...
OAINumber
OAIInline_response_200_4::getHealthScore() const {
    return health_score;
}
void
OAIInline_response_200_4::setHealthScore(const OAINumber &health_score) {
...
OAINumber
OAIInline_response_200_4::getSpoonacularScore() const {
    return spoonacular_score;
}
void
OAIInline_response_200_4::setSpoonacularScore(const OAINumber &spoonacular_score) {
...
OAINumber
OAIInline_response_200_4::getPricePerServing() const {
    return price_per_serving;
}
void
OAIInline_response_200_4::setPricePerServing(const OAINumber &price_per_serving) {
...
QList<QString>
OAIInline_response_200_4::getAnalyzedInstructions() const {
    return analyzed_instructions;
}
void
OAIInline_response_200_4::setAnalyzedInstructions(const QList<QString> &analyzed_instructions) {
...
bool
OAIInline_response_200_4::isCheap() const {
    return cheap;
}
void
OAIInline_response_200_4::setCheap(const bool &cheap) {
    this->cheap = cheap;
...
QString
OAIInline_response_200_4::getCreditsText() const {
    return credits_text;
}
void
OAIInline_response_200_4::setCreditsText(const QString &credits_text) {
...
QList<QString>
OAIInline_response_200_4::getCuisines() const {
    return cuisines;
}
void
OAIInline_response_200_4::setCuisines(const QList<QString> &cuisines) {
...
bool
OAIInline_response_200_4::isDairyFree() const {
    return dairy_free;
}
void
OAIInline_response_200_4::setDairyFree(const bool &dairy_free) {
...
QList<QString>
OAIInline_response_200_4::getDiets() const {
    return diets;
}
void
OAIInline_response_200_4::setDiets(const QList<QString> &diets) {
    this->diets = diets;
...
QString
OAIInline_response_200_4::getGaps() const {
    return gaps;
}
void
OAIInline_response_200_4::setGaps(const QString &gaps) {
    this->gaps = gaps;
...
bool
OAIInline_response_200_4::isGlutenFree() const {
    return gluten_free;
}
void
OAIInline_response_200_4::setGlutenFree(const bool &gluten_free) {
...
QString
OAIInline_response_200_4::getInstructions() const {
    return instructions;
}
void
OAIInline_response_200_4::setInstructions(const QString &instructions) {
...
bool
OAIInline_response_200_4::isKetogenic() const {
    return ketogenic;
}
void
OAIInline_response_200_4::setKetogenic(const bool &ketogenic) {
...
bool
OAIInline_response_200_4::isLowFodmap() const {
    return low_fodmap;
}
void
OAIInline_response_200_4::setLowFodmap(const bool &low_fodmap) {
...
QList<QString>
OAIInline_response_200_4::getOccasions() const {
    return occasions;
}
void
OAIInline_response_200_4::setOccasions(const QList<QString> &occasions) {
...
bool
OAIInline_response_200_4::isSustainable() const {
    return sustainable;
}
void
OAIInline_response_200_4::setSustainable(const bool &sustainable) {
...
bool
OAIInline_response_200_4::isVegan() const {
    return vegan;
}
void
OAIInline_response_200_4::setVegan(const bool &vegan) {
    this->vegan = vegan;
...
bool
OAIInline_response_200_4::isVegetarian() const {
    return vegetarian;
}
void
OAIInline_response_200_4::setVegetarian(const bool &vegetarian) {
...
bool
OAIInline_response_200_4::isVeryHealthy() const {
    return very_healthy;
}
void
OAIInline_response_200_4::setVeryHealthy(const bool &very_healthy) {
...
bool
OAIInline_response_200_4::isVeryPopular() const {
    return very_popular;
}
void
OAIInline_response_200_4::setVeryPopular(const bool &very_popular) {
...
bool
OAIInline_response_200_4::isWhole30() const {
    return whole30;
}
void
OAIInline_response_200_4::setWhole30(const bool &whole30) {
...
OAINumber
OAIInline_response_200_4::getWeightWatcherSmartPoints() const {
    return weight_watcher_smart_points;
}
void
OAIInline_response_200_4::setWeightWatcherSmartPoints(const OAINumber &weight_watcher_smart_points) {
...
QList<QString>
OAIInline_response_200_4::getDishTypes() const {
    return dish_types;
}
void
OAIInline_response_200_4::setDishTypes(const QList<QString> &dish_types) {
...
OAIInline_response_200_4::getExtendedIngredients() const {
    return extended_ingredients;
}
void
OAIInline_response_200_4::setExtendedIngredients(const QList<OAIInline_response_200_3_extendedIngredients> &extended_ingredients) {
...
QString
OAIInline_response_200_4::getSummary() const {
    return summary;
}
void
OAIInline_response_200_4::setSummary(const QString &summary) {
...
OAIInline_response_200_4::getWinePairing() const {
    return wine_pairing;
}
void
OAIInline_response_200_4::setWinePairing(const OAIInline_response_200_3_winePairing &wine_pairing) {
