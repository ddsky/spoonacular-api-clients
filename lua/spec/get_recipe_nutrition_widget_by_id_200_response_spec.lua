...
--[[
Unit tests for openapiclient.model.get_recipe_nutrition_widget_by_id_200_response
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("get_recipe_nutrition_widget_by_id_200_response", function()
  ...
  -- unit tests for the property 'bad'
  describe("property bad test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)

  -- unit tests for the property 'good'
  describe("property good test", function()
    it("should work", function()
      -- TODO assertion here: http://olivinelabs.com/busted/#asserts
    end)
  end)
