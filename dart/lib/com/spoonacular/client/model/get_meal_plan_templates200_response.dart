...
class GetMealPlanTemplates200Response {
  ...
  static GetMealPlanTemplates200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GetMealPlanTemplates200Response(
        templates: GetAnalyzedRecipeInstructions200ResponseIngredientsInner.listFromJson(json[r'templates'])!,
      );
    }
    return null;
  }
  ...
  static Map<String, List<GetMealPlanTemplates200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetMealPlanTemplates200Response.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
