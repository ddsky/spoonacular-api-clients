...
// checks if the GuessNutritionByDishName200ResponseCalories type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuessNutritionByDishName200ResponseCalories{}
...
type _GuessNutritionByDishName200ResponseCalories GuessNutritionByDishName200ResponseCalories
...
func (o *GuessNutritionByDishName200ResponseCalories) UnmarshalJSON(data []byte) (err error) {
	...
	varGuessNutritionByDishName200ResponseCalories := _GuessNutritionByDishName200ResponseCalories{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGuessNutritionByDishName200ResponseCalories)

	if err != nil {
		return err
	}

	*o = GuessNutritionByDishName200ResponseCalories(varGuessNutritionByDishName200ResponseCalories)
