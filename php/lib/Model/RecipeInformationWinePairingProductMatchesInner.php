...
/**
 * RecipeInformationWinePairingProductMatchesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RecipeInformationWinePairingProductMatchesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecipeInformation_winePairing_productMatches_inner';
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling RecipeInformationWinePairingProductMatchesInner., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling RecipeInformationWinePairingProductMatchesInner., must be bigger than or equal to 1.');
        }
    ...
    public function setPrice($price)
    {
        ...
        if ((mb_strlen($price) < 1)) {
            throw new \InvalidArgumentException('invalid length for $price when calling RecipeInformationWinePairingProductMatchesInner., must be bigger than or equal to 1.');
        }
    ...
    public function setImageUrl($image_url)
    {
        ...
        if ((mb_strlen($image_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling RecipeInformationWinePairingProductMatchesInner., must be bigger than or equal to 1.');
        }
    ...
    public function setLink($link)
    {
        ...
        if ((mb_strlen($link) < 1)) {
            throw new \InvalidArgumentException('invalid length for $link when calling RecipeInformationWinePairingProductMatchesInner., must be bigger than or equal to 1.');
        }
