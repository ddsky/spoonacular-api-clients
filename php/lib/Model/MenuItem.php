...
class MenuItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'image_type' => 'string',
        'likes' => 'int',
        'servings' => '\OpenAPI\Client\Model\MenuItemServings',
        'price' => 'float',
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling MenuItem., must be bigger than or equal to 1.');
        }
    ...
    public function setRestaurantChain($restaurant_chain)
    {
        ...
        if ((mb_strlen($restaurant_chain) < 1)) {
            throw new \InvalidArgumentException('invalid length for $restaurant_chain when calling MenuItem., must be bigger than or equal to 1.');
        }
     ...
     * Gets nutrition
     *
     * @return \OpenAPI\Client\Model\SearchGroceryProductsByUPC200ResponseNutrition|null
     */
     ...
     * Sets nutrition
     *
     * @param \OpenAPI\Client\Model\SearchGroceryProductsByUPC200ResponseNutrition|null $nutrition nutrition
     *
     * @return self
     */
    ...
    public function setImageType($image_type)
    {
        ...
        if ((mb_strlen($image_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image_type when calling MenuItem., must be bigger than or equal to 1.');
        }
     ...
     * Gets servings
     *
     * @return \OpenAPI\Client\Model\MenuItemServings|null
     */
     ...
     * Sets servings
     *
     * @param \OpenAPI\Client\Model\MenuItemServings|null $servings servings
     *
     * @return self
     */
    ...
    public function setSpoonacularScore($spoonacular_score)
    {
        if (is_null($spoonacular_score)) {
            array_push($this->openAPINullablesSetToNull, 'spoonacular_score');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('spoonacular_score', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
