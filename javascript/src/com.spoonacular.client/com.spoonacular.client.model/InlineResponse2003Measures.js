...
import InlineResponse2003MeasuresMetric from './InlineResponse2003MeasuresMetric';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('metric')) {
                obj['metric'] = InlineResponse2003MeasuresMetric.constructFromObject(data['metric']);
            }
            if (data.hasOwnProperty('us')) {
                obj['us'] = InlineResponse2003MeasuresMetric.constructFromObject(data['us']);
            }
        }
        return obj;
    }
...
export default InlineResponse2003Measures;
