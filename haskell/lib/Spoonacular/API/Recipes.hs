...
analyzeARecipeSearchQuery 
  ...
  -> SpoonacularRequest AnalyzeARecipeSearchQuery MimeNoContent InlineResponse20018 MimeJSON
...
-- 
analyzeRecipeInstructions 
  :: SpoonacularRequest AnalyzeRecipeInstructions MimeNoContent InlineResponse20016 MimeJSON
analyzeRecipeInstructions =
...
-- 
autocompleteRecipeSearch 
  :: SpoonacularRequest AutocompleteRecipeSearch MimeNoContent [InlineResponse2007] MimeJSON
autocompleteRecipeSearch =
...
-- 
classifyCuisine 
  :: SpoonacularRequest ClassifyCuisine MimeNoContent InlineResponse20017 MimeJSON
classifyCuisine =
...
-- 
computeGlycemicLoad 
  :: (Consumes ComputeGlycemicLoad MimeJSON, MimeRender MimeJSON InlineObject)
  => InlineObject -- ^ "inlineObject"
  -> SpoonacularRequest ComputeGlycemicLoad MimeJSON InlineResponse20023 MimeJSON
computeGlycemicLoad inlineObject =
  _mkRequest "POST" ["/food/ingredients/glycemicLoad"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyScheme)
    `setBodyParam` inlineObject

data ComputeGlycemicLoad 
instance HasBodyParam ComputeGlycemicLoad InlineObject 
...
convertAmounts 
  ...
  -> SpoonacularRequest ConvertAmounts MimeNoContent InlineResponse20019 MimeJSON
...
-- 
createRecipeCard 
  :: SpoonacularRequest CreateRecipeCard MimeNoContent InlineResponse20015 MimeJSON
createRecipeCard =
...
extractRecipeFromWebsite 
  ...
  -> SpoonacularRequest ExtractRecipeFromWebsite MimeNoContent InlineResponse2003 MimeJSON
...
instance HasOptionalParam ExtractRecipeFromWebsite IncludeTaste where
  applyOptionalParam req (IncludeTaste xs) =
    req `setQuery` toQuery ("includeTaste", Just xs)
-- | @application/json@
...
getAnalyzedRecipeInstructions 
  :: Id -- ^ "id" -  The item's id.
  -> SpoonacularRequest GetAnalyzedRecipeInstructions MimeNoContent InlineResponse20013 MimeJSON
...
-- 
getRandomRecipes 
  :: SpoonacularRequest GetRandomRecipes MimeNoContent InlineResponse2006 MimeJSON
getRandomRecipes =
...
getRecipeEquipmentByID 
  :: Id -- ^ "id" -  The item's id.
  -> SpoonacularRequest GetRecipeEquipmentByID MimeNoContent InlineResponse2009 MimeJSON
...
getRecipeInformation 
  :: Id -- ^ "id" -  The item's id.
  -> SpoonacularRequest GetRecipeInformation MimeNoContent InlineResponse2003 MimeJSON
...
getRecipeInformationBulk 
  ...
  -> SpoonacularRequest GetRecipeInformationBulk MimeNoContent [InlineResponse2004] MimeJSON
...
getRecipeIngredientsByID 
  :: Id -- ^ "id" -  The item's id.
  -> SpoonacularRequest GetRecipeIngredientsByID MimeNoContent InlineResponse20011 MimeJSON
...
getRecipeNutritionWidgetByID 
  :: Id -- ^ "id" -  The item's id.
  -> SpoonacularRequest GetRecipeNutritionWidgetByID MimeNoContent InlineResponse20012 MimeJSON
...
getRecipePriceBreakdownByID 
  :: Id -- ^ "id" -  The item's id.
  -> SpoonacularRequest GetRecipePriceBreakdownByID MimeNoContent InlineResponse20010 MimeJSON
...
getRecipeTasteByID 
  :: Id -- ^ "id" -  The item's id.
  -> SpoonacularRequest GetRecipeTasteByID MimeNoContent InlineResponse2008 MimeJSON
...
instance HasOptionalParam GetRecipeTasteByID Normalize where
  applyOptionalParam req (Normalize xs) =
    req `setQuery` toQuery ("normalize", Just xs)
-- | @application/json@
...
getSimilarRecipes 
  :: Id -- ^ "id" -  The item's id.
  -> SpoonacularRequest GetSimilarRecipes MimeNoContent [InlineResponse2005] MimeJSON
...
guessNutritionByDishName 
  ...
  -> SpoonacularRequest GuessNutritionByDishName MimeNoContent InlineResponse20021 MimeJSON
...
-- 
parseIngredients 
  :: SpoonacularRequest ParseIngredients MimeNoContent [InlineResponse20020] MimeJSON
parseIngredients =
...
instance HasOptionalParam RecipeNutritionLabelImage ShowOptionalNutrients where
  applyOptionalParam req (ShowOptionalNutrients xs) =
    req `setQuery` toQuery ("showOptionalNutrients", Just xs)
...
instance HasOptionalParam RecipeNutritionLabelImage ShowZeroValues where
  applyOptionalParam req (ShowZeroValues xs) =
    req `setQuery` toQuery ("showZeroValues", Just xs)
...
instance HasOptionalParam RecipeNutritionLabelImage ShowIngredients where
  applyOptionalParam req (ShowIngredients xs) =
    req `setQuery` toQuery ("showIngredients", Just xs)
-- | @image/png@
...
instance HasOptionalParam RecipeTasteByIDImage Rgb where
  applyOptionalParam req (Rgb xs) =
    req `setQuery` toQuery ("rgb", Just xs)
-- | @image/png@
...
-- 
searchRecipes 
  :: SpoonacularRequest SearchRecipes MimeNoContent InlineResponse200 MimeJSON
searchRecipes =
...
-- 
searchRecipesByIngredients 
  :: SpoonacularRequest SearchRecipesByIngredients MimeNoContent [InlineResponse2001] MimeJSON
searchRecipesByIngredients =
...
instance HasOptionalParam SearchRecipesByIngredients Ingredients where
  applyOptionalParam req (Ingredients xs) =
    req `setQuery` toQuery ("ingredients", Just xs)
...
-- 
searchRecipesByNutrients 
  :: SpoonacularRequest SearchRecipesByNutrients MimeNoContent [InlineResponse2002] MimeJSON
searchRecipesByNutrients =
...
summarizeRecipe 
  :: Id -- ^ "id" -  The item's id.
  -> SpoonacularRequest SummarizeRecipe MimeNoContent InlineResponse20014 MimeJSON
