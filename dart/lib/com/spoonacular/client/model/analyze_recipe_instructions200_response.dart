...
class AnalyzeRecipeInstructions200Response {
  ...
  static AnalyzeRecipeInstructions200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return AnalyzeRecipeInstructions200Response(
        parsedInstructions: AnalyzeRecipeInstructions200ResponseParsedInstructionsInner.listFromJson(json[r'parsedInstructions'])!,
        ingredients: AnalyzeRecipeInstructions200ResponseIngredientsInner.listFromJson(json[r'ingredients'])!,
        equipment: AnalyzeRecipeInstructions200ResponseIngredientsInner.listFromJson(json[r'equipment'])!,
      );
    }
    return null;
  }
  ...
  static Map<String, List<AnalyzeRecipeInstructions200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AnalyzeRecipeInstructions200Response.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
