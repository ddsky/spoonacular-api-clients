...
// tests for RecipeInformationWinePairingProductMatchesInner
void main() {
  // final instance = RecipeInformationWinePairingProductMatchesInner();

  group('test RecipeInformationWinePairingProductMatchesInner', () {
    // int id
