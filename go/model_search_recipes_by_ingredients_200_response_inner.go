...
// checks if the SearchRecipesByIngredients200ResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SearchRecipesByIngredients200ResponseInner{}
...
type _SearchRecipesByIngredients200ResponseInner SearchRecipesByIngredients200ResponseInner
...
func (o *SearchRecipesByIngredients200ResponseInner) UnmarshalJSON(data []byte) (err error) {
	...
	varSearchRecipesByIngredients200ResponseInner := _SearchRecipesByIngredients200ResponseInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSearchRecipesByIngredients200ResponseInner)

	if err != nil {
		return err
	}

	*o = SearchRecipesByIngredients200ResponseInner(varSearchRecipesByIngredients200ResponseInner)
