...
export class ObservableRecipesApi {
     ...
     * @param number The maximum number of items to return (between 1 and 100). Defaults to 10.
     */
    public getRandomRecipesWithHttpInfo(limitLicense?: boolean, includeNutrition?: boolean, includeTags?: string, excludeTags?: string, number?: number, _options?: Configuration): Observable<HttpInfo<GetRandomRecipes200Response>> {
        const requestContextPromise = this.requestFactory.getRandomRecipes(limitLicense, includeNutrition, includeTags, excludeTags, number, _options);
     ...
     * @param number The maximum number of items to return (between 1 and 100). Defaults to 10.
     */
    public getRandomRecipes(limitLicense?: boolean, includeNutrition?: boolean, includeTags?: string, excludeTags?: string, number?: number, _options?: Configuration): Observable<GetRandomRecipes200Response> {
        return this.getRandomRecipesWithHttpInfo(limitLicense, includeNutrition, includeTags, excludeTags, number, _options).pipe(map((apiResponse: HttpInfo<GetRandomRecipes200Response>) => apiResponse.data));
    }
