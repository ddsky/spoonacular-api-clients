...
type GetComparableProducts200ResponseComparableProducts struct {
	Calories []ComparableProduct `json:"calories"`
	Likes []ComparableProduct `json:"likes"`
	Price []ComparableProduct `json:"price"`
	Protein []ComparableProduct `json:"protein"`
	SpoonacularScore []ComparableProduct `json:"spoonacular_score"`
	Sugar []ComparableProduct `json:"sugar"`
}
...
func (o GetComparableProducts200ResponseComparableProducts) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["spoonacular_score"] = o.SpoonacularScore
