...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpoonacularApi.ParseIngredients200ResponseInnerNutritionCaloricBreakdown();
  });
  ...
  describe('ParseIngredients200ResponseInnerNutritionCaloricBreakdown', function() {
    it('should create an instance of ParseIngredients200ResponseInnerNutritionCaloricBreakdown', function() {
      // uncomment below and update the code to test ParseIngredients200ResponseInnerNutritionCaloricBreakdown
      //var instance = new SpoonacularApi.ParseIngredients200ResponseInnerNutritionCaloricBreakdown();
      //expect(instance).to.be.a(SpoonacularApi.ParseIngredients200ResponseInnerNutritionCaloricBreakdown);
    });
