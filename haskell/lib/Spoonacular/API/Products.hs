...
autocompleteProductSearch 
  ...
  -> SpoonacularRequest AutocompleteProductSearch MimeNoContent InlineResponse20032 MimeJSON
...
-- 
classifyGroceryProduct 
  :: (Consumes ClassifyGroceryProduct MimeJSON, MimeRender MimeJSON InlineObject1)
  => InlineObject1 -- ^ "inlineObject1"
  -> SpoonacularRequest ClassifyGroceryProduct MimeJSON InlineResponse20033 MimeJSON
classifyGroceryProduct inlineObject1 =
  _mkRequest "POST" ["/food/products/classify"]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthApiKeyApiKeyScheme)
    `setBodyParam` inlineObject1

data ClassifyGroceryProduct 
instance HasBodyParam ClassifyGroceryProduct InlineObject1 
...
getComparableProducts 
  ...
  -> SpoonacularRequest GetComparableProducts MimeNoContent InlineResponse20031 MimeJSON
...
getProductInformation 
  :: Id -- ^ "id" -  The item's id.
  -> SpoonacularRequest GetProductInformation MimeNoContent InlineResponse20030 MimeJSON
...
-- 
searchGroceryProducts 
  :: SpoonacularRequest SearchGroceryProducts MimeNoContent InlineResponse20027 MimeJSON
searchGroceryProducts =
...
searchGroceryProductsByUPC 
  ...
  -> SpoonacularRequest SearchGroceryProductsByUPC MimeNoContent InlineResponse20028 MimeJSON
