...
// tests for GetMealPlanTemplate200ResponseDaysInner
void main() {
  // final instance = GetMealPlanTemplate200ResponseDaysInner();

  group('test GetMealPlanTemplate200ResponseDaysInner', () {
    ...
    // Set<GetMealPlanTemplate200ResponseDaysInnerItemsInner> items (default value: const {})
