...
class TestRecipeInformationExtendedIngredientsInner(unittest.TestCase):
    """RecipeInformationExtendedIngredientsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecipeInformationExtendedIngredientsInner:
        """Test RecipeInformationExtendedIngredientsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecipeInformationExtendedIngredientsInner`
        """
        model = RecipeInformationExtendedIngredientsInner()
        if include_optional:
    ...
    def testRecipeInformationExtendedIngredientsInner(self):
        """Test RecipeInformationExtendedIngredientsInner"""
