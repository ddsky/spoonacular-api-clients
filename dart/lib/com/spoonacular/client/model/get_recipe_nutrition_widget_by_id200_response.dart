...
class GetRecipeNutritionWidgetByID200Response {
  ...
  static GetRecipeNutritionWidgetByID200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GetRecipeNutritionWidgetByID200Response(
        ...
        bad: GetRecipeNutritionWidgetByID200ResponseBadInner.listFromJson(json[r'bad'])!,
        good: GetRecipeNutritionWidgetByID200ResponseGoodInner.listFromJson(json[r'good'])!,
      );
    }
    return null;
  }
  ...
  static Map<String, List<GetRecipeNutritionWidgetByID200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetRecipeNutritionWidgetByID200Response.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
