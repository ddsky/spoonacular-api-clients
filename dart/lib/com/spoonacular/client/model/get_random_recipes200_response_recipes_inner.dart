...
class GetRandomRecipes200ResponseRecipesInner {
  ...
  static GetRandomRecipes200ResponseRecipesInner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GetRandomRecipes200ResponseRecipesInner(
        ...
        aggregateLikes: json[r'aggregateLikes'] == null
            ? null
            : num.parse(json[r'aggregateLikes'].toString()),
        ...
        analyzedInstructions: Object.listFromJson(json[r'analyzedInstructions']) ?? const [],
        ...
        dishTypes: json[r'dishTypes'] is List
            ...
            : const [],
        extendedIngredients: GetRecipeInformation200ResponseExtendedIngredientsInner.listFromJson(json[r'extendedIngredients']) ?? const {},
  ...
  static Map<String, List<GetRandomRecipes200ResponseRecipesInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetRandomRecipes200ResponseRecipesInner.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
