...
// checks if the GetMenuItemInformation200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetMenuItemInformation200Response{}
...
type _GetMenuItemInformation200Response GetMenuItemInformation200Response
...
func (o *GetMenuItemInformation200Response) GetSpoonacularScore() float32 {
	if o == nil || IsNil(o.SpoonacularScore) {
		var ret float32
		return ret
	}
...
func (o *GetMenuItemInformation200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetMenuItemInformation200Response := _GetMenuItemInformation200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetMenuItemInformation200Response)

	if err != nil {
		return err
	}

	*o = GetMenuItemInformation200Response(varGetMenuItemInformation200Response)
