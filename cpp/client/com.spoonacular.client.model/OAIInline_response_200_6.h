...
#include "com.spoonacular.client.model\OAIInline_response_200_6_recipes.h"
#include <QList>
...
public:
    ...
    QList<OAIInline_response_200_6_recipes> getRecipes() const;
    void setRecipes(const QList<OAIInline_response_200_6_recipes> &recipes);
...
private:
    ...
    QList<OAIInline_response_200_6_recipes> recipes;
