...
class GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner {
  ...
  static GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner(
        ...
        ingredients: GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerIngredientsInner.listFromJson(json[r'ingredients']).toSet(),
        equipment: GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInnerIngredientsInner.listFromJson(json[r'equipment']).toSet(),
      );
    }
    return null;
  }
  ...
  static Map<String, List<GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = GetAnalyzedRecipeInstructions200ResponseParsedInstructionsInnerStepsInner.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
