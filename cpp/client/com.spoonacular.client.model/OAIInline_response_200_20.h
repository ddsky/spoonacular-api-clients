...
#include "com.spoonacular.client.model\OAI_recipes_parseIngredients_nutrition.h"
#include <QList>
#include <QString>
...
public:
    ...
    OAI_recipes_parseIngredients_nutrition getNutrition() const;
    void setNutrition(const OAI_recipes_parseIngredients_nutrition &nutrition);
...
private:
    ...
    OAI_recipes_parseIngredients_nutrition nutrition;
