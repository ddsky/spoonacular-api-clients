...
module OpenapiClient
  ...
  class RecipeInformation
    ...
    attr_accessor :preparation_minutes

    attr_accessor :cooking_minutes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::RecipeInformation` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::RecipeInformation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ready_in_minutes')
        ...
        self.ready_in_minutes = nil
      end

      if attributes.key?(:'preparation_minutes')
        self.preparation_minutes = attributes[:'preparation_minutes']
      end

      if attributes.key?(:'cooking_minutes')
        self.cooking_minutes = attributes[:'cooking_minutes']
      end
      ...
      if attributes.key?(:'analyzed_instructions')
        ...
        self.analyzed_instructions = nil
      end
    ...
    def list_invalid_properties
      ...
      if @extended_ingredients.length < 0
    ...
    def valid?
      ...
      return false if @extended_ingredients.length < 0
    ...
    def extended_ingredients=(extended_ingredients)
      if extended_ingredients.nil?
        fail ArgumentError, 'extended_ingredients cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cooking_minutes == o.cooking_minutes &&
          license == o.license &&
    ...
    def hash
      [id, title, image, image_type, servings, ready_in_minutes, preparation_minutes, cooking_minutes, license, source_name, source_url, spoonacular_source_url, aggregate_likes, health_score, spoonacular_score, price_per_serving, analyzed_instructions, cheap, credits_text, cuisines, dairy_free, diets, gaps, gluten_free, instructions, low_fodmap, occasions, sustainable, vegan, vegetarian, very_healthy, very_popular, weight_watcher_smart_points, dish_types, extended_ingredients, summary, wine_pairing, taste].hash
    end
