...
class InlineResponse2007 implements ModelInterface, ArrayAccess
{
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling InlineResponse2007., must be bigger than or equal to 1.');
        }
    ...
    public function setImageType($image_type)
    {
        ...
        if ((mb_strlen($image_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $image_type when calling InlineResponse2007., must be bigger than or equal to 1.');
        }
