...
// checks if the GetRandomRecipes200ResponseRecipesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRandomRecipes200ResponseRecipesInner{}
...
type _GetRandomRecipes200ResponseRecipesInner GetRandomRecipes200ResponseRecipesInner
...
func (o *GetRandomRecipes200ResponseRecipesInner) GetAnalyzedInstructions() []map[string]interface{} {
	if o == nil || IsNil(o.AnalyzedInstructions) {
...
func (o *GetRandomRecipes200ResponseRecipesInner) GetExtendedIngredients() []GetRecipeInformation200ResponseExtendedIngredientsInner {
	if o == nil || IsNil(o.ExtendedIngredients) {
...
func (o GetRandomRecipes200ResponseRecipesInner) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AnalyzedInstructions) {
	...
	if !IsNil(o.DishTypes) {
		toSerialize["dishTypes"] = o.DishTypes
	}
	if !IsNil(o.ExtendedIngredients) {
...
func (o *GetRandomRecipes200ResponseRecipesInner) UnmarshalJSON(data []byte) (err error) {
	...
	varGetRandomRecipes200ResponseRecipesInner := _GetRandomRecipes200ResponseRecipesInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetRandomRecipes200ResponseRecipesInner)

	if err != nil {
		return err
	}

	*o = GetRandomRecipes200ResponseRecipesInner(varGetRandomRecipes200ResponseRecipesInner)
