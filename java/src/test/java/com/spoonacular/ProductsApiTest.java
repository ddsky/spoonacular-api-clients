...
public class ProductsApiTest {
    ...
    public void autocompleteProductSearchTest() throws ApiException {
        String query = null;
        Integer number = null;
        InlineResponse20032 response = api.autocompleteProductSearch(query, number);
    ...
    public void classifyGroceryProductTest() throws ApiException {
        ...
        String locale = null;
        InlineResponse20033 response = api.classifyGroceryProduct(inlineObject1, locale);
    ...
    public void classifyGroceryProductBulkTest() throws ApiException {
        ...
        String locale = null;
        List<InlineResponse20033> response = api.classifyGroceryProductBulk(inlineObject, locale);
    ...
    public void getComparableProductsTest() throws ApiException {
        BigDecimal upc = null;
        InlineResponse20031 response = api.getComparableProducts(upc);
    ...
    public void getProductInformationTest() throws ApiException {
        Integer id = null;
        InlineResponse20030 response = api.getProductInformation(id);
    ...
    public void searchGroceryProductsByUPCTest() throws ApiException {
        BigDecimal upc = null;
        InlineResponse20028 response = api.searchGroceryProductsByUPC(upc);
