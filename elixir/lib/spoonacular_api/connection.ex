...
defmodule SpoonacularAPI.Connection do
  @moduledoc """
  Handle Tesla connections for SpoonacularAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, SpoonacularAPI.Connection,
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:spoonacular, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - SpoonacularAPI 2.0.2 - elixir"
        )
      )
