...
public class InlineResponse20048NutritionCaloriesConfidenceRange95Percent  {
  ...
  public boolean equals(Object o) {
    ...
    return (this.min == null ? inlineResponse20048NutritionCaloriesConfidenceRange95Percent.min == null : this.min.equals(inlineResponse20048NutritionCaloriesConfidenceRange95Percent.min)) &&
        (this.max == null ? inlineResponse20048NutritionCaloriesConfidenceRange95Percent.max == null : this.max.equals(inlineResponse20048NutritionCaloriesConfidenceRange95Percent.max));
  }
