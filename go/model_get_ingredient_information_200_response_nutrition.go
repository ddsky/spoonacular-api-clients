...
// checks if the GetIngredientInformation200ResponseNutrition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetIngredientInformation200ResponseNutrition{}
...
type _GetIngredientInformation200ResponseNutrition GetIngredientInformation200ResponseNutrition
...
func (o *GetIngredientInformation200ResponseNutrition) UnmarshalJSON(data []byte) (err error) {
	...
	varGetIngredientInformation200ResponseNutrition := _GetIngredientInformation200ResponseNutrition{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetIngredientInformation200ResponseNutrition)

	if err != nil {
		return err
	}

	*o = GetIngredientInformation200ResponseNutrition(varGetIngredientInformation200ResponseNutrition)
