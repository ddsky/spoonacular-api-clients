...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SpoonacularApi.RecipesParseIngredientsNutritionCaloricBreakdown();
  });
  ...
  describe('RecipesParseIngredientsNutritionCaloricBreakdown', function() {
    it('should create an instance of RecipesParseIngredientsNutritionCaloricBreakdown', function() {
      // uncomment below and update the code to test RecipesParseIngredientsNutritionCaloricBreakdown
      //var instane = new SpoonacularApi.RecipesParseIngredientsNutritionCaloricBreakdown();
      //expect(instance).to.be.a(SpoonacularApi.RecipesParseIngredientsNutritionCaloricBreakdown);
    });
