...
#
package WWW::OpenAPIClient::Object::RecipesParseIngredientsNutrition;
...
__PACKAGE__->method_documentation({
    'nutrients' => {
        datatype => 'ARRAY[RecipesParseIngredientsNutritionNutrients]',
        base_name => 'nutrients',
        description => '',
        format => '',
        read_only => '',
    ...
    'properties' => {
        datatype => 'ARRAY[RecipesParseIngredientsNutritionProperties]',
    ...
    'caloric_breakdown' => {
        datatype => 'RecipesParseIngredientsNutritionCaloricBreakdown',
    ...
    'weight_per_serving' => {
        datatype => 'RecipesParseIngredientsNutritionWeightPerServing',
        base_name => 'weightPerServing',
        description => '',
        format => '',
        read_only => '',
            },
