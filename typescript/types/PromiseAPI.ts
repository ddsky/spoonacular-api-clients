...
export class PromiseRecipesApi {
     ...
     * @param number The maximum number of items to return (between 1 and 100). Defaults to 10.
     */
    public getRandomRecipesWithHttpInfo(includeNutrition?: boolean, includeTags?: string, excludeTags?: string, number?: number, _options?: Configuration): Promise<HttpInfo<GetRandomRecipes200Response>> {
        const result = this.api.getRandomRecipesWithHttpInfo(includeNutrition, includeTags, excludeTags, number, _options);
        return result.toPromise();
    }
     ...
     * @param number The maximum number of items to return (between 1 and 100). Defaults to 10.
     */
    public getRandomRecipes(includeNutrition?: boolean, includeTags?: string, excludeTags?: string, number?: number, _options?: Configuration): Promise<GetRandomRecipes200Response> {
        const result = this.api.getRandomRecipes(includeNutrition, includeTags, excludeTags, number, _options);
        return result.toPromise();
    }
    ...
    public getSimilarRecipesWithHttpInfo(id: number, number?: number, _options?: Configuration): Promise<HttpInfo<Set<GetSimilarRecipes200ResponseInner>>> {
        const result = this.api.getSimilarRecipesWithHttpInfo(id, number, _options);
        return result.toPromise();
    }
    ...
    public getSimilarRecipes(id: number, number?: number, _options?: Configuration): Promise<Set<GetSimilarRecipes200ResponseInner>> {
        const result = this.api.getSimilarRecipes(id, number, _options);
        return result.toPromise();
    }
