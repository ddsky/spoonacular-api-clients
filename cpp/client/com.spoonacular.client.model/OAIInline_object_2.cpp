...
QString
OAIInline_object_2::getIngredientList() const {
    return ingredient_list;
}
void
OAIInline_object_2::setIngredientList(const QString &ingredient_list) {
...
bool
OAIInline_object_2::isDefaultCss() const {
    return default_css;
}
void
OAIInline_object_2::setDefaultCss(const bool &default_css) {
...
bool
OAIInline_object_2::isShowBacklink() const {
    return show_backlink;
}
void
OAIInline_object_2::setShowBacklink(const bool &show_backlink) {
